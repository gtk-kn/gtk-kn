 ...
 * @property annotations Annotations associated with the inline method.
 * @property parameters Parameters for the inline method.
 * @property returnValue Return value of the inline method.
 */
@Suppress("DataClassShouldBeImmutable", "LateinitUsage", "LongMethod")
data class GirMethodInline(
