...
public open class Scale(
    ...
    public open fun addMark(
        ...
        markup: String? = null,
    ): Unit = gtk_scale_add_mark(gtkScalePointer, `value`, position.nativeValue, markup)
     ...
     */
    public open fun setFormatValueFunc(func: ScaleFormatValueFunc?): Unit = gtk_scale_set_format_value_func(gtkScalePointer, func?.let { ScaleFormatValueFuncFunc.reinterpret() }, func?.let { StableRef.create(func).asCPointer() }, func?.let { staticStableRefDestroy.reinterpret() })
