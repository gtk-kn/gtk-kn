...
public class CssLocation(
     ...
     */
    public constructor() : this(nativeHeap.alloc<GtkCssLocation>().run {
     ...
     */
    private constructor(pair: Pair<CPointer<GtkCssLocation>, Cleaner>) : this(pointer = pair.first, cleaner = pair.second)
    ...
    override fun toString(): String = "CssLocation(bytes=$bytes, chars=$chars, lines=$lines, lineBytes=$lineBytes, lineChars=$lineChars)"
}
