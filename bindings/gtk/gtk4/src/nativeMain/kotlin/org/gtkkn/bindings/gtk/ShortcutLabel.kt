...
public open class ShortcutLabel(
     ...
     */
    public open fun getAccelerator(): String? = gtk_shortcut_label_get_accelerator(gtkShortcutLabelPointer.reinterpret())?.toKString()
     ...
     * accelerator is set.
     */
    public open fun getDisabledText(): String? = gtk_shortcut_label_get_disabled_text(gtkShortcutLabelPointer.reinterpret())?.toKString()
     ...
     */
    public open fun setAccelerator(accelerator: String): Unit = gtk_shortcut_label_set_accelerator(gtkShortcutLabelPointer.reinterpret(), accelerator)
     ...
     */
    public open fun setDisabledText(disabledText: String): Unit = gtk_shortcut_label_set_disabled_text(gtkShortcutLabelPointer.reinterpret(), disabledText)
