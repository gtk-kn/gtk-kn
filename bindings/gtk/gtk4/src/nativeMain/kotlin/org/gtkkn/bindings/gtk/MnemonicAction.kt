...
public open class MnemonicAction(
    ...
    public companion object : TypeCompanion<MnemonicAction> {
        ...
        public fun `get`(): MnemonicAction = gtk_mnemonic_action_get()!!.run {
            InstanceCache.get(reinterpret(), true) { MnemonicAction(reinterpret()) }!!.also { ref() }
        }
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_mnemonic_action_get_type")
    }
}
