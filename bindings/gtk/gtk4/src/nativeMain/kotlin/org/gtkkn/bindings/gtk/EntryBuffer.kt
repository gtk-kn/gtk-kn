...
public open class EntryBuffer(
     ...
     */
    public constructor(initialChars: String? = null, nInitialChars: gint) : this(gtk_entry_buffer_new(initialChars, nInitialChars)!!) {
     ...
     */
    public open fun deleteText(position: guint, nChars: gint): guint = gtk_entry_buffer_delete_text(gtkEntryBufferPointer, position, nChars)
     ...
     */
    public open fun emitDeletedText(position: guint, nChars: guint): Unit = gtk_entry_buffer_emit_deleted_text(gtkEntryBufferPointer, position, nChars)
    ...
    public open fun emitInsertedText(
        ...
        chars: String,
        nChars: guint,
    ): Unit = gtk_entry_buffer_emit_inserted_text(gtkEntryBufferPointer, position, chars, nChars)
    ...
    public open fun insertText(
        ...
        chars: String,
        nChars: gint,
    ): guint = gtk_entry_buffer_insert_text(gtkEntryBufferPointer, position, chars, nChars)
     ...
     */
    public open fun setText(chars: String, nChars: gint): Unit = gtk_entry_buffer_set_text(gtkEntryBufferPointer, chars, nChars)
     ...
     */
    public fun onDeletedText(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (position: guint, nChars: guint) -> Unit): ULong = g_signal_connect_data(gtkEntryBufferPointer, "deleted-text", onDeletedTextFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun onInsertedText(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (
        position: guint,
        chars: String,
        nChars: guint,
    ) -> Unit): ULong = g_signal_connect_data(gtkEntryBufferPointer, "inserted-text", onInsertedTextFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
    ...
    public companion object : TypeCompanion<EntryBuffer> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_entry_buffer_get_type")
    }
}
...
private val onInsertedTextFunc: CPointer<CFunction<(
    guint,
    CPointer<ByteVar>,
    guint,
    ...
    userData.asStableRef<(
        ...
        chars: String,
        nChars: guint,
    ) -> Unit>().get().invoke(position, chars?.toKString() ?: error("Expected not null string"), nChars)}
.reinterpret()
