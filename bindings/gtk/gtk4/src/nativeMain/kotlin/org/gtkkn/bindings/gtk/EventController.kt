...
public open class EventController(
    ...
    public open var propagationLimit: PropagationLimit
         ...
         */
        set(limit) = gtk_event_controller_set_propagation_limit(gtkEventControllerPointer.reinterpret(), limit.nativeValue)
    ...
    public open var propagationPhase: PropagationPhase
         ...
         */
        set(phase) = gtk_event_controller_set_propagation_phase(gtkEventControllerPointer.reinterpret(), phase.nativeValue)
     ...
     */
    public open fun getCurrentEvent(): Event? = gtk_event_controller_get_current_event(gtkEventControllerPointer.reinterpret())?.run {
        Event(reinterpret())}
     ...
     */
    public open fun getCurrentEventDevice(): Device? = gtk_event_controller_get_current_event_device(gtkEventControllerPointer.reinterpret())?.run {
        Device(reinterpret())}
     ...
     */
    public open fun getCurrentEventState(): ModifierType = gtk_event_controller_get_current_event_state(gtkEventControllerPointer.reinterpret()).run {
        ModifierType(this)}
     ...
     */
    @GtkVersion4_8
    public open fun setStaticName(name: String? = null): Unit = gtk_event_controller_set_static_name(gtkEventControllerPointer.reinterpret(), name)
