...
public interface AccessibleText : Proxy, Accessible, KGTyped {
    ...
    public class AccessibleTextImpl(
        gtkAccessibleTextPointer: CPointer<GtkAccessibleText>,
    ...
    public companion object : TypeCompanion<AccessibleText> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_accessible_text_get_type")
    }
}
