...
public open class ComboBox(
     ...
     */
    public open fun setRowSeparatorFunc(func: TreeViewRowSeparatorFunc): Unit = gtk_combo_box_set_row_separator_func(gtkComboBoxPointer.reinterpret(), TreeViewRowSeparatorFuncFunc.reinterpret(), StableRef.create(func).asCPointer(), staticStableRefDestroy.reinterpret())
