...
public open class DragIcon(
    ...
    public companion object : TypeCompanion<DragIcon> {
        ...
        public fun setFromPaintable(
            ...
            hotX: gint,
            hotY: gint,
        ): Unit = gtk_drag_icon_set_from_paintable(drag.gdkDragPointer, paintable.gdkPaintablePointer, hotX, hotY)
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_drag_icon_get_type")
    }
}
