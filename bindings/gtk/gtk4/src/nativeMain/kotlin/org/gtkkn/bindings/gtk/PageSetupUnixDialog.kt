...
public open class PageSetupUnixDialog(
     ...
     */
    public open fun setPageSetup(pageSetup: PageSetup): Unit = gtk_page_setup_unix_dialog_set_page_setup(gtkPageSetupUnixDialogPointer, pageSetup.gtkPageSetupPointer)
     ...
     */
    public open fun setPrintSettings(printSettings: PrintSettings? = null): Unit = gtk_page_setup_unix_dialog_set_print_settings(gtkPageSetupUnixDialogPointer, printSettings?.gtkPrintSettingsPointer)
