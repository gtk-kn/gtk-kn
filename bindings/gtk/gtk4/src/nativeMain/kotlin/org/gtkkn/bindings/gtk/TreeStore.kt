...
public open class TreeStore(
     ...
     */
    public open fun append(iter: TreeIter, parent: TreeIter? = null): Unit = gtk_tree_store_append(gtkTreeStorePointer.reinterpret(), iter.gtkTreeIterPointer.reinterpret(), parent?.gtkTreeIterPointer?.reinterpret())
    ...
    ): Unit = gtk_tree_store_insert_after(gtkTreeStorePointer.reinterpret(), iter.gtkTreeIterPointer.reinterpret(), parent?.gtkTreeIterPointer?.reinterpret(), sibling?.gtkTreeIterPointer?.reinterpret())
    ...
    public open fun insertBefore(
        ...
        parent: TreeIter? = null,
        sibling: TreeIter? = null,
    ): Unit = gtk_tree_store_insert_before(gtkTreeStorePointer.reinterpret(), iter.gtkTreeIterPointer.reinterpret(), parent?.gtkTreeIterPointer?.reinterpret(), sibling?.gtkTreeIterPointer?.reinterpret())
     ...
     */
    public open fun isAncestor(iter: TreeIter, descendant: TreeIter): Boolean = gtk_tree_store_is_ancestor(gtkTreeStorePointer.reinterpret(), iter.gtkTreeIterPointer.reinterpret(), descendant.gtkTreeIterPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun iterIsValid(iter: TreeIter): Boolean = gtk_tree_store_iter_is_valid(gtkTreeStorePointer.reinterpret(), iter.gtkTreeIterPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun moveAfter(iter: TreeIter, position: TreeIter? = null): Unit = gtk_tree_store_move_after(gtkTreeStorePointer.reinterpret(), iter.gtkTreeIterPointer.reinterpret(), position?.gtkTreeIterPointer?.reinterpret())
     ...
     * @param position A `GtkTreeIter`
     */
    public open fun moveBefore(iter: TreeIter, position: TreeIter? = null): Unit = gtk_tree_store_move_before(gtkTreeStorePointer.reinterpret(), iter.gtkTreeIterPointer.reinterpret(), position?.gtkTreeIterPointer?.reinterpret())
     ...
     * @param parent A valid `GtkTreeIter`
     */
    public open fun prepend(iter: TreeIter, parent: TreeIter? = null): Unit = gtk_tree_store_prepend(gtkTreeStorePointer.reinterpret(), iter.gtkTreeIterPointer.reinterpret(), parent?.gtkTreeIterPointer?.reinterpret())
     ...
     */
    public open fun remove(iter: TreeIter): Boolean = gtk_tree_store_remove(gtkTreeStorePointer.reinterpret(), iter.gtkTreeIterPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun swap(a: TreeIter, b: TreeIter): Unit = gtk_tree_store_swap(gtkTreeStorePointer.reinterpret(), a.gtkTreeIterPointer.reinterpret(), b.gtkTreeIterPointer.reinterpret())
