...
public open class ToggleButton(
    ...
    public companion object : TypeCompanion<ToggleButton> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_toggle_button_get_type")
         ...
         */
        public fun withMnemonic(label: String): ToggleButton = ToggleButton(gtk_toggle_button_new_with_mnemonic(label)!!.reinterpret()).apply  {
            InstanceCache.put(this)
        }
    }
}
