...
public interface Scrollable : Interface, KGTyped {
    ...
    public var hadjustment: Adjustment?
         ...
         */
        set(hadjustment) = gtk_scrollable_set_hadjustment(gtkScrollablePointer.reinterpret(), hadjustment?.gtkAdjustmentPointer?.reinterpret())
    ...
    public var vadjustment: Adjustment?
         ...
         */
        set(vadjustment) = gtk_scrollable_set_vadjustment(gtkScrollablePointer.reinterpret(), vadjustment?.gtkAdjustmentPointer?.reinterpret())
     ...
     */
    public fun getBorder(border: Border): Boolean = gtk_scrollable_get_border(gtkScrollablePointer.reinterpret(), border.gtkBorderPointer.reinterpret()).asBoolean()
     ...
     * @return The horizontal `GtkScrollablePolicy`.
     */
    public fun getHscrollPolicy(): ScrollablePolicy = gtk_scrollable_get_hscroll_policy(gtkScrollablePointer.reinterpret()).run {
        ScrollablePolicy.fromNativeValue(this)}
     ...
     * @return The vertical `GtkScrollablePolicy`.
     */
    public fun getVscrollPolicy(): ScrollablePolicy = gtk_scrollable_get_vscroll_policy(gtkScrollablePointer.reinterpret()).run {
        ScrollablePolicy.fromNativeValue(this)}
     ...
     * @param hadjustment a `GtkAdjustment`
     */
    public fun setHadjustment(hadjustment: Adjustment? = null): Unit = gtk_scrollable_set_hadjustment(gtkScrollablePointer.reinterpret(), hadjustment?.gtkAdjustmentPointer?.reinterpret())
     ...
     * @param policy the horizontal `GtkScrollablePolicy`
     */
    public fun setHscrollPolicy(policy: ScrollablePolicy): Unit = gtk_scrollable_set_hscroll_policy(gtkScrollablePointer.reinterpret(), policy.nativeValue)
     ...
     * @param vadjustment a `GtkAdjustment`
     */
    public fun setVadjustment(vadjustment: Adjustment? = null): Unit = gtk_scrollable_set_vadjustment(gtkScrollablePointer.reinterpret(), vadjustment?.gtkAdjustmentPointer?.reinterpret())
     ...
     * @param policy the vertical `GtkScrollablePolicy`
     */
    public fun setVscrollPolicy(policy: ScrollablePolicy): Unit = gtk_scrollable_set_vscroll_policy(gtkScrollablePointer.reinterpret(), policy.nativeValue)
