 ...
 */
public interface StyleProvider : Proxy, KGTyped {
     ...
     */
    public fun onGtkPrivateChanged(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong = g_signal_connect_data(gtkStyleProviderPointer, "gtk-private-changed", onGtkPrivateChangedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
    ...
    public companion object : TypeCompanion<StyleProvider> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_style_provider_get_type")
    }
}
