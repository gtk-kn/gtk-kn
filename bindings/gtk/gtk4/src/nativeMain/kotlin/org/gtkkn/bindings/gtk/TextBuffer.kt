...
public open class TextBuffer(
    ...
    public open val tagTable: TextTagTable
         ...
         */
        get() = gtk_text_buffer_get_tag_table(gtkTextBufferPointer.reinterpret())!!.run {
     ...
     */
    public constructor(table: TextTagTable? = null) : this(gtk_text_buffer_new(table?.gtkTextTagTablePointer?.reinterpret())!!.reinterpret())
     ...
     */
    public open fun addMark(mark: TextMark, `where`: TextIter): Unit = gtk_text_buffer_add_mark(gtkTextBufferPointer.reinterpret(), mark.gtkTextMarkPointer.reinterpret(), `where`.gtkTextIterPointer.reinterpret())
     ...
     */
    public open fun addSelectionClipboard(clipboard: Clipboard): Unit = gtk_text_buffer_add_selection_clipboard(gtkTextBufferPointer.reinterpret(), clipboard.gdkClipboardPointer.reinterpret())
    ...
    ): Unit = gtk_text_buffer_apply_tag(gtkTextBufferPointer.reinterpret(), tag.gtkTextTagPointer.reinterpret(), start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret())
    ...
    ): Unit = gtk_text_buffer_apply_tag_by_name(gtkTextBufferPointer.reinterpret(), name, start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret())
    ...
    ): Boolean = gtk_text_buffer_backspace(gtkTextBufferPointer.reinterpret(), iter.gtkTextIterPointer.reinterpret(), interactive.asGBoolean(), defaultEditable.asGBoolean()).asBoolean()
     ...
     */
    public open fun beginIrreversibleAction(): Unit = gtk_text_buffer_begin_irreversible_action(gtkTextBufferPointer.reinterpret())
     ...
     */
    public open fun copyClipboard(clipboard: Clipboard): Unit = gtk_text_buffer_copy_clipboard(gtkTextBufferPointer.reinterpret(), clipboard.gdkClipboardPointer.reinterpret())
     ...
     */
    public open fun createChildAnchor(iter: TextIter): TextChildAnchor = gtk_text_buffer_create_child_anchor(gtkTextBufferPointer.reinterpret(), iter.gtkTextIterPointer.reinterpret())!!.run {
    ...
    public open fun createMark(
        ...
        `where`: TextIter,
        leftGravity: Boolean,
    ): TextMark = gtk_text_buffer_create_mark(gtkTextBufferPointer.reinterpret(), markName, `where`.gtkTextIterPointer.reinterpret(), leftGravity.asGBoolean())!!.run {
     ...
     */
    public open fun cutClipboard(clipboard: Clipboard, defaultEditable: Boolean): Unit = gtk_text_buffer_cut_clipboard(gtkTextBufferPointer.reinterpret(), clipboard.gdkClipboardPointer.reinterpret(), defaultEditable.asGBoolean())
     ...
     */
    public open fun delete(start: TextIter, end: TextIter): Unit = gtk_text_buffer_delete(gtkTextBufferPointer.reinterpret(), start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret())
    ...
    public open fun deleteInteractive(
        ...
        endIter: TextIter,
        defaultEditable: Boolean,
    ): Boolean = gtk_text_buffer_delete_interactive(gtkTextBufferPointer.reinterpret(), startIter.gtkTextIterPointer.reinterpret(), endIter.gtkTextIterPointer.reinterpret(), defaultEditable.asGBoolean()).asBoolean()
     ...
     */
    public open fun deleteMark(mark: TextMark): Unit = gtk_text_buffer_delete_mark(gtkTextBufferPointer.reinterpret(), mark.gtkTextMarkPointer.reinterpret())
     ...
     */
    public open fun deleteMarkByName(name: String): Unit = gtk_text_buffer_delete_mark_by_name(gtkTextBufferPointer.reinterpret(), name)
     ...
     */
    public open fun deleteSelection(interactive: Boolean, defaultEditable: Boolean): Boolean = gtk_text_buffer_delete_selection(gtkTextBufferPointer.reinterpret(), interactive.asGBoolean(), defaultEditable.asGBoolean()).asBoolean()
     ...
     * and gtk_text_buffer_end_irreversible_action() pairs.
     */
    public open fun endIrreversibleAction(): Unit = gtk_text_buffer_end_irreversible_action(gtkTextBufferPointer.reinterpret())
     ...
     */
    public open fun getBounds(start: TextIter, end: TextIter): Unit = gtk_text_buffer_get_bounds(gtkTextBufferPointer.reinterpret(), start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret())
     ...
     */
    public open fun getEndIter(iter: TextIter): Unit = gtk_text_buffer_get_end_iter(gtkTextBufferPointer.reinterpret(), iter.gtkTextIterPointer.reinterpret())
     ...
     */
    public open fun getInsert(): TextMark = gtk_text_buffer_get_insert(gtkTextBufferPointer.reinterpret())!!.run {
        TextMark(reinterpret())}
     ...
     */
    public open fun getIterAtChildAnchor(iter: TextIter, anchor: TextChildAnchor): Unit = gtk_text_buffer_get_iter_at_child_anchor(gtkTextBufferPointer.reinterpret(), iter.gtkTextIterPointer.reinterpret(), anchor.gtkTextChildAnchorPointer.reinterpret())
     ...
     * @param mark a `GtkTextMark` in @buffer
     */
    public open fun getIterAtMark(iter: TextIter, mark: TextMark): Unit = gtk_text_buffer_get_iter_at_mark(gtkTextBufferPointer.reinterpret(), iter.gtkTextIterPointer.reinterpret(), mark.gtkTextMarkPointer.reinterpret())
     ...
     */
    public open fun getMark(name: String): TextMark? = gtk_text_buffer_get_mark(gtkTextBufferPointer.reinterpret(), name)?.run {
        TextMark(reinterpret())}
     ...
     */
    public open fun getModified(): Boolean = gtk_text_buffer_get_modified(gtkTextBufferPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun getSelectionBound(): TextMark = gtk_text_buffer_get_selection_bound(gtkTextBufferPointer.reinterpret())!!.run {
        TextMark(reinterpret())}
     ...
     */
    public open fun getSelectionBounds(start: TextIter, end: TextIter): Boolean = gtk_text_buffer_get_selection_bounds(gtkTextBufferPointer.reinterpret(), start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun getSelectionContent(): ContentProvider = gtk_text_buffer_get_selection_content(gtkTextBufferPointer.reinterpret())!!.run {
    ...
    ): String = gtk_text_buffer_get_slice(gtkTextBufferPointer.reinterpret(), start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret(), includeHiddenChars.asGBoolean())?.toKString() ?: error("Expected not null string")
     ...
     * @param iter iterator to initialize
     */
    public open fun getStartIter(iter: TextIter): Unit = gtk_text_buffer_get_start_iter(gtkTextBufferPointer.reinterpret(), iter.gtkTextIterPointer.reinterpret())
    ...
    public open fun getText(
        ...
        includeHiddenChars: Boolean,
    ): String = gtk_text_buffer_get_text(gtkTextBufferPointer.reinterpret(), start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret(), includeHiddenChars.asGBoolean())?.toKString() ?: error("Expected not null string")
     ...
     */
    public open fun insertChildAnchor(iter: TextIter, anchor: TextChildAnchor): Unit = gtk_text_buffer_insert_child_anchor(gtkTextBufferPointer.reinterpret(), iter.gtkTextIterPointer.reinterpret(), anchor.gtkTextChildAnchorPointer.reinterpret())
     ...
     */
    public open fun insertPaintable(iter: TextIter, paintable: Paintable): Unit = gtk_text_buffer_insert_paintable(gtkTextBufferPointer.reinterpret(), iter.gtkTextIterPointer.reinterpret(), paintable.gdkPaintablePointer)
    ...
    ): Unit = gtk_text_buffer_insert_range(gtkTextBufferPointer.reinterpret(), iter.gtkTextIterPointer.reinterpret(), start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret())
    ...
    public open fun insertRangeInteractive(
        ...
        defaultEditable: Boolean,
    ): Boolean = gtk_text_buffer_insert_range_interactive(gtkTextBufferPointer.reinterpret(), iter.gtkTextIterPointer.reinterpret(), start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret(), defaultEditable.asGBoolean()).asBoolean()
     ...
     */
    public open fun moveMark(mark: TextMark, `where`: TextIter): Unit = gtk_text_buffer_move_mark(gtkTextBufferPointer.reinterpret(), mark.gtkTextMarkPointer.reinterpret(), `where`.gtkTextIterPointer.reinterpret())
     ...
     */
    public open fun moveMarkByName(name: String, `where`: TextIter): Unit = gtk_text_buffer_move_mark_by_name(gtkTextBufferPointer.reinterpret(), name, `where`.gtkTextIterPointer.reinterpret())
    ...
    public open fun pasteClipboard(
        ...
        defaultEditable: Boolean,
    ): Unit = gtk_text_buffer_paste_clipboard(gtkTextBufferPointer.reinterpret(), clipboard.gdkClipboardPointer.reinterpret(), overrideLocation?.gtkTextIterPointer?.reinterpret(), defaultEditable.asGBoolean())
     ...
     */
    public open fun placeCursor(`where`: TextIter): Unit = gtk_text_buffer_place_cursor(gtkTextBufferPointer.reinterpret(), `where`.gtkTextIterPointer.reinterpret())
     ...
     */
    public open fun removeAllTags(start: TextIter, end: TextIter): Unit = gtk_text_buffer_remove_all_tags(gtkTextBufferPointer.reinterpret(), start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret())
     ...
     *   [method@Gtk.TextBuffer.add_selection_clipboard]
     */
    public open fun removeSelectionClipboard(clipboard: Clipboard): Unit = gtk_text_buffer_remove_selection_clipboard(gtkTextBufferPointer.reinterpret(), clipboard.gdkClipboardPointer.reinterpret())
    ...
    ): Unit = gtk_text_buffer_remove_tag(gtkTextBufferPointer.reinterpret(), tag.gtkTextTagPointer.reinterpret(), start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret())
    ...
    ): Unit = gtk_text_buffer_remove_tag_by_name(gtkTextBufferPointer.reinterpret(), name, start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret())
     ...
     */
    public open fun selectRange(ins: TextIter, bound: TextIter): Unit = gtk_text_buffer_select_range(gtkTextBufferPointer.reinterpret(), ins.gtkTextIterPointer.reinterpret(), bound.gtkTextIterPointer.reinterpret())
     ...
     */
    public open fun setModified(setting: Boolean): Unit = gtk_text_buffer_set_modified(gtkTextBufferPointer.reinterpret(), setting.asGBoolean())
     ...
     */
    public fun connectApplyTag(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (
        tag: TextTag,
        start: TextIter,
        end: TextIter,
    ) -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "apply-tag", connectApplyTagFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectBeginUserAction(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "begin-user-action", connectBeginUserActionFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectDeleteRange(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (start: TextIter, end: TextIter) -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "delete-range", connectDeleteRangeFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect
     */
    public fun connectEndUserAction(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "end-user-action", connectEndUserActionFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectInsertChildAnchor(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (location: TextIter, anchor: TextChildAnchor) -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "insert-child-anchor", connectInsertChildAnchorFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectInsertPaintable(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (location: TextIter, paintable: Paintable) -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "insert-paintable", connectInsertPaintableFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectMarkDeleted(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (mark: TextMark) -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "mark-deleted", connectMarkDeletedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectMarkSet(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (location: TextIter, mark: TextMark) -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "mark-set", connectMarkSetFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect
     */
    public fun connectModifiedChanged(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "modified-changed", connectModifiedChangedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectPasteDone(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (clipboard: Clipboard) -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "paste-done", connectPasteDoneFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect
     */
    public fun connectRedo(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "redo", connectRedoFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectRemoveTag(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (
        tag: TextTag,
        start: TextIter,
        end: TextIter,
    ) -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "remove-tag", connectRemoveTagFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect
     */
    public fun connectUndo(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "undo", connectUndoFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
...
private val connectApplyTagFunc: CPointer<CFunction<(
    CPointer<GtkTextTag>,
...
private val connectBeginUserActionFunc: CPointer<CFunction<() -> Unit>> = staticCFunction {
    _: COpaquePointer,
    userData: COpaquePointer
    ->
...
private val connectEndUserActionFunc: CPointer<CFunction<() -> Unit>> = staticCFunction {
    _: COpaquePointer,
    userData: COpaquePointer
    ->
    userData.asStableRef<() -> Unit>().get().invoke()}
...
private val connectModifiedChangedFunc: CPointer<CFunction<() -> Unit>> = staticCFunction {
    _: COpaquePointer,
    userData: COpaquePointer
    ->
    userData.asStableRef<() -> Unit>().get().invoke()}
...
private val connectRedoFunc: CPointer<CFunction<() -> Unit>> = staticCFunction {
    _: COpaquePointer,
    userData: COpaquePointer
    ->
    userData.asStableRef<() -> Unit>().get().invoke()}
...
private val connectRemoveTagFunc: CPointer<CFunction<(
    CPointer<GtkTextTag>,
    CPointer<GtkTextIter>,
    CPointer<GtkTextIter>,
) -> Unit>> = staticCFunction {
...
private val connectUndoFunc: CPointer<CFunction<() -> Unit>> = staticCFunction {
    _: COpaquePointer,
    userData: COpaquePointer
    ->
    userData.asStableRef<() -> Unit>().get().invoke()}
