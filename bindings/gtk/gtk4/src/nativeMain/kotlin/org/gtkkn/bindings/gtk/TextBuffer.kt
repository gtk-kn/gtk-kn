...
public open class TextBuffer(pointer: CPointer<GtkTextBuffer>) :
     ...
     */
    public open fun createChildAnchor(iter: TextIter): TextChildAnchor = gtk_text_buffer_create_child_anchor(
        gtkTextBufferPointer.reinterpret(),
        iter.gtkTextIterPointer.reinterpret()
    )!!.run {
     ...
     */
    public open fun getIterAtLine(iter: TextIter, lineNumber: Int): Boolean = gtk_text_buffer_get_iter_at_line(
        gtkTextBufferPointer.reinterpret(),
        iter.gtkTextIterPointer.reinterpret(),
        lineNumber
    ).asBoolean()
     ...
     * @return whether the exact position has been found
     */
    public open fun getIterAtLineIndex(iter: TextIter, lineNumber: Int, byteIndex: Int): Boolean =
     ...
     * @return whether the exact position has been found
     */
    public open fun getIterAtLineOffset(iter: TextIter, lineNumber: Int, charOffset: Int): Boolean =
     ...
     */
    public open fun getIterAtOffset(iter: TextIter, charOffset: Int): Unit = gtk_text_buffer_get_iter_at_offset(
        gtkTextBufferPointer.reinterpret(),
        iter.gtkTextIterPointer.reinterpret(),
        charOffset
    )
     ...
     */
    public open fun insert(iter: TextIter, text: String, len: Int): Unit =
     ...
     */
    public open fun insertAtCursor(text: String, len: Int): Unit =
     ...
     */
    public open fun insertInteractive(iter: TextIter, text: String, len: Int, defaultEditable: Boolean): Boolean =
     ...
     * @return whether text was actually inserted
     */
    public open fun insertInteractiveAtCursor(text: String, len: Int, defaultEditable: Boolean): Boolean =
     ...
     */
    public open fun insertMarkup(iter: TextIter, markup: String, len: Int): Unit = gtk_text_buffer_insert_markup(
        gtkTextBufferPointer.reinterpret(),
        iter.gtkTextIterPointer.reinterpret(),
        markup,
        len
     ...
     */
    public open fun moveMarkByName(name: String, `where`: TextIter): Unit = gtk_text_buffer_move_mark_by_name(
        gtkTextBufferPointer.reinterpret(),
        name,
        `where`.gtkTextIterPointer.reinterpret()
    )
     ...
     * @param len length of @text in bytes
     */
    public open fun setText(text: String, len: Int): Unit =
