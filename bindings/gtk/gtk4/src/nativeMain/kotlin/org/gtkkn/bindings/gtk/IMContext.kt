...
public open class IMContext(pointer: CPointer<GtkIMContext>) :
     ...
     */
    public open fun deleteSurrounding(offset: Int, nChars: Int): Boolean =
     ...
     */
    public open fun setSurrounding(text: String, len: Int, cursorIndex: Int): Unit =
     ...
     */
    @GtkVersion4_2
    public open fun setSurroundingWithSelection(text: String, len: Int, cursorIndex: Int, anchorIndex: Int): Unit =
