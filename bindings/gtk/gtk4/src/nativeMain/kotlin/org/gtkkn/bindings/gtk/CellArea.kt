...
public abstract class CellArea(
     ...
     * @param cellArea the `GtkWidget` relative `GdkRectangle` coordinates
    ...
    public companion object : TypeCompanion<CellArea> {
        override val type: GeneratedClassKGType<CellArea> =
                GeneratedClassKGType(getTypeOrNull()!!) { CellAreaImpl(it.reinterpret()) }
        ...
        /**
         * Gets the GType of from the symbol `gtk_cell_area_get_type` if it exists.
         *
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_cell_area_get_type")
    }
}
