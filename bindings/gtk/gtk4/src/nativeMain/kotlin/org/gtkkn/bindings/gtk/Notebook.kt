...
public open class Notebook(
     ...
     */
    public open fun appendPage(child: Widget, tabLabel: Widget? = null): gint = gtk_notebook_append_page(gtkNotebookPointer, child.gtkWidgetPointer, tabLabel?.gtkWidgetPointer)
    ...
    ): gint = gtk_notebook_append_page_menu(gtkNotebookPointer, child.gtkWidgetPointer, tabLabel?.gtkWidgetPointer, menuLabel?.gtkWidgetPointer)
     ...
     */
    public open fun getMenuLabelText(child: Widget): String? = gtk_notebook_get_menu_label_text(gtkNotebookPointer, child.gtkWidgetPointer)?.toKString()
     ...
     */
    public open fun getTabDetachable(child: Widget): Boolean = gtk_notebook_get_tab_detachable(gtkNotebookPointer, child.gtkWidgetPointer).asBoolean()
     ...
     */
    public open fun getTabLabelText(child: Widget): String? = gtk_notebook_get_tab_label_text(gtkNotebookPointer, child.gtkWidgetPointer)?.toKString()
     ...
     */
    public open fun getTabReorderable(child: Widget): Boolean = gtk_notebook_get_tab_reorderable(gtkNotebookPointer, child.gtkWidgetPointer).asBoolean()
    ...
    public open fun insertPage(
        ...
        tabLabel: Widget? = null,
        position: gint,
    ): gint = gtk_notebook_insert_page(gtkNotebookPointer, child.gtkWidgetPointer, tabLabel?.gtkWidgetPointer, position)
    ...
    public open fun insertPageMenu(
        ...
        menuLabel: Widget? = null,
        position: gint,
    ): gint = gtk_notebook_insert_page_menu(gtkNotebookPointer, child.gtkWidgetPointer, tabLabel?.gtkWidgetPointer, menuLabel?.gtkWidgetPointer, position)
     ...
     *   page in the notebook, or -1 if function fails
     */
    public open fun prependPage(child: Widget, tabLabel: Widget? = null): gint = gtk_notebook_prepend_page(gtkNotebookPointer, child.gtkWidgetPointer, tabLabel?.gtkWidgetPointer)
    ...
    public open fun prependPageMenu(
        ...
        tabLabel: Widget? = null,
        menuLabel: Widget? = null,
    ): gint = gtk_notebook_prepend_page_menu(gtkNotebookPointer, child.gtkWidgetPointer, tabLabel?.gtkWidgetPointer, menuLabel?.gtkWidgetPointer)
     ...
     */
    public open fun reorderChild(child: Widget, position: gint): Unit = gtk_notebook_reorder_child(gtkNotebookPointer, child.gtkWidgetPointer, position)
     ...
     */
    public open fun setActionWidget(widget: Widget, packType: PackType): Unit = gtk_notebook_set_action_widget(gtkNotebookPointer, widget.gtkWidgetPointer, packType.nativeValue)
     ...
     */
    public open fun setMenuLabel(child: Widget, menuLabel: Widget? = null): Unit = gtk_notebook_set_menu_label(gtkNotebookPointer, child.gtkWidgetPointer, menuLabel?.gtkWidgetPointer)
     ...
     */
    public open fun setMenuLabelText(child: Widget, menuText: String): Unit = gtk_notebook_set_menu_label_text(gtkNotebookPointer, child.gtkWidgetPointer, menuText)
     ...
     */
    public open fun setTabDetachable(child: Widget, detachable: Boolean): Unit = gtk_notebook_set_tab_detachable(gtkNotebookPointer, child.gtkWidgetPointer, detachable.asGBoolean())
     ...
     */
    public open fun setTabLabel(child: Widget, tabLabel: Widget? = null): Unit = gtk_notebook_set_tab_label(gtkNotebookPointer, child.gtkWidgetPointer, tabLabel?.gtkWidgetPointer)
     ...
     */
    public open fun setTabLabelText(child: Widget, tabText: String): Unit = gtk_notebook_set_tab_label_text(gtkNotebookPointer, child.gtkWidgetPointer, tabText)
     ...
     */
    public open fun setTabReorderable(child: Widget, reorderable: Boolean): Unit = gtk_notebook_set_tab_reorderable(gtkNotebookPointer, child.gtkWidgetPointer, reorderable.asGBoolean())
     ...
     */
    public fun onChangeCurrentPage(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (`object`: gint) -> Boolean): ULong = g_signal_connect_data(gtkNotebookPointer, "change-current-page", onChangeCurrentPageFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun onCreateWindow(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (page: Widget) -> Notebook?): ULong = g_signal_connect_data(gtkNotebookPointer, "create-window", onCreateWindowFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect. Params: `object` 
     */
    public fun onFocusTab(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (`object`: NotebookTab) -> Boolean): ULong = g_signal_connect_data(gtkNotebookPointer, "focus-tab", onFocusTabFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect. Params: `object` 
     */
    public fun onMoveFocusOut(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (`object`: DirectionType) -> Unit): ULong = g_signal_connect_data(gtkNotebookPointer, "move-focus-out", onMoveFocusOutFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun onPageAdded(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (child: Widget, pageNum: guint) -> Unit): ULong = g_signal_connect_data(gtkNotebookPointer, "page-added", onPageAddedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
    ...
    public fun emitPageAdded(child: Widget, pageNum: guint) {
        g_signal_emit_by_name(gtkNotebookPointer.reinterpret(), "page-added", child.gtkWidgetPointer, pageNum)
    }
     ...
     */
    public fun onPageRemoved(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (child: Widget, pageNum: guint) -> Unit): ULong = g_signal_connect_data(gtkNotebookPointer, "page-removed", onPageRemovedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
    ...
    public fun emitPageRemoved(child: Widget, pageNum: guint) {
        g_signal_emit_by_name(gtkNotebookPointer.reinterpret(), "page-removed", child.gtkWidgetPointer, pageNum)
    }
     ...
     * @param handler the Callback to connect. Params: `child` the child `GtkWidget` affected; `pageNum` the new page number for @child
     */
    public fun onPageReordered(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (child: Widget, pageNum: guint) -> Unit): ULong = g_signal_connect_data(gtkNotebookPointer, "page-reordered", onPageReorderedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
    ...
    public fun emitPageReordered(child: Widget, pageNum: guint) {
        g_signal_emit_by_name(gtkNotebookPointer.reinterpret(), "page-reordered", child.gtkWidgetPointer, pageNum)
    }
     ...
     */
    public fun onReorderTab(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (`object`: DirectionType, p0: Boolean) -> Boolean): ULong = g_signal_connect_data(gtkNotebookPointer, "reorder-tab", onReorderTabFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect. Params: `object` 
     */
    public fun onSelectPage(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (`object`: Boolean) -> Boolean): ULong = g_signal_connect_data(gtkNotebookPointer, "select-page", onSelectPageFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun onSwitchPage(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (page: Widget, pageNum: guint) -> Unit): ULong = g_signal_connect_data(gtkNotebookPointer, "switch-page", onSwitchPageFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
    ...
    public fun emitSwitchPage(page: Widget, pageNum: guint) {
        g_signal_emit_by_name(gtkNotebookPointer.reinterpret(), "switch-page", page.gtkWidgetPointer, pageNum)
    }
