...
public class PaperSize(
    public val gtkPaperSizePointer: CPointer<GtkPaperSize>,
) : ProxyInstance(gtkPaperSizePointer) {
    /**
     ...
     */
    public fun getDefaultBottomMargin(unit: Unit): gdouble = gtk_paper_size_get_default_bottom_margin(gtkPaperSizePointer, unit.nativeValue)
     ...
     */
    public fun getDefaultLeftMargin(unit: Unit): gdouble = gtk_paper_size_get_default_left_margin(gtkPaperSizePointer, unit.nativeValue)
     ...
     */
    public fun getDefaultRightMargin(unit: Unit): gdouble = gtk_paper_size_get_default_right_margin(gtkPaperSizePointer, unit.nativeValue)
     ...
     */
    public fun getDefaultTopMargin(unit: Unit): gdouble = gtk_paper_size_get_default_top_margin(gtkPaperSizePointer, unit.nativeValue)
     ...
     */
    public fun getDisplayName(): String = gtk_paper_size_get_display_name(gtkPaperSizePointer)?.toKString() ?: error("Expected not null string")
     ...
     */
    public fun getName(): String = gtk_paper_size_get_name(gtkPaperSizePointer)?.toKString() ?: error("Expected not null string")
     ...
     */
    public fun getPpdName(): String = gtk_paper_size_get_ppd_name(gtkPaperSizePointer)?.toKString() ?: error("Expected not null string")
     ...
     */
    public fun isEqual(size2: PaperSize): Boolean = gtk_paper_size_is_equal(gtkPaperSizePointer, size2.gtkPaperSizePointer).asBoolean()
    ...
    public fun setSize(
        ...
        height: gdouble,
        unit: Unit,
    ): kotlin.Unit = gtk_paper_size_set_size(gtkPaperSizePointer, width, height, unit.nativeValue)
     ...
     */
    public fun toKeyFile(keyFile: KeyFile, groupName: String): kotlin.Unit = gtk_paper_size_to_key_file(gtkPaperSizePointer, keyFile.glibKeyFilePointer, groupName)
