...
public open class ListItem(
    ...
    public open var accessibleDescription: String
         ...
         * @since 4.12
         */
        get() = gtk_list_item_get_accessible_description(gtkListItemPointer)?.toKString() ?: error("Expected not null string")
        /**
    ...
    public companion object : TypeCompanion<ListItem> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_list_item_get_type")
    }
}
