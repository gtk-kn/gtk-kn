...
public open class Box(
     ...
     */
    public open fun append(child: Widget): Unit = gtk_box_append(gtkBoxPointer.reinterpret(), child.gtkWidgetPointer.reinterpret())
     ...
     */
    public open fun insertChildAfter(child: Widget, sibling: Widget? = null): Unit = gtk_box_insert_child_after(gtkBoxPointer.reinterpret(), child.gtkWidgetPointer.reinterpret(), sibling?.gtkWidgetPointer?.reinterpret())
     ...
     */
    public open fun prepend(child: Widget): Unit = gtk_box_prepend(gtkBoxPointer.reinterpret(), child.gtkWidgetPointer.reinterpret())
     ...
     */
    public open fun remove(child: Widget): Unit = gtk_box_remove(gtkBoxPointer.reinterpret(), child.gtkWidgetPointer.reinterpret())
     ...
     */
    public open fun reorderChildAfter(child: Widget, sibling: Widget? = null): Unit = gtk_box_reorder_child_after(gtkBoxPointer.reinterpret(), child.gtkWidgetPointer.reinterpret(), sibling?.gtkWidgetPointer?.reinterpret())
