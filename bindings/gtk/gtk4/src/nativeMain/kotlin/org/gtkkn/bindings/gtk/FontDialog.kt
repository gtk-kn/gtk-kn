...
public open class FontDialog(
    ...
    public open var filter: Filter?
         ...
         * @since 4.10
         */
        get() = gtk_font_dialog_get_filter(gtkFontDialogPointer.reinterpret())?.run {
            Filter(reinterpret())}
        /**
         ...
         */
        @GtkVersion4_10
        set(filter) = gtk_font_dialog_set_filter(gtkFontDialogPointer.reinterpret(), filter?.gtkFilterPointer?.reinterpret())
    ...
    public open var fontMap: FontMap?
         ...
         * @since 4.10
         */
        get() = gtk_font_dialog_get_font_map(gtkFontDialogPointer.reinterpret())?.run {
            FontMap(reinterpret())}
        /**
         ...
         */
        @GtkVersion4_10
        set(fontmap) = gtk_font_dialog_set_font_map(gtkFontDialogPointer.reinterpret(), fontmap?.pangoFontMapPointer?.reinterpret())
    ...
    public open var title: String
         ...
         * @since 4.10
         */
        get() = gtk_font_dialog_get_title(gtkFontDialogPointer.reinterpret())?.toKString() ?: error("Expected not null string")
        /**
    ...
    ): Unit = gtk_font_dialog_choose_face(gtkFontDialogPointer.reinterpret(), parent?.gtkWindowPointer?.reinterpret(), initialValue?.pangoFontFacePointer?.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public open fun chooseFaceFinish(result: AsyncResult): Result<FontFace?> = memScoped {
        ...
        val gResult = gtk_font_dialog_choose_face_finish(gtkFontDialogPointer.reinterpret(), result.gioAsyncResultPointer, gError.ptr)?.run {
    ...
    public open fun chooseFamily(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = gtk_font_dialog_choose_family(gtkFontDialogPointer.reinterpret(), parent?.gtkWindowPointer?.reinterpret(), initialValue?.pangoFontFamilyPointer?.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public open fun chooseFamilyFinish(result: AsyncResult): Result<FontFamily?> = memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = gtk_font_dialog_choose_family_finish(gtkFontDialogPointer.reinterpret(), result.gioAsyncResultPointer, gError.ptr)?.run {
    ...
    public open fun chooseFont(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = gtk_font_dialog_choose_font(gtkFontDialogPointer.reinterpret(), parent?.gtkWindowPointer?.reinterpret(), initialValue?.pangoFontDescriptionPointer?.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public open fun chooseFontAndFeatures(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = gtk_font_dialog_choose_font_and_features(gtkFontDialogPointer.reinterpret(), parent?.gtkWindowPointer?.reinterpret(), initialValue?.pangoFontDescriptionPointer?.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public open fun chooseFontFinish(result: AsyncResult): Result<FontDescription?> = memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = gtk_font_dialog_choose_font_finish(gtkFontDialogPointer.reinterpret(), result.gioAsyncResultPointer, gError.ptr)?.run {
     ...
     */
    @GtkVersion4_10
    public open fun getLanguage(): Language? = gtk_font_dialog_get_language(gtkFontDialogPointer.reinterpret())?.run {
     ...
     */
    @GtkVersion4_10
    public open fun setLanguage(language: Language): Unit = gtk_font_dialog_set_language(gtkFontDialogPointer.reinterpret(), language.pangoLanguagePointer.reinterpret())
