...
public open class FixedLayoutChild(
     ...
     */
    public open fun setTransform(transform: Transform): Unit = gtk_fixed_layout_child_set_transform(gtkFixedLayoutChildPointer, transform.gskTransformPointer)
    ...
    public companion object : TypeCompanion<FixedLayoutChild> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_fixed_layout_child_get_type")
    }
}
