...
public open class EventControllerMotion(
     ...
     */
    public open fun containsPointer(): Boolean = gtk_event_controller_motion_contains_pointer(gtkEventControllerMotionPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun isPointer(): Boolean = gtk_event_controller_motion_is_pointer(gtkEventControllerMotionPointer.reinterpret()).asBoolean()
