...
public open class Range(
    ...
    public open var restrictToFillLevel: Boolean
         ...
         */
        set(restrictToFillLevel) = gtk_range_set_restrict_to_fill_level(gtkRangePointer, restrictToFillLevel.asGBoolean())
     ...
     */
    public open fun getRangeRect(rangeRect: Rectangle): Unit = gtk_range_get_range_rect(gtkRangePointer, rangeRect.gdkRectanglePointer)
     ...
     */
    public open fun setFlippable(flippable: Boolean): Unit = gtk_range_set_flippable(gtkRangePointer, flippable.asGBoolean())
     ...
     */
    public open fun setIncrements(step: gdouble, page: gdouble): Unit = gtk_range_set_increments(gtkRangePointer, step, page)
     ...
     */
    public open fun setSliderSizeFixed(sizeFixed: Boolean): Unit = gtk_range_set_slider_size_fixed(gtkRangePointer, sizeFixed.asGBoolean())
     ...
     */
    public fun onAdjustBounds(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (`value`: gdouble) -> Unit): ULong = g_signal_connect_data(gtkRangePointer, "adjust-bounds", onAdjustBoundsFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun onChangeValue(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (scroll: ScrollType, `value`: gdouble) -> Boolean): ULong = g_signal_connect_data(gtkRangePointer, "change-value", onChangeValueFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun onMoveSlider(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (step: ScrollType) -> Unit): ULong = g_signal_connect_data(gtkRangePointer, "move-slider", onMoveSliderFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun onValueChanged(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong = g_signal_connect_data(gtkRangePointer, "value-changed", onValueChangedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
...
private val onMoveSliderFunc: CPointer<CFunction<(GtkScrollType) -> Unit>> = staticCFunction {
    ...
    userData: COpaquePointer
    ->
    userData.asStableRef<(step: ScrollType) -> Unit>().get().invoke(step.run {
        ScrollType.fromNativeValue(this)}
    )}
.reinterpret()
