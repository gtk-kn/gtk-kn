...
public open class PopoverMenuBar(
    ...
    public open var menuModel: MenuModel?
         ...
         */
        set(model) = gtk_popover_menu_bar_set_menu_model(gtkPopoverMenuBarPointer.reinterpret(), model?.gioMenuModelPointer?.reinterpret())
     ...
     */
    public constructor(model: MenuModel? = null) : this(gtk_popover_menu_bar_new_from_model(model?.gioMenuModelPointer?.reinterpret())!!.reinterpret())
     ...
     */
    public open fun addChild(child: Widget, id: String): Boolean = gtk_popover_menu_bar_add_child(gtkPopoverMenuBarPointer.reinterpret(), child.gtkWidgetPointer.reinterpret(), id).asBoolean()
     ...
     */
    public open fun removeChild(child: Widget): Boolean = gtk_popover_menu_bar_remove_child(gtkPopoverMenuBarPointer.reinterpret(), child.gtkWidgetPointer.reinterpret()).asBoolean()
