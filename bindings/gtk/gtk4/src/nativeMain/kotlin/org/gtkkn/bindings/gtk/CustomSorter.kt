...
public open class CustomSorter(
     ...
     */
    public constructor(sortFunc: CompareDataFunc) : this(gtk_custom_sorter_new(CompareDataFuncFunc.reinterpret(), StableRef.create(sortFunc).asCPointer(), staticStableRefDestroy.reinterpret())!!.reinterpret())
     ...
     */
    public open fun setSortFunc(sortFunc: CompareDataFunc): Unit = gtk_custom_sorter_set_sort_func(gtkCustomSorterPointer.reinterpret(), CompareDataFuncFunc.reinterpret(), StableRef.create(sortFunc).asCPointer(), staticStableRefDestroy.reinterpret())
