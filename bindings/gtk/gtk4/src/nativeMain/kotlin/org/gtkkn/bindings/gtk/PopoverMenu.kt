...
public open class PopoverMenu(
    ...
    public open var flags: PopoverMenuFlags
         ...
         * @since 4.14
         */
        get() = gtk_popover_menu_get_flags(gtkPopoverMenuPointer.reinterpret()).run {
    ...
    public open var menuModel: MenuModel?
         ...
         */
        get() = gtk_popover_menu_get_menu_model(gtkPopoverMenuPointer.reinterpret())?.run {
         ...
         */
        set(model) = gtk_popover_menu_set_menu_model(gtkPopoverMenuPointer.reinterpret(), model?.gioMenuModelPointer?.reinterpret())
     ...
     */
    public constructor(model: MenuModel? = null) : this(gtk_popover_menu_new_from_model(model?.gioMenuModelPointer?.reinterpret())!!.reinterpret())
     ...
     * @return the new `GtkPopoverMenu`
     */
    public constructor(model: MenuModel, flags: PopoverMenuFlags) : this(gtk_popover_menu_new_from_model_full(model.gioMenuModelPointer.reinterpret(), flags.mask)!!.reinterpret())
     ...
     */
    public open fun addChild(child: Widget, id: String): Boolean = gtk_popover_menu_add_child(gtkPopoverMenuPointer.reinterpret(), child.gtkWidgetPointer.reinterpret(), id).asBoolean()
     ...
     */
    public open fun removeChild(child: Widget): Boolean = gtk_popover_menu_remove_child(gtkPopoverMenuPointer.reinterpret(), child.gtkWidgetPointer.reinterpret()).asBoolean()
