...
public open class PopoverMenu(public val gtkPopoverMenuPointer: CPointer<GtkPopoverMenu>) :
    ...
    public open var flags: PopoverMenuFlags
         ...
         */
        @GtkVersion4_14
        set(flags) = gtk_popover_menu_set_flags(gtkPopoverMenuPointer, flags.mask)
    ...
    public open var menuModel: MenuModel?
         ...
         */
        set(model) = gtk_popover_menu_set_menu_model(gtkPopoverMenuPointer, model?.gioMenuModelPointer)
    ...
    public companion object : TypeCompanion<PopoverMenu> {
        ...
        internal fun getTypeOrNull(): GType? =
            org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_popover_menu_get_type")
    }
}
