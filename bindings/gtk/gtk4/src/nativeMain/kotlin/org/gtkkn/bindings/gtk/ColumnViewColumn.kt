...
public open class ColumnViewColumn(
    ...
    public open val columnView: ColumnView?
         ...
         */
        get() = gtk_column_view_column_get_column_view(gtkColumnViewColumnPointer.reinterpret())?.run {
    ...
    public open var factory: ListItemFactory?
         ...
         */
        get() = gtk_column_view_column_get_factory(gtkColumnViewColumnPointer.reinterpret())?.run {
         ...
         */
        set(factory) = gtk_column_view_column_set_factory(gtkColumnViewColumnPointer.reinterpret(), factory?.gtkListItemFactoryPointer?.reinterpret())
    ...
    public open var headerMenu: MenuModel?
         ...
         */
        get() = gtk_column_view_column_get_header_menu(gtkColumnViewColumnPointer.reinterpret())?.run {
         ...
         */
        set(menu) = gtk_column_view_column_set_header_menu(gtkColumnViewColumnPointer.reinterpret(), menu?.gioMenuModelPointer?.reinterpret())
    ...
    public open var resizable: Boolean
         ...
         */
        set(resizable) = gtk_column_view_column_set_resizable(gtkColumnViewColumnPointer.reinterpret(), resizable.asGBoolean())
    ...
    public open var sorter: Sorter?
         ...
         */
        get() = gtk_column_view_column_get_sorter(gtkColumnViewColumnPointer.reinterpret())?.run {
            Sorter(reinterpret())}
        /**
         ...
         */
        set(sorter) = gtk_column_view_column_set_sorter(gtkColumnViewColumnPointer.reinterpret(), sorter?.gtkSorterPointer?.reinterpret())
    ...
    public open var visible: Boolean
         ...
         */
        set(visible) = gtk_column_view_column_set_visible(gtkColumnViewColumnPointer.reinterpret(), visible.asGBoolean())
     ...
     */
    public constructor(title: String? = null, factory: ListItemFactory? = null) : this(gtk_column_view_column_new(title, factory?.gtkListItemFactoryPointer?.reinterpret())!!.reinterpret())
