...
public open class Sorter(public val gtkSorterPointer: CPointer<GtkSorter>) :
    ...
    public companion object : TypeCompanion<Sorter> {
        override val type: GeneratedClassKGType<Sorter> =
            GeneratedClassKGType(getTypeOrNull()!!) { Sorter(it.reinterpret()) }
        ...
        /**
         * Gets the GType of from the symbol `gtk_sorter_get_type` if it exists.
         *
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_sorter_get_type")
    }
}
