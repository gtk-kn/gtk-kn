...
public open class ConstraintLayout(
     ...
     */
    public open fun addConstraint(constraint: Constraint): Unit = gtk_constraint_layout_add_constraint(gtkConstraintLayoutPointer.reinterpret(), constraint.gtkConstraintPointer.reinterpret())
    ...
    public open fun addConstraintsFromDescription(
        ...
        val gResult = gtk_constraint_layout_add_constraints_from_descriptionv(gtkConstraintLayoutPointer.reinterpret(), lines.toCStringList(this), nLines, hspacing, vspacing, views.glibHashTablePointer.reinterpret(), gError.ptr)?.run {
     ...
     */
    public open fun addGuide(guide: ConstraintGuide): Unit = gtk_constraint_layout_add_guide(gtkConstraintLayoutPointer.reinterpret(), guide.gtkConstraintGuidePointer.reinterpret())
     ...
     */
    public open fun observeConstraints(): ListModel = gtk_constraint_layout_observe_constraints(gtkConstraintLayoutPointer.reinterpret())!!.run {
     ...
     */
    public open fun observeGuides(): ListModel = gtk_constraint_layout_observe_guides(gtkConstraintLayoutPointer.reinterpret())!!.run {
        ListModel.wrap(reinterpret())}

    /**
     * Removes all constraints from the layout manager.
     */
    public open fun removeAllConstraints(): Unit = gtk_constraint_layout_remove_all_constraints(gtkConstraintLayoutPointer.reinterpret())
     ...
     * @param constraint a [class@Gtk.Constraint]
     */
    public open fun removeConstraint(constraint: Constraint): Unit = gtk_constraint_layout_remove_constraint(gtkConstraintLayoutPointer.reinterpret(), constraint.gtkConstraintPointer.reinterpret())
     ...
     * @param guide a [class@Gtk.ConstraintGuide] object
     */
    public open fun removeGuide(guide: ConstraintGuide): Unit = gtk_constraint_layout_remove_guide(gtkConstraintLayoutPointer.reinterpret(), guide.gtkConstraintGuidePointer.reinterpret())
