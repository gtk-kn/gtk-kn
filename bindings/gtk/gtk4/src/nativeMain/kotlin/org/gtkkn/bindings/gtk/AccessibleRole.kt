...
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_CHECKBOX
...
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_FEED
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_FORM
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_GENERIC
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_GRID
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_GRID_CELL
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_GROUP
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_HEADING
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_IMG
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_INPUT
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_LABEL
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_LANDMARK
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_LEGEND
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_LINK
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_LIST
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_LIST_BOX
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_LIST_ITEM
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_LOG
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_MAIN
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_MARQUEE
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_MATH
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_MENU
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_MENU_BAR
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_MENU_ITEM
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_MENU_ITEM_CHECKBOX
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_MENU_ITEM_RADIO
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_METER
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_NAVIGATION
...
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_RADIO_GROUP
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_RANGE
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_REGION
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_ROW
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_ROW_GROUP
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_ROW_HEADER
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_SCROLLBAR
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_SEARCH
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_SEARCH_BOX
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_SECTION
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_SECTION_HEAD
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_SELECT
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_SEPARATOR
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_SLIDER
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_SPIN_BUTTON
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_STATUS
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_STRUCTURE
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_SWITCH
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_TAB
...
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_TREE_GRID
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_TREE_ITEM
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_WIDGET
import org.gtkkn.native.gtk.GtkAccessibleRole.GTK_ACCESSIBLE_ROLE_WINDOW
...
public enum class AccessibleRole(
    ...
    public companion object {
        public fun fromNativeValue(nativeValue: GtkAccessibleRole): AccessibleRole =
            when (nativeValue) {
                GTK_ACCESSIBLE_ROLE_ALERT -> ALERT
                GTK_ACCESSIBLE_ROLE_ALERT_DIALOG -> ALERT_DIALOG
                GTK_ACCESSIBLE_ROLE_BANNER -> BANNER
                GTK_ACCESSIBLE_ROLE_BUTTON -> BUTTON
                GTK_ACCESSIBLE_ROLE_CAPTION -> CAPTION
                GTK_ACCESSIBLE_ROLE_CELL -> CELL
                GTK_ACCESSIBLE_ROLE_CHECKBOX -> CHECKBOX
                GTK_ACCESSIBLE_ROLE_COLUMN_HEADER -> COLUMN_HEADER
                GTK_ACCESSIBLE_ROLE_COMBO_BOX -> COMBO_BOX
                GTK_ACCESSIBLE_ROLE_COMMAND -> COMMAND
                GTK_ACCESSIBLE_ROLE_COMPOSITE -> COMPOSITE
                GTK_ACCESSIBLE_ROLE_DIALOG -> DIALOG
                GTK_ACCESSIBLE_ROLE_DOCUMENT -> DOCUMENT
                GTK_ACCESSIBLE_ROLE_FEED -> FEED
                GTK_ACCESSIBLE_ROLE_FORM -> FORM
                GTK_ACCESSIBLE_ROLE_GENERIC -> GENERIC
                GTK_ACCESSIBLE_ROLE_GRID -> GRID
                GTK_ACCESSIBLE_ROLE_GRID_CELL -> GRID_CELL
                GTK_ACCESSIBLE_ROLE_GROUP -> GROUP
                GTK_ACCESSIBLE_ROLE_HEADING -> HEADING
                GTK_ACCESSIBLE_ROLE_IMG -> IMG
                GTK_ACCESSIBLE_ROLE_INPUT -> INPUT
                GTK_ACCESSIBLE_ROLE_LABEL -> LABEL
                GTK_ACCESSIBLE_ROLE_LANDMARK -> LANDMARK
                GTK_ACCESSIBLE_ROLE_LEGEND -> LEGEND
                GTK_ACCESSIBLE_ROLE_LINK -> LINK
                GTK_ACCESSIBLE_ROLE_LIST -> LIST
                GTK_ACCESSIBLE_ROLE_LIST_BOX -> LIST_BOX
                GTK_ACCESSIBLE_ROLE_LIST_ITEM -> LIST_ITEM
                GTK_ACCESSIBLE_ROLE_LOG -> LOG
                GTK_ACCESSIBLE_ROLE_MAIN -> MAIN
                GTK_ACCESSIBLE_ROLE_MARQUEE -> MARQUEE
                GTK_ACCESSIBLE_ROLE_MATH -> MATH
                GTK_ACCESSIBLE_ROLE_METER -> METER
                GTK_ACCESSIBLE_ROLE_MENU -> MENU
                GTK_ACCESSIBLE_ROLE_MENU_BAR -> MENU_BAR
                GTK_ACCESSIBLE_ROLE_MENU_ITEM -> MENU_ITEM
                GTK_ACCESSIBLE_ROLE_MENU_ITEM_CHECKBOX -> MENU_ITEM_CHECKBOX
                GTK_ACCESSIBLE_ROLE_MENU_ITEM_RADIO -> MENU_ITEM_RADIO
                GTK_ACCESSIBLE_ROLE_NAVIGATION -> NAVIGATION
                GTK_ACCESSIBLE_ROLE_NONE -> NONE
                GTK_ACCESSIBLE_ROLE_NOTE -> NOTE
                GTK_ACCESSIBLE_ROLE_OPTION -> OPTION
                GTK_ACCESSIBLE_ROLE_PRESENTATION -> PRESENTATION
                GTK_ACCESSIBLE_ROLE_PROGRESS_BAR -> PROGRESS_BAR
                GTK_ACCESSIBLE_ROLE_RADIO -> RADIO
                GTK_ACCESSIBLE_ROLE_RADIO_GROUP -> RADIO_GROUP
                GTK_ACCESSIBLE_ROLE_RANGE -> RANGE
                GTK_ACCESSIBLE_ROLE_REGION -> REGION
                GTK_ACCESSIBLE_ROLE_ROW -> ROW
                GTK_ACCESSIBLE_ROLE_ROW_GROUP -> ROW_GROUP
                GTK_ACCESSIBLE_ROLE_ROW_HEADER -> ROW_HEADER
                GTK_ACCESSIBLE_ROLE_SCROLLBAR -> SCROLLBAR
                GTK_ACCESSIBLE_ROLE_SEARCH -> SEARCH
                GTK_ACCESSIBLE_ROLE_SEARCH_BOX -> SEARCH_BOX
                GTK_ACCESSIBLE_ROLE_SECTION -> SECTION
                GTK_ACCESSIBLE_ROLE_SECTION_HEAD -> SECTION_HEAD
                GTK_ACCESSIBLE_ROLE_SELECT -> SELECT
                GTK_ACCESSIBLE_ROLE_SEPARATOR -> SEPARATOR
                GTK_ACCESSIBLE_ROLE_SLIDER -> SLIDER
                GTK_ACCESSIBLE_ROLE_SPIN_BUTTON -> SPIN_BUTTON
                GTK_ACCESSIBLE_ROLE_STATUS -> STATUS
                GTK_ACCESSIBLE_ROLE_STRUCTURE -> STRUCTURE
                GTK_ACCESSIBLE_ROLE_SWITCH -> SWITCH
                GTK_ACCESSIBLE_ROLE_TAB -> TAB
                GTK_ACCESSIBLE_ROLE_TABLE -> TABLE
                GTK_ACCESSIBLE_ROLE_TAB_LIST -> TAB_LIST
                GTK_ACCESSIBLE_ROLE_TAB_PANEL -> TAB_PANEL
                GTK_ACCESSIBLE_ROLE_TEXT_BOX -> TEXT_BOX
                GTK_ACCESSIBLE_ROLE_TIME -> TIME
                GTK_ACCESSIBLE_ROLE_TIMER -> TIMER
                GTK_ACCESSIBLE_ROLE_TOOLBAR -> TOOLBAR
                GTK_ACCESSIBLE_ROLE_TOOLTIP -> TOOLTIP
                GTK_ACCESSIBLE_ROLE_TREE -> TREE
                GTK_ACCESSIBLE_ROLE_TREE_GRID -> TREE_GRID
