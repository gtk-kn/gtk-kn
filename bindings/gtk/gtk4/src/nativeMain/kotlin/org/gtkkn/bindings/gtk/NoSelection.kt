...
public open class NoSelection(
    ...
    public companion object : TypeCompanion<NoSelection> {
        override val type: GeneratedClassKGType<NoSelection> =
                GeneratedClassKGType(getTypeOrNull()!!) { NoSelection(it.reinterpret()) }
        ...
        /**
         * Gets the GType of from the symbol `gtk_no_selection_get_type` if it exists.
         *
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_no_selection_get_type")
    }
}
