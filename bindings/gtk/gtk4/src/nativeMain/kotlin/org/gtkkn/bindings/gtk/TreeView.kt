...
public open class TreeView(
    ...
    public open var expanderColumn: TreeViewColumn?
         ...
         */
        get() = gtk_tree_view_get_expander_column(gtkTreeViewPointer.reinterpret())?.run {
         ...
         */
        set(column) = gtk_tree_view_set_expander_column(gtkTreeViewPointer.reinterpret(), column?.gtkTreeViewColumnPointer?.reinterpret())
    ...
    public open var headersVisible: Boolean
         ...
         */
        set(headersVisible) = gtk_tree_view_set_headers_visible(gtkTreeViewPointer.reinterpret(), headersVisible.asGBoolean())
    ...
    public open var model: TreeModel?
         ...
         */
        get() = gtk_tree_view_get_model(gtkTreeViewPointer.reinterpret())?.run {
     ...
     */
    public open fun collapseRow(path: TreePath): Boolean = gtk_tree_view_collapse_row(gtkTreeViewPointer.reinterpret(), path.gtkTreePathPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun createRowDragIcon(path: TreePath): Paintable? = gtk_tree_view_create_row_drag_icon(gtkTreeViewPointer.reinterpret(), path.gtkTreePathPointer.reinterpret())?.run {
     ...
     *    widget
     */
    public open fun enableModelDragDest(formats: ContentFormats, actions: DragAction): Unit = gtk_tree_view_enable_model_drag_dest(gtkTreeViewPointer.reinterpret(), formats.gdkContentFormatsPointer.reinterpret(), actions.mask)
    ...
    public open fun enableModelDragSource(
        ...
        actions: DragAction,
    ): Unit = gtk_tree_view_enable_model_drag_source(gtkTreeViewPointer.reinterpret(), startButtonMask.mask, formats.gdkContentFormatsPointer.reinterpret(), actions.mask)
     ...
     */
    public open fun expandRow(path: TreePath, openAll: Boolean): Boolean = gtk_tree_view_expand_row(gtkTreeViewPointer.reinterpret(), path.gtkTreePathPointer.reinterpret(), openAll.asGBoolean()).asBoolean()
     ...
     * @param path path to a row.
     */
    public open fun expandToPath(path: TreePath): Unit = gtk_tree_view_expand_to_path(gtkTreeViewPointer.reinterpret(), path.gtkTreePathPointer.reinterpret())
    ...
    public open fun getBackgroundArea(
        ...
        rect: Rectangle,
    ): Unit = gtk_tree_view_get_background_area(gtkTreeViewPointer.reinterpret(), path?.gtkTreePathPointer?.reinterpret(), column?.gtkTreeViewColumnPointer?.reinterpret(), rect.gdkRectanglePointer.reinterpret())
    ...
    public open fun getCellArea(
        ...
        column: TreeViewColumn? = null,
        rect: Rectangle,
    ): Unit = gtk_tree_view_get_cell_area(gtkTreeViewPointer.reinterpret(), path?.gtkTreePathPointer?.reinterpret(), column?.gtkTreeViewColumnPointer?.reinterpret(), rect.gdkRectanglePointer.reinterpret())
     ...
     */
    public open fun getColumns(): List = gtk_tree_view_get_columns(gtkTreeViewPointer.reinterpret())!!.run {
        List(reinterpret())}
     ...
     * are enabled.
     */
    public open fun getGridLines(): TreeViewGridLines = gtk_tree_view_get_grid_lines(gtkTreeViewPointer.reinterpret()).run {
     ...
     */
    public open fun getSearchEntry(): Editable? = gtk_tree_view_get_search_entry(gtkTreeViewPointer.reinterpret())?.run {
     ...
     */
    public open fun getSelection(): TreeSelection = gtk_tree_view_get_selection(gtkTreeViewPointer.reinterpret())!!.run {
     ...
     */
    public open fun getVisibleRect(visibleRect: Rectangle): Unit = gtk_tree_view_get_visible_rect(gtkTreeViewPointer.reinterpret(), visibleRect.gdkRectanglePointer.reinterpret())
     ...
     * done in @tree_view.
     */
    public open fun isRubberBandingActive(): Boolean = gtk_tree_view_is_rubber_banding_active(gtkTreeViewPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun mapExpandedRows(func: TreeViewMappingFunc): Unit = gtk_tree_view_map_expanded_rows(gtkTreeViewPointer.reinterpret(), TreeViewMappingFuncFunc.reinterpret(), StableRef.create(func).asCPointer())
     ...
     */
    public open fun moveColumnAfter(column: TreeViewColumn, baseColumn: TreeViewColumn? = null): Unit = gtk_tree_view_move_column_after(gtkTreeViewPointer.reinterpret(), column.gtkTreeViewColumnPointer.reinterpret(), baseColumn?.gtkTreeViewColumnPointer?.reinterpret())
     ...
     */
    public open fun rowActivated(path: TreePath, column: TreeViewColumn? = null): Unit = gtk_tree_view_row_activated(gtkTreeViewPointer.reinterpret(), path.gtkTreePathPointer.reinterpret(), column?.gtkTreeViewColumnPointer?.reinterpret())
     ...
     */
    public open fun rowExpanded(path: TreePath): Boolean = gtk_tree_view_row_expanded(gtkTreeViewPointer.reinterpret(), path.gtkTreePathPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun setColumnDragFunction(func: TreeViewColumnDropFunc?): Unit = gtk_tree_view_set_column_drag_function(gtkTreeViewPointer.reinterpret(), func?.let { TreeViewColumnDropFuncFunc.reinterpret() }, func?.let { StableRef.create(func).asCPointer() }, func?.let { staticStableRefDestroy.reinterpret() })
     ...
     */
    public open fun setCursor(
        path: TreePath,
        focusColumn: TreeViewColumn? = null,
        startEditing: Boolean,
    ): Unit = gtk_tree_view_set_cursor(gtkTreeViewPointer.reinterpret(), path.gtkTreePathPointer.reinterpret(), focusColumn?.gtkTreeViewColumnPointer?.reinterpret(), startEditing.asGBoolean())
    ...
    public open fun setCursorOnCell(
        ...
        startEditing: Boolean,
    ): Unit = gtk_tree_view_set_cursor_on_cell(gtkTreeViewPointer.reinterpret(), path.gtkTreePathPointer.reinterpret(), focusColumn?.gtkTreeViewColumnPointer?.reinterpret(), focusCell?.gtkCellRendererPointer?.reinterpret(), startEditing.asGBoolean())
     ...
     */
    public open fun setDragDestRow(path: TreePath? = null, pos: TreeViewDropPosition): Unit = gtk_tree_view_set_drag_dest_row(gtkTreeViewPointer.reinterpret(), path?.gtkTreePathPointer?.reinterpret(), pos.nativeValue)
     ...
     * enable.
     */
    public open fun setGridLines(gridLines: TreeViewGridLines): Unit = gtk_tree_view_set_grid_lines(gtkTreeViewPointer.reinterpret(), gridLines.nativeValue)
     ...
     */
    public open fun setRowSeparatorFunc(func: TreeViewRowSeparatorFunc?): Unit = gtk_tree_view_set_row_separator_func(gtkTreeViewPointer.reinterpret(), func?.let { TreeViewRowSeparatorFuncFunc.reinterpret() }, func?.let { StableRef.create(func).asCPointer() }, func?.let { staticStableRefDestroy.reinterpret() })
     ...
     */
    public open fun setSearchEntry(entry: Editable? = null): Unit = gtk_tree_view_set_search_entry(gtkTreeViewPointer.reinterpret(), entry?.gtkEditablePointer)
     ...
     */
    public open fun setSearchEqualFunc(searchEqualFunc: TreeViewSearchEqualFunc): Unit = gtk_tree_view_set_search_equal_func(gtkTreeViewPointer.reinterpret(), TreeViewSearchEqualFuncFunc.reinterpret(), StableRef.create(searchEqualFunc).asCPointer(), staticStableRefDestroy.reinterpret())
    ...
    ): Unit = gtk_tree_view_set_tooltip_cell(gtkTreeViewPointer.reinterpret(), tooltip.gtkTooltipPointer.reinterpret(), path?.gtkTreePathPointer?.reinterpret(), column?.gtkTreeViewColumnPointer?.reinterpret(), cell?.gtkCellRendererPointer?.reinterpret())
     ...
     * @param path a `GtkTreePath`
     */
    public open fun setTooltipRow(tooltip: Tooltip, path: TreePath): Unit = gtk_tree_view_set_tooltip_row(gtkTreeViewPointer.reinterpret(), tooltip.gtkTooltipPointer.reinterpret(), path.gtkTreePathPointer.reinterpret())
     ...
     */
    public fun connectColumnsChanged(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "columns-changed", connectColumnsChangedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect
     */
    public fun connectCursorChanged(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "cursor-changed", connectCursorChangedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectExpandCollapseCursorRow(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (
        `object`: Boolean,
        p0: Boolean,
        p1: Boolean,
    ) -> Boolean): ULong = g_signal_connect_data(gPointer.reinterpret(), "expand-collapse-cursor-row", connectExpandCollapseCursorRowFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectRowActivated(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (path: TreePath, column: TreeViewColumn?) -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "row-activated", connectRowActivatedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectRowCollapsed(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (iter: TreeIter, path: TreePath) -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "row-collapsed", connectRowCollapsedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectRowExpanded(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (iter: TreeIter, path: TreePath) -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "row-expanded", connectRowExpandedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect
     */
    public fun connectSelectAll(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Boolean): ULong = g_signal_connect_data(gPointer.reinterpret(), "select-all", connectSelectAllFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect
     */
    public fun connectSelectCursorParent(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Boolean): ULong = g_signal_connect_data(gPointer.reinterpret(), "select-cursor-parent", connectSelectCursorParentFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectSelectCursorRow(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (`object`: Boolean) -> Boolean): ULong = g_signal_connect_data(gPointer.reinterpret(), "select-cursor-row", connectSelectCursorRowFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect
     */
    public fun connectStartInteractiveSearch(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Boolean): ULong = g_signal_connect_data(gPointer.reinterpret(), "start-interactive-search", connectStartInteractiveSearchFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectTestCollapseRow(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (iter: TreeIter, path: TreePath) -> Boolean): ULong = g_signal_connect_data(gPointer.reinterpret(), "test-collapse-row", connectTestCollapseRowFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    public fun connectTestExpandRow(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (iter: TreeIter, path: TreePath) -> Boolean): ULong = g_signal_connect_data(gPointer.reinterpret(), "test-expand-row", connectTestExpandRowFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect
     */
    public fun connectToggleCursorRow(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Boolean): ULong = g_signal_connect_data(gPointer.reinterpret(), "toggle-cursor-row", connectToggleCursorRowFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect
     */
    public fun connectUnselectAll(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Boolean): ULong = g_signal_connect_data(gPointer.reinterpret(), "unselect-all", connectUnselectAllFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
...
private val connectColumnsChangedFunc: CPointer<CFunction<() -> Unit>> = staticCFunction {
    _: COpaquePointer,
...
private val connectCursorChangedFunc: CPointer<CFunction<() -> Unit>> = staticCFunction {
    _: COpaquePointer,
    userData: COpaquePointer
    ->
    userData.asStableRef<() -> Unit>().get().invoke()}
...
private val connectExpandCollapseCursorRowFunc: CPointer<CFunction<(
    ...
    userData.asStableRef<(
        ...
        p0: Boolean,
        p1: Boolean,
    ) -> Boolean>().get().invoke(`object`.asBoolean(), p0.asBoolean(), p1.asBoolean()).asGBoolean()}
.reinterpret()
...
private val connectMoveCursorFunc: CPointer<CFunction<(
    ...
    , direction, extend.asBoolean(), modify.asBoolean()).asGBoolean()}
.reinterpret()
...
private val connectRowCollapsedFunc:
    ...
    userData: COpaquePointer
    ->
    userData.asStableRef<(iter: TreeIter, path: TreePath) -> Unit>().get().invoke(iter!!.run {
...
private val connectTestCollapseRowFunc:
    ...
    userData: COpaquePointer
    ->
    userData.asStableRef<(iter: TreeIter, path: TreePath) -> Boolean>().get().invoke(iter!!.run {
        TreeIter(reinterpret())}
    , path!!.run {
        TreePath(reinterpret())}
    ).asGBoolean()}
