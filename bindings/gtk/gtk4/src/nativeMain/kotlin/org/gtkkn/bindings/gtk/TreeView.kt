...
public open class TreeView(
     ...
     */
    public open fun setColumnDragFunction(func: TreeViewColumnDropFunc): Unit = gtk_tree_view_set_column_drag_function(gtkTreeViewPointer.reinterpret(), TreeViewColumnDropFuncFunc.reinterpret(), StableRef.create(func).asCPointer(), staticStableRefDestroy.reinterpret())
     ...
     */
    public open fun setRowSeparatorFunc(func: TreeViewRowSeparatorFunc): Unit = gtk_tree_view_set_row_separator_func(gtkTreeViewPointer.reinterpret(), TreeViewRowSeparatorFuncFunc.reinterpret(), StableRef.create(func).asCPointer(), staticStableRefDestroy.reinterpret())
