 ...
 */
public interface SelectionModel : Proxy, ListModel, KGTyped {
     ...
     *   The bitset must not be modified.
     */
    public fun getSelectionInRange(position: guint, nItems: guint): Bitset = gtk_selection_model_get_selection_in_range(gtkSelectionModelPointer, position, nItems)!!.run {
        Bitset(this)}
     ...
     */
    public fun isSelected(position: guint): Boolean = gtk_selection_model_is_selected(gtkSelectionModelPointer, position).asBoolean()
     ...
     */
    public fun selectItem(position: guint, unselectRest: Boolean): Boolean = gtk_selection_model_select_item(gtkSelectionModelPointer, position, unselectRest.asGBoolean()).asBoolean()
    ...
    ): Boolean = gtk_selection_model_select_range(gtkSelectionModelPointer, position, nItems, unselectRest.asGBoolean()).asBoolean()
     ...
     */
    public fun selectionChanged(position: guint, nItems: guint): Unit = gtk_selection_model_selection_changed(gtkSelectionModelPointer, position, nItems)
     ...
     *   to the inputs.
     */
    public fun setSelection(selected: Bitset, mask: Bitset): Boolean = gtk_selection_model_set_selection(gtkSelectionModelPointer, selected.gtkBitsetPointer, mask.gtkBitsetPointer).asBoolean()
     ...
     */
    public fun unselectItem(position: guint): Boolean = gtk_selection_model_unselect_item(gtkSelectionModelPointer, position).asBoolean()
     ...
     */
    public fun unselectRange(position: guint, nItems: guint): Boolean = gtk_selection_model_unselect_range(gtkSelectionModelPointer, position, nItems).asBoolean()
     ...
     */
    public fun onSelectionChanged(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (position: guint, nItems: guint) -> Unit): ULong = g_signal_connect_data(gtkSelectionModelPointer, "selection-changed", onSelectionChangedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
