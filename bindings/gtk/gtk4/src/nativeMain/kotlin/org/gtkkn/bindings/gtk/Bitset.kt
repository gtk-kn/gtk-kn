...
public class Bitset(public val gtkBitsetPointer: CPointer<GtkBitset>) : ProxyInstance(gtkBitsetPointer) {
     ...
     *   was changed
     */
    public fun add(`value`: guint): Boolean = gtk_bitset_add(gtkBitsetPointer, `value`).asBoolean()
     ...
     * @param nItems number of consecutive values to add
     */
    public fun addRange(start: guint, nItems: guint): Unit = gtk_bitset_add_range(gtkBitsetPointer, start, nItems)
     ...
     */
    public fun contains(`value`: guint): Boolean = gtk_bitset_contains(gtkBitsetPointer, `value`).asBoolean()
     ...
     */
    public fun difference(other: Bitset): Unit = gtk_bitset_difference(gtkBitsetPointer, other.gtkBitsetPointer)
     ...
     */
    public fun equals(other: Bitset): Boolean = gtk_bitset_equals(gtkBitsetPointer, other.gtkBitsetPointer).asBoolean()
     ...
     */
    public fun getMaximum(): guint = gtk_bitset_get_maximum(gtkBitsetPointer)
     ...
     */
    public fun getMinimum(): guint = gtk_bitset_get_minimum(gtkBitsetPointer)
     ...
     */
    public fun getNth(nth: guint): guint = gtk_bitset_get_nth(gtkBitsetPointer, nth)
     ...
     */
    public fun getSize(): guint64 = gtk_bitset_get_size(gtkBitsetPointer)
     ...
     */
    public fun intersect(other: Bitset): Unit = gtk_bitset_intersect(gtkBitsetPointer, other.gtkBitsetPointer)
     ...
     */
    public fun isEmpty(): Boolean = gtk_bitset_is_empty(gtkBitsetPointer).asBoolean()
     ...
     *   was changed
     */
    public fun remove(`value`: guint): Boolean = gtk_bitset_remove(gtkBitsetPointer, `value`).asBoolean()

    /**
     * Removes all values from the bitset so that it is empty again.
     */
    public fun removeAll(): Unit = gtk_bitset_remove_all(gtkBitsetPointer)
     ...
     */
    public fun removeRange(start: guint, nItems: guint): Unit = gtk_bitset_remove_range(gtkBitsetPointer, start, nItems)
     ...
     */
    public fun shiftLeft(amount: guint): Unit = gtk_bitset_shift_left(gtkBitsetPointer, amount)
     ...
     */
    public fun shiftRight(amount: guint): Unit = gtk_bitset_shift_right(gtkBitsetPointer, amount)
     ...
     */
    public fun subtract(other: Bitset): Unit = gtk_bitset_subtract(gtkBitsetPointer, other.gtkBitsetPointer)
     ...
     */
    public fun union(other: Bitset): Unit = gtk_bitset_union(gtkBitsetPointer, other.gtkBitsetPointer)
