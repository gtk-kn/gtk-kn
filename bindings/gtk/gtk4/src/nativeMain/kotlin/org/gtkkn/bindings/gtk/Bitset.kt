...
public class Bitset(pointer: CPointer<GtkBitset>) : ProxyInstance(pointer) {
     ...
     *   was changed
     */
    public fun add(`value`: guint): Boolean = gtk_bitset_add(gPointer, `value`).asBoolean()
     ...
     */
    public fun addRange(start: guint, nItems: guint): Unit = gtk_bitset_add_range(gPointer, start, nItems)
     ...
     */
    public fun addRangeClosed(first: guint, last: guint): Unit = gtk_bitset_add_range_closed(gPointer, first, last)
    ...
    public fun addRectangle(start: guint, width: guint, height: guint, stride: guint): Unit =
        gtk_bitset_add_rectangle(gPointer, start, width, height, stride)
     ...
     */
    public fun contains(`value`: guint): Boolean = gtk_bitset_contains(gPointer, `value`).asBoolean()
     ...
     *   values as @self
     */
    public fun copy(): Bitset = gtk_bitset_copy(gPointer)!!.run {
        Bitset(this)
    }
     ...
     */
    public fun difference(other: Bitset): Unit = gtk_bitset_difference(gPointer, other.gPointer)
     ...
     */
    public fun equals(other: Bitset): Boolean = gtk_bitset_equals(gPointer, other.gPointer).asBoolean()
     ...
     */
    public fun getMaximum(): guint = gtk_bitset_get_maximum(gPointer)
     ...
     */
    public fun getMinimum(): guint = gtk_bitset_get_minimum(gPointer)
     ...
     */
    public fun getNth(nth: guint): guint = gtk_bitset_get_nth(gPointer, nth)
     ...
     */
    public fun getSize(): guint64 = gtk_bitset_get_size(gPointer)
     ...
     */
    public fun getSizeInRange(first: guint, last: guint): guint64 = gtk_bitset_get_size_in_range(gPointer, first, last)
     ...
     */
    public fun intersect(other: Bitset): Unit = gtk_bitset_intersect(gPointer, other.gPointer)
     ...
     */
    public fun isEmpty(): Boolean = gtk_bitset_is_empty(gPointer).asBoolean()
     ...
     */
    public fun ref(): Bitset = gtk_bitset_ref(gPointer)!!.run {
        Bitset(this)
    }
     ...
     *   was changed
     */
    public fun remove(`value`: guint): Boolean = gtk_bitset_remove(gPointer, `value`).asBoolean()

    /**
     * Removes all values from the bitset so that it is empty again.
     */
    public fun removeAll(): Unit = gtk_bitset_remove_all(gPointer)
     ...
     */
    public fun removeRange(start: guint, nItems: guint): Unit = gtk_bitset_remove_range(gPointer, start, nItems)
    ...
    public fun removeRangeClosed(first: guint, last: guint): Unit =
        gtk_bitset_remove_range_closed(gPointer, first, last)
    ...
    public fun removeRectangle(start: guint, width: guint, height: guint, stride: guint): Unit =
        gtk_bitset_remove_rectangle(gPointer, start, width, height, stride)
     ...
     */
    public fun shiftLeft(amount: guint): Unit = gtk_bitset_shift_left(gPointer, amount)
     ...
     */
    public fun shiftRight(amount: guint): Unit = gtk_bitset_shift_right(gPointer, amount)
    ...
    public fun splice(position: guint, removed: guint, added: guint): Unit =
        gtk_bitset_splice(gPointer, position, removed, added)
     ...
     */
    public fun subtract(other: Bitset): Unit = gtk_bitset_subtract(gPointer, other.gPointer)
     ...
     */
    public fun union(other: Bitset): Unit = gtk_bitset_union(gPointer, other.gPointer)
     ...
     * freed.
     */
    public fun unref(): Unit = gtk_bitset_unref(gPointer)
