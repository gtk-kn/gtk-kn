...
public open class GestureSwipe(
    ...
    public companion object : TypeCompanion<GestureSwipe> {
        override val type: GeneratedClassKGType<GestureSwipe> =
                GeneratedClassKGType(getTypeOrNull()!!) { GestureSwipe(it.reinterpret()) }
        ...
        /**
         * Gets the GType of from the symbol `gtk_gesture_swipe_get_type` if it exists.
         *
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_gesture_swipe_get_type")
    }
}
