...
public open class Scrollbar(
     ...
     */
    public open fun setAdjustment(adjustment: Adjustment? = null): Unit = gtk_scrollbar_set_adjustment(gtkScrollbarPointer, adjustment?.gtkAdjustmentPointer)
