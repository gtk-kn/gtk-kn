...
public interface TreeDragSource : Interface, KGTyped {
     ...
     */
    public fun dragDataDelete(path: TreePath): Boolean = gtk_tree_drag_source_drag_data_delete(gtkTreeDragSourcePointer.reinterpret(), path.gtkTreePathPointer.reinterpret()).asBoolean()
     ...
     *    given @path
     */
    public fun dragDataGet(path: TreePath): ContentProvider? = gtk_tree_drag_source_drag_data_get(gtkTreeDragSourcePointer.reinterpret(), path.gtkTreePathPointer.reinterpret())?.run {
     ...
     */
    public fun rowDraggable(path: TreePath): Boolean = gtk_tree_drag_source_row_draggable(gtkTreeDragSourcePointer.reinterpret(), path.gtkTreePathPointer.reinterpret()).asBoolean()
