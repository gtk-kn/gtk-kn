 ...
 */
public class CssSection(pointer: CPointer<GtkCssSection>) : Record {
    ...
    override fun toString(): KotlinString =
        gtk_css_section_to_string(gtkCssSectionPointer.reinterpret())?.toKString() ?: error("Expected not null string")
