...
public open class Grid(
    ...
    public open fun attach(
        ...
        width: gint,
        height: gint,
    ): Unit = gtk_grid_attach(gtkGridPointer, child.gtkWidgetPointer, column, row, width, height)
    ...
    public open fun attachNextTo(
        ...
        width: gint,
        height: gint,
    ): Unit = gtk_grid_attach_next_to(gtkGridPointer, child.gtkWidgetPointer, sibling?.gtkWidgetPointer, side.nativeValue, width, height)
     ...
     */
    public open fun getRowBaselinePosition(row: gint): BaselinePosition = gtk_grid_get_row_baseline_position(gtkGridPointer, row).run {
     ...
     * @param side the side of @sibling that @child is positioned next to
     */
    public open fun insertNextTo(sibling: Widget, side: PositionType): Unit = gtk_grid_insert_next_to(gtkGridPointer, sibling.gtkWidgetPointer, side.nativeValue)
     ...
     */
    public open fun setRowBaselinePosition(row: gint, pos: BaselinePosition): Unit = gtk_grid_set_row_baseline_position(gtkGridPointer, row, pos.nativeValue)
