...
public interface FontChooser : Interface, KGTyped {
    ...
    public var language: String
         ...
         */
        get() =
            gtk_font_chooser_get_language(gtkFontChooserPointer.reinterpret())?.toKString()
                ?: error("Expected not null string")
         ...
         */
        set(language) = gtk_font_chooser_set_language(gtkFontChooserPointer.reinterpret(), language)
    ...
    public var level: FontChooserLevel
         ...
         */
        get() =
            gtk_font_chooser_get_level(gtkFontChooserPointer.reinterpret()).run {
         ...
         */
        set(level) = gtk_font_chooser_set_level(gtkFontChooserPointer.reinterpret(), level.mask)
    ...
    public var previewText: String
         ...
         */
        set(text) = gtk_font_chooser_set_preview_text(gtkFontChooserPointer.reinterpret(), text)
     ...
     *   of the current font
     */
    public fun getFont(): String? = gtk_font_chooser_get_font(gtkFontChooserPointer.reinterpret())?.toKString()
     ...
     */
    public fun getFontFace(): FontFace? =
        gtk_font_chooser_get_font_face(gtkFontChooserPointer.reinterpret())?.run {
     ...
     * @return the current granularity level
     */
    public fun getLevel(): FontChooserLevel =
        gtk_font_chooser_get_level(gtkFontChooserPointer.reinterpret()).run {
            FontChooserLevel(this)
        }
     ...
     */
    public fun setFilterFunc(filter: FontFilterFunc): Unit =
