...
public open class Fixed(
     ...
     */
    public open fun getChildTransform(widget: Widget): Transform? = gtk_fixed_get_child_transform(gtkFixedPointer.reinterpret(), widget.gtkWidgetPointer.reinterpret())?.run {
     ...
     */
    public open fun remove(widget: Widget): Unit = gtk_fixed_remove(gtkFixedPointer.reinterpret(), widget.gtkWidgetPointer.reinterpret())
     ...
     */
    public open fun setChildTransform(widget: Widget, transform: Transform? = null): Unit = gtk_fixed_set_child_transform(gtkFixedPointer.reinterpret(), widget.gtkWidgetPointer.reinterpret(), transform?.gskTransformPointer?.reinterpret())
