...
public open class ShortcutTrigger(
     ...
     */
    public open fun equal(trigger2: ShortcutTrigger): Boolean = gtk_shortcut_trigger_equal(gtkShortcutTriggerPointer.reinterpret(), trigger2.gtkShortcutTriggerPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun print(string: GlibString): Unit = gtk_shortcut_trigger_print(gtkShortcutTriggerPointer.reinterpret(), string.glibStringPointer.reinterpret())
     ...
     *   for end users.
     */
    public open fun printLabel(display: Display, string: GlibString): Boolean = gtk_shortcut_trigger_print_label(gtkShortcutTriggerPointer.reinterpret(), display.gdkDisplayPointer.reinterpret(), string.glibStringPointer.reinterpret()).asBoolean()
     ...
     * @return a new string
     */
    public open fun toLabel(display: Display): KotlinString = gtk_shortcut_trigger_to_label(gtkShortcutTriggerPointer.reinterpret(), display.gdkDisplayPointer.reinterpret())?.toKString() ?: error("Expected not null string")
     ...
     * @return a new string
     */
    override fun toString(): KotlinString = gtk_shortcut_trigger_to_string(gtkShortcutTriggerPointer.reinterpret())?.toKString() ?: error("Expected not null string")
     ...
     */
    public open fun trigger(event: Event, enableMnemonics: Boolean): KeyMatch = gtk_shortcut_trigger_trigger(gtkShortcutTriggerPointer.reinterpret(), event.gPointer.reinterpret(), enableMnemonics.asGBoolean()).run {
