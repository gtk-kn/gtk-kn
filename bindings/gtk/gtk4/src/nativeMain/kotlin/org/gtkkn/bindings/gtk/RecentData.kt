...
public class RecentData(
    ...
    override fun toString(): String = "RecentData(displayName=$displayName, description=$description, mimeType=$mimeType, appName=$appName, appExec=$appExec, isPrivate=$isPrivate)"
}
