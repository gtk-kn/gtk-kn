...
public open class PageSetup(
     ...
     */
    public open fun getBottomMargin(unit: Unit): gdouble = gtk_page_setup_get_bottom_margin(gtkPageSetupPointer, unit.nativeValue)
     ...
     */
    public open fun getLeftMargin(unit: Unit): gdouble = gtk_page_setup_get_left_margin(gtkPageSetupPointer, unit.nativeValue)
     ...
     */
    public open fun getPageHeight(unit: Unit): gdouble = gtk_page_setup_get_page_height(gtkPageSetupPointer, unit.nativeValue)
     ...
     */
    public open fun getPageWidth(unit: Unit): gdouble = gtk_page_setup_get_page_width(gtkPageSetupPointer, unit.nativeValue)
     ...
     */
    public open fun getPaperHeight(unit: Unit): gdouble = gtk_page_setup_get_paper_height(gtkPageSetupPointer, unit.nativeValue)
     ...
     */
    public open fun getPaperWidth(unit: Unit): gdouble = gtk_page_setup_get_paper_width(gtkPageSetupPointer, unit.nativeValue)
     ...
     */
    public open fun getRightMargin(unit: Unit): gdouble = gtk_page_setup_get_right_margin(gtkPageSetupPointer, unit.nativeValue)
     ...
     */
    public open fun getTopMargin(unit: Unit): gdouble = gtk_page_setup_get_top_margin(gtkPageSetupPointer, unit.nativeValue)
    ...
    public open fun loadKeyFile(keyFile: KeyFile, groupName: String? = null): Result<Boolean> = memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = gtk_page_setup_load_key_file(gtkPageSetupPointer, keyFile.glibKeyFilePointer, groupName, gError.ptr).asBoolean()
        return if (gError.pointed != null) {
            Result.failure(resolveException(Error(gError.pointed!!.ptr)))
        } else {
            Result.success(gResult)
     ...
     */
    public open fun setBottomMargin(margin: gdouble, unit: Unit): kotlin.Unit = gtk_page_setup_set_bottom_margin(gtkPageSetupPointer, margin, unit.nativeValue)
     ...
     * @param unit the units for @margin
     */
    public open fun setLeftMargin(margin: gdouble, unit: Unit): kotlin.Unit = gtk_page_setup_set_left_margin(gtkPageSetupPointer, margin, unit.nativeValue)
     ...
     */
    public open fun setOrientation(orientation: PageOrientation): kotlin.Unit = gtk_page_setup_set_orientation(gtkPageSetupPointer, orientation.nativeValue)
     ...
     */
    public open fun setPaperSize(size: PaperSize): kotlin.Unit = gtk_page_setup_set_paper_size(gtkPageSetupPointer, size.gtkPaperSizePointer)
     ...
     * @param size a `GtkPaperSize`
     */
    public open fun setPaperSizeAndDefaultMargins(size: PaperSize): kotlin.Unit = gtk_page_setup_set_paper_size_and_default_margins(gtkPageSetupPointer, size.gtkPaperSizePointer)
     ...
     * @param unit the units for @margin
     */
    public open fun setRightMargin(margin: gdouble, unit: Unit): kotlin.Unit = gtk_page_setup_set_right_margin(gtkPageSetupPointer, margin, unit.nativeValue)
     ...
     * @param unit the units for @margin
     */
    public open fun setTopMargin(margin: gdouble, unit: Unit): kotlin.Unit = gtk_page_setup_set_top_margin(gtkPageSetupPointer, margin, unit.nativeValue)
     ...
     */
    public open fun toKeyFile(keyFile: KeyFile, groupName: String? = null): kotlin.Unit = gtk_page_setup_to_key_file(gtkPageSetupPointer, keyFile.glibKeyFilePointer, groupName)
