...
public open class Display(
     ...
     */
    public open fun beep(): Unit = gdk_display_beep(gdkDisplayPointer.reinterpret())
     ...
     */
    public open fun close(): Unit = gdk_display_close(gdkDisplayPointer.reinterpret())
     ...
     */
    public open fun flush(): Unit = gdk_display_flush(gdkDisplayPointer.reinterpret())
    ...
    public open fun getClipboard(): Clipboard =
        gdk_display_get_clipboard(gdkDisplayPointer.reinterpret())!!.run {
     ...
     */
    public open fun getDefaultSeat(): Seat? =
        gdk_display_get_default_seat(gdkDisplayPointer.reinterpret())?.run {
            Seat(reinterpret())
        }
     ...
     */
    public open fun getMonitors(): ListModel =
        gdk_display_get_monitors(gdkDisplayPointer.reinterpret())!!.run {
     ...
     */
    public open fun isClosed(): Boolean = gdk_display_is_closed(gdkDisplayPointer.reinterpret()).asBoolean()
     ...
     *   on the screen.
     */
    public open fun isComposited(): Boolean = gdk_display_is_composited(gdkDisplayPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun isRgba(): Boolean = gdk_display_is_rgba(gdkDisplayPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun listSeats(): List =
        gdk_display_list_seats(gdkDisplayPointer.reinterpret())!!.run {
            List(reinterpret())
        }
     ...
     * handled synchronously, this function will do nothing.
     */
    public open fun sync(): Unit = gdk_display_sync(gdkDisplayPointer.reinterpret())
     ...
     */
    public fun connectSeatAdded(
        connectFlags: ConnectFlags = ConnectFlags(0u),
        handler: (seat: Seat) -> Unit,
    ): ULong =
        g_signal_connect_data(
            gPointer.reinterpret(),
            "seat-added",
    ...
    public companion object : TypeCompanion<Display> {
         ...
         */
        public fun getDefault(): Display? =
            gdk_display_get_default()?.run {
                Display(reinterpret())
            }
...
private val connectClosedFunc: CPointer<CFunction<(Int) -> Unit>> =
    staticCFunction {
            _: COpaquePointer,
            isError: Int,
