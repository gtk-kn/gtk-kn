...
public class ContentFormats(pointer: CPointer<GdkContentFormats>) : ProxyInstance(pointer) {
    ...
    public fun containGtype(type: GType): Boolean =
        gdk_content_formats_contain_gtype(gPointer.reinterpret(), type).asBoolean()
    ...
    public fun containMimeType(mimeType: KotlinString): Boolean =
        gdk_content_formats_contain_mime_type(gPointer.reinterpret(), mimeType).asBoolean()
    ...
    public fun match(second: ContentFormats): Boolean =
        gdk_content_formats_match(gPointer.reinterpret(), second.gPointer.reinterpret()).asBoolean()
    ...
    public fun matchGtype(second: ContentFormats): GType =
        gdk_content_formats_match_gtype(gPointer.reinterpret(), second.gPointer.reinterpret())
    ...
    public fun matchMimeType(second: ContentFormats): KotlinString? =
        gdk_content_formats_match_mime_type(gPointer.reinterpret(), second.gPointer.reinterpret())?.toKString()
    ...
    public fun print(string: GlibString): Unit =
        gdk_content_formats_print(gPointer.reinterpret(), string.gPointer.reinterpret())
     ...
     */
    public fun ref(): ContentFormats = gdk_content_formats_ref(gPointer.reinterpret())!!.run {
    ...
    override fun toString(): KotlinString =
        gdk_content_formats_to_string(gPointer.reinterpret())?.toKString() ?: error("Expected not null string")
    ...
    public fun union(second: ContentFormats): ContentFormats =
        gdk_content_formats_union(gPointer.reinterpret(), second.gPointer.reinterpret())!!.run {
            ContentFormats(reinterpret())
        }
    ...
    public fun unionDeserializeGtypes(): ContentFormats =
        gdk_content_formats_union_deserialize_gtypes(gPointer.reinterpret())!!.run {
            ContentFormats(reinterpret())
        }
    ...
    public fun unionDeserializeMimeTypes(): ContentFormats =
        gdk_content_formats_union_deserialize_mime_types(gPointer.reinterpret())!!.run {
            ContentFormats(reinterpret())
        }
    ...
    public fun unionSerializeGtypes(): ContentFormats =
        gdk_content_formats_union_serialize_gtypes(gPointer.reinterpret())!!.run {
            ContentFormats(reinterpret())
        }
    ...
    public fun unionSerializeMimeTypes(): ContentFormats =
        gdk_content_formats_union_serialize_mime_types(gPointer.reinterpret())!!.run {
            ContentFormats(reinterpret())
        }
     ...
     */
    public fun unref(): Unit = gdk_content_formats_unref(gPointer.reinterpret())
