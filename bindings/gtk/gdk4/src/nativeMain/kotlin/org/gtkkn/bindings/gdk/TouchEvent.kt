...
public open class TouchEvent(
     ...
     */
    public open fun getEmulatingPointer(): Boolean = gdk_touch_event_get_emulating_pointer(gdkTouchEventPointer.reinterpret()).asBoolean()
    ...
    public companion object : TypeCompanion<TouchEvent> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gdk_touch_event_get_type")
    }
}
