 ...
 */
public class PopupLayout(pointer: CPointer<GdkPopupLayout>) : Record {
     ...
     */
    public fun setOffset(dx: Int, dy: Int): Unit =
     ...
     */
    @GdkVersion4_2
    public fun setShadowWidth(left: Int, right: Int, top: Int, bottom: Int): Unit =
