...
public class ContentFormatsBuilder(
    public val gdkContentFormatsBuilderPointer: CPointer<GdkContentFormatsBuilder>,
     ...
     */
    public fun addFormats(formats: ContentFormats): Unit = gdk_content_formats_builder_add_formats(gdkContentFormatsBuilderPointer, formats.gdkContentFormatsPointer)
     ...
     * @param type a `GType`
     */
    public fun addGtype(type: GType): Unit = gdk_content_formats_builder_add_gtype(gdkContentFormatsBuilderPointer, type)
     ...
     */
    public fun addMimeType(mimeType: String): Unit = gdk_content_formats_builder_add_mime_type(gdkContentFormatsBuilderPointer, mimeType)
     ...
     */
    public fun freeToFormats(): ContentFormats = gdk_content_formats_builder_free_to_formats(gdkContentFormatsBuilderPointer)!!.run {
        ContentFormats(this)}
     ...
     *   with all the formats added to @builder
     */
    public fun toFormats(): ContentFormats = gdk_content_formats_builder_to_formats(gdkContentFormatsBuilderPointer)!!.run {
        ContentFormats(this)}
