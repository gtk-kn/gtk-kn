...
public open class Clipboard(
    ...
    public open fun readAsync(
        ...
        return gdk_clipboard_read_async(gdkClipboardPointer.reinterpret(), mimeTypes.toCStringList(this), ioPriority, cancellable?.gioCancellablePointer?.reinterpret(), AsyncReadyCallbackFunc.reinterpret(), StableRef.create(callback).asCPointer())}
     ...
     * @param callback callback to call when the request is satisfied
     */
    public open fun readTextAsync(cancellable: Cancellable? = null, callback: AsyncReadyCallback): Unit = gdk_clipboard_read_text_async(gdkClipboardPointer.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), AsyncReadyCallbackFunc.reinterpret(), StableRef.create(callback).asCPointer())
     ...
     * @param callback callback to call when the request is satisfied
     */
    public open fun readTextureAsync(cancellable: Cancellable? = null, callback: AsyncReadyCallback): Unit = gdk_clipboard_read_texture_async(gdkClipboardPointer.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), AsyncReadyCallbackFunc.reinterpret(), StableRef.create(callback).asCPointer())
