...
public class DragSurfaceSize(
    public val gdkDragSurfaceSizePointer: CPointer<GdkDragSurfaceSize>,
     ...
     */
    @GdkVersion4_12
    public fun setSize(width: gint, height: gint): Unit = gdk_drag_surface_size_set_size(gdkDragSurfaceSizePointer, width, height)
}
