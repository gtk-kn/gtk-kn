...
public open class ConicGradientNode(
     ...
     */
    public open fun getNColorStops(): ULong = gsk_conic_gradient_node_get_n_color_stops(gskConicGradientNodePointer.reinterpret())
     ...
     */
    public open fun getRotation(): Float = gsk_conic_gradient_node_get_rotation(gskConicGradientNodePointer.reinterpret())
