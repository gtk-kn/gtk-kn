...
public object GskTypeProvider : TypeProvider {
    override val typeMap: Map<KClass<*>, KGType<*>> = buildMap {
        ...
        if (RepeatingLinearGradientNode.getTypeOrNull() != null) put(RepeatingLinearGradientNode::class, RepeatingLinearGradientNode.type)
        if (RepeatingRadialGradientNode.getTypeOrNull() != null) put(RepeatingRadialGradientNode::class, RepeatingRadialGradientNode.type)
