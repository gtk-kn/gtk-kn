...
public object GskTypeProvider : TypeProvider {
    override val typeMap: Map<KClass<*>, KGType<*>> = buildMap {
        ...
        if (getTypeOrNull("gsk_conic_gradient_node_get_type") != null) put(ConicGradientNode::class, ConicGradientNode.type)
        ...
        if (getTypeOrNull("gsk_linear_gradient_node_get_type") != null) put(LinearGradientNode::class, LinearGradientNode.type)
        ...
        if (getTypeOrNull("gsk_outset_shadow_node_get_type") != null) put(OutsetShadowNode::class, OutsetShadowNode.type)
        if (getTypeOrNull("gsk_radial_gradient_node_get_type") != null) put(RadialGradientNode::class, RadialGradientNode.type)
        ...
        if (getTypeOrNull("gsk_repeating_linear_gradient_node_get_type") != null) put(RepeatingLinearGradientNode::class, RepeatingLinearGradientNode.type)
        if (getTypeOrNull("gsk_repeating_radial_gradient_node_get_type") != null) put(RepeatingRadialGradientNode::class, RepeatingRadialGradientNode.type)
        ...
        if (getTypeOrNull("gsk_texture_scale_node_get_type") != null) put(TextureScaleNode::class, TextureScaleNode.type)
