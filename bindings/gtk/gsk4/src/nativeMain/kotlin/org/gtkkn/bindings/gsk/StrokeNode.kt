...
public open class StrokeNode(
    ...
    public constructor(
        ...
        path: Path,
        stroke: Stroke,
    ) : this(gsk_stroke_node_new(child.gskRenderNodePointer, path.gskPathPointer, stroke.gskStrokePointer)!!.reinterpret()) {
    ...
    public companion object : TypeCompanion<StrokeNode> {
        override val type: GeneratedClassKGType<StrokeNode> =
                GeneratedClassKGType(getTypeOrNull()!!) { StrokeNode(it.reinterpret()) }
        ...
        /**
         * Gets the GType of from the symbol `gsk_stroke_node_get_type` if it exists.
         *
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gsk_stroke_node_get_type")
    }
}
