...
public class Transform(
    public val gskTransformPointer: CPointer<GskTransform>,
) : ProxyInstance(gskTransformPointer) {
     ...
     */
    public fun equal(second: Transform? = null): Boolean = gsk_transform_equal(gskTransformPointer, second?.gskTransformPointer).asBoolean()
     ...
     */
    public fun matrix(matrix: Matrix): Transform = gsk_transform_matrix(gskTransformPointer, matrix.grapheneMatrixPointer)!!.run {
        Transform(this)}
     ...
     * @return The new transform
     */
    public fun rotate3d(angle: gfloat, axis: Vec3): Transform? = gsk_transform_rotate_3d(gskTransformPointer, angle, axis.grapheneVec3Pointer)?.run {
        Transform(this)}
     ...
     * @return The new transform
     */
    public fun scale(factorX: gfloat, factorY: gfloat): Transform? = gsk_transform_scale(gskTransformPointer, factorX, factorY)?.run {
        Transform(this)}
    ...
    public fun scale3d(
        ...
        factorY: gfloat,
        factorZ: gfloat,
    ): Transform? = gsk_transform_scale_3d(gskTransformPointer, factorX, factorY, factorZ)?.run {
        Transform(this)}
     ...
     */
    @GskVersion4_6
    public fun skew(skewX: gfloat, skewY: gfloat): Transform? = gsk_transform_skew(gskTransformPointer, skewX, skewY)?.run {
        Transform(this)}
     ...
     */
    public fun toMatrix(outMatrix: Matrix): Unit = gsk_transform_to_matrix(gskTransformPointer, outMatrix.grapheneMatrixPointer)
     ...
     */
    override fun toString(): KotlinString = gsk_transform_to_string(gskTransformPointer)?.toKString() ?: error("Expected not null string")
     ...
     * @return The new transform
     */
    public fun transform(other: Transform? = null): Transform? = gsk_transform_transform(gskTransformPointer, other?.gskTransformPointer)?.run {
        Transform(this)}
     ...
     */
    public fun transformBounds(rect: Rect, outRect: Rect): Unit = gsk_transform_transform_bounds(gskTransformPointer, rect.grapheneRectPointer, outRect.grapheneRectPointer)
     ...
     */
    public fun transformPoint(point: Point, outPoint: Point): Unit = gsk_transform_transform_point(gskTransformPointer, point.graphenePointPointer, outPoint.graphenePointPointer)
     ...
     * @return The new transform
     */
    public fun translate(point: Point): Transform? = gsk_transform_translate(gskTransformPointer, point.graphenePointPointer)?.run {
        Transform(this)}
     ...
     * @return The new transform
     */
    public fun translate3d(point: Point3d): Transform? = gsk_transform_translate_3d(gskTransformPointer, point.graphenePoint3dPointer)?.run {
        Transform(this)}
