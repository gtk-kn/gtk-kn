 ...
 */
public class Transform(pointer: CPointer<GskTransform>) : Record {
     ...
     * @return The new transform
     */
    public fun rotate3d(angle: Float, axis: Vec3): Transform? =
     ...
     * @return The new transform
     */
    public fun scale(factorX: Float, factorY: Float): Transform? =
     ...
     * @return The new transform
     */
    public fun scale3d(factorX: Float, factorY: Float, factorZ: Float): Transform? =
     ...
     */
    @GskVersion4_6
    public fun skew(skewX: Float, skewY: Float): Transform? =
