...
public open class TransformNode(
     ...
     */
    public constructor(child: RenderNode, transform: Transform) : this(gsk_transform_node_new(child.gskRenderNodePointer, transform.gskTransformPointer)!!.reinterpret()) {
    ...
    public companion object : TypeCompanion<TransformNode> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gsk_transform_node_get_type")
    }
}
