...
public open class BlendNode(
    ...
    public constructor(
        ...
        top: RenderNode,
        blendMode: BlendMode,
    ) : this(gsk_blend_node_new(bottom.gskRenderNodePointer, top.gskRenderNodePointer, blendMode.nativeValue)!!.reinterpret()) {
    ...
    public companion object : TypeCompanion<BlendNode> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gsk_blend_node_get_type")
    }
}
