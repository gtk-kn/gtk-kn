...
public open class Application(
     ...
     */
    public constructor(applicationId: String? = null, flags: ApplicationFlags) : this(adw_application_new(applicationId, flags.mask)!!) {
    ...
    public companion object : TypeCompanion<Application> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("adw_application_get_type")
    }
}
