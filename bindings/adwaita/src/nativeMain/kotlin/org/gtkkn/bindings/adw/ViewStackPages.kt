...
public class ViewStackPages(
     ...
     */
    @AdwVersion1_4
    public fun setSelectedPage(page: ViewStackPage): Unit = adw_view_stack_pages_set_selected_page(adwViewStackPagesPointer, page.adwViewStackPagePointer)
    ...
    public companion object : TypeCompanion<ViewStackPages> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("adw_view_stack_pages_get_type")
    }
}
