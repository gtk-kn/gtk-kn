...
public open class AlertDialog(
    ...
    ): Unit = adw_alert_dialog_choose(adwAlertDialogPointer.reinterpret(), parent?.gtkWidgetPointer?.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), AsyncReadyCallbackFunc.reinterpret(), StableRef.create(callback).asCPointer())
