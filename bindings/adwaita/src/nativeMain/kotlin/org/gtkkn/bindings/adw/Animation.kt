...
public abstract class Animation(
    ...
    public open var target: AnimationTarget
        ...
        get() = adw_animation_get_target(adwAnimationPointer)!!.run {
            InstanceCache.get(this, true) { AnimationTarget.AnimationTargetImpl(reinterpret()) }!!.apply { ref() }
        }
        /**
    ...
    public companion object : TypeCompanion<Animation> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("adw_animation_get_type")
    }
}
