...
public open class EntryRow(
    ...
    public open var activatesDefault: Boolean
         ...
         */
        @AdwVersion1_2
        set(activates) = adw_entry_row_set_activates_default(adwEntryRowPointer.reinterpret(), activates.asGBoolean())
    ...
    public open var attributes: AttrList?
         ...
         */
        @AdwVersion1_2
        set(attributes) = adw_entry_row_set_attributes(adwEntryRowPointer.reinterpret(), attributes?.pangoAttrListPointer?.reinterpret())
    ...
    public open var enableEmojiCompletion: Boolean
         ...
         * @since 1.2
         */
        get() = adw_entry_row_get_enable_emoji_completion(adwEntryRowPointer.reinterpret()).asBoolean()
        /**
         ...
         */
        @AdwVersion1_2
        set(enableEmojiCompletion) = adw_entry_row_set_enable_emoji_completion(adwEntryRowPointer.reinterpret(), enableEmojiCompletion.asGBoolean())
    ...
    public open var inputPurpose: InputPurpose
         ...
         */
        @AdwVersion1_2
        set(purpose) = adw_entry_row_set_input_purpose(adwEntryRowPointer.reinterpret(), purpose.nativeValue)
    ...
    public open var showApplyButton: Boolean
         ...
         */
        @AdwVersion1_2
        set(showApplyButton) = adw_entry_row_set_show_apply_button(adwEntryRowPointer.reinterpret(), showApplyButton.asGBoolean())
     ...
     */
    @AdwVersion1_2
    public open fun addPrefix(widget: Widget): Unit = adw_entry_row_add_prefix(adwEntryRowPointer.reinterpret(), widget.gtkWidgetPointer.reinterpret())
     ...
     */
    @AdwVersion1_2
    public open fun addSuffix(widget: Widget): Unit = adw_entry_row_add_suffix(adwEntryRowPointer.reinterpret(), widget.gtkWidgetPointer.reinterpret())
     ...
     */
    @AdwVersion1_3
    public open fun grabFocusWithoutSelecting(): Boolean = adw_entry_row_grab_focus_without_selecting(adwEntryRowPointer.reinterpret()).asBoolean()
     ...
     */
    @AdwVersion1_2
    public open fun remove(widget: Widget): Unit = adw_entry_row_remove(adwEntryRowPointer.reinterpret(), widget.gtkWidgetPointer.reinterpret())
     ...
     */
    @AdwVersion1_2
    public fun connectEntryActivated(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "entry-activated", connectEntryActivatedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
