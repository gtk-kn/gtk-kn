...
public class NavigationSplitView(
    ...
    public var collapsed: Boolean
         ...
         * @since 1.4
         */
        get() = adw_navigation_split_view_get_collapsed(adwNavigationSplitViewPointer).asBoolean()
        /**
         ...
         */
        @AdwVersion1_4
        set(collapsed) = adw_navigation_split_view_set_collapsed(adwNavigationSplitViewPointer, collapsed.asGBoolean())
    ...
    public var content: NavigationPage?
         ...
         */
        @AdwVersion1_4
        set(content) = adw_navigation_split_view_set_content(adwNavigationSplitViewPointer, content?.adwNavigationPagePointer)
    ...
    public var maxSidebarWidth: gdouble
         ...
         * @since 1.4
         */
        get() = adw_navigation_split_view_get_max_sidebar_width(adwNavigationSplitViewPointer)
        /**
         ...
         */
        @AdwVersion1_4
        set(width) = adw_navigation_split_view_set_max_sidebar_width(adwNavigationSplitViewPointer, width)
    ...
    public var minSidebarWidth: gdouble
         ...
         * @since 1.4
         */
        get() = adw_navigation_split_view_get_min_sidebar_width(adwNavigationSplitViewPointer)
        /**
         ...
         */
        @AdwVersion1_4
        set(width) = adw_navigation_split_view_set_min_sidebar_width(adwNavigationSplitViewPointer, width)
    ...
    public var showContent: Boolean
         ...
         * @since 1.4
         */
        get() = adw_navigation_split_view_get_show_content(adwNavigationSplitViewPointer).asBoolean()
        /**
         ...
         */
        @AdwVersion1_4
        set(showContent) = adw_navigation_split_view_set_show_content(adwNavigationSplitViewPointer, showContent.asGBoolean())
    ...
    public var sidebar: NavigationPage?
         ...
         */
        @AdwVersion1_4
        set(sidebar) = adw_navigation_split_view_set_sidebar(adwNavigationSplitViewPointer, sidebar?.adwNavigationPagePointer)
    ...
    public var sidebarWidthFraction: gdouble
         ...
         * @since 1.4
         */
        get() = adw_navigation_split_view_get_sidebar_width_fraction(adwNavigationSplitViewPointer)
        /**
         ...
         */
        @AdwVersion1_4
        set(fraction) = adw_navigation_split_view_set_sidebar_width_fraction(adwNavigationSplitViewPointer, fraction)
    ...
    public var sidebarWidthUnit: LengthUnit
         ...
         * @since 1.4
         */
        get() = adw_navigation_split_view_get_sidebar_width_unit(adwNavigationSplitViewPointer).run {
         ...
         */
        @AdwVersion1_4
        set(unit) = adw_navigation_split_view_set_sidebar_width_unit(adwNavigationSplitViewPointer, unit.nativeValue)
    ...
    public companion object : TypeCompanion<NavigationSplitView> {
        override val type: GeneratedClassKGType<NavigationSplitView> =
                GeneratedClassKGType(getTypeOrNull()!!) { NavigationSplitView(it.reinterpret()) }
        ...
        /**
         * Gets the GType of from the symbol `adw_navigation_split_view_get_type` if it exists.
         *
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("adw_navigation_split_view_get_type")
    }
}
