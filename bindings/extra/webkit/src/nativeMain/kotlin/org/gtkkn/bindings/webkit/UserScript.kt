...
public class UserScript(
    public val webkitUserScriptPointer: CPointer<WebKitUserScript>,
    ...
    public constructor(
        ...
        webkit_user_script_new(source, injectedFrames.nativeValue, injectionTime.nativeValue, allowList?.toCStringList(this), blockList?.toCStringList(this))!!
    }
    ) {
    ...
    public constructor(
        ...
        webkit_user_script_new_for_world(source, injectedFrames.nativeValue, injectionTime.nativeValue, worldName, allowList?.toCStringList(this), blockList?.toCStringList(this))!!
    }
    ) {
        MemoryCleaner.setBoxedType(this, getType(), owned = true)
    }
