...
public class ItpFirstParty(
    public val webkitItpFirstPartyPointer: CPointer<WebKitITPFirstParty>,
     ...
     */
    @WebKitVersion2_30
    public fun getDomain(): String = webkit_itp_first_party_get_domain(webkitItpFirstPartyPointer)?.toKString() ?: error("Expected not null string")
     ...
     */
    @WebKitVersion2_30
    public fun getLastUpdateTime(): DateTime = webkit_itp_first_party_get_last_update_time(webkitItpFirstPartyPointer)!!.run {
        DateTime(this)}
     ...
     */
    @WebKitVersion2_30
    public fun getWebsiteDataAccessAllowed(): Boolean = webkit_itp_first_party_get_website_data_access_allowed(webkitItpFirstPartyPointer).asBoolean()
