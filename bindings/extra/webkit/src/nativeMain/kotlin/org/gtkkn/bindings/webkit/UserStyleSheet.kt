...
public class UserStyleSheet(
    public val webkitUserStyleSheetPointer: CPointer<WebKitUserStyleSheet>,
    ...
    public constructor(
        ...
        webkit_user_style_sheet_new(source, injectedFrames.nativeValue, level.nativeValue, allowList?.toCStringList(this), blockList?.toCStringList(this))!!
    }
    ) {
    ...
    public constructor(
        ...
        webkit_user_style_sheet_new_for_world(source, injectedFrames.nativeValue, level.nativeValue, worldName, allowList?.toCStringList(this), blockList?.toCStringList(this))!!
    }
    ) {
        MemoryCleaner.setBoxedType(this, getType(), owned = true)
    }
