...
public class WebResource(
     ...
     */
    public fun getData(cancellable: Cancellable? = null, callback: AsyncReadyCallback): Unit = webkit_web_resource_get_data(webkitWebResourcePointer.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), AsyncReadyCallbackFunc.reinterpret(), StableRef.create(callback).asCPointer())
