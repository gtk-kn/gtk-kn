...
public class GeolocationPermissionRequest(
    ...
    public companion object : TypeCompanion<GeolocationPermissionRequest> {
        override val type: GeneratedClassKGType<GeolocationPermissionRequest> =
                GeneratedClassKGType(getTypeOrNull()!!) { GeolocationPermissionRequest(it.reinterpret()) }
        ...
        /**
         * Gets the GType of from the symbol `webkit_geolocation_permission_request_get_type` if it exists.
         *
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("webkit_geolocation_permission_request_get_type")
    }
}
