...
public enum class AuthenticationScheme(
     ...
     */
    SERVER_TRUST_EVALUATION_REQUESTED(WebKitAuthenticationScheme.WEBKIT_AUTHENTICATION_SCHEME_SERVER_TRUST_EVALUATION_REQUESTED),
    /**
     * Client certificate PIN required for use. Since: 2.34
     */
    CLIENT_CERTIFICATE_PIN_REQUESTED(WebKitAuthenticationScheme.WEBKIT_AUTHENTICATION_SCHEME_CLIENT_CERTIFICATE_PIN_REQUESTED),
    /**
