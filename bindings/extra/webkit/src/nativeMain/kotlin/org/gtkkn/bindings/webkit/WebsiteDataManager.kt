...
public class WebsiteDataManager(
    ...
    ): Unit = webkit_website_data_manager_clear(webkitWebsiteDataManagerPointer.reinterpret(), types.mask, timespan, cancellable?.gioCancellablePointer?.reinterpret(), AsyncReadyCallbackFunc.reinterpret(), StableRef.create(callback).asCPointer())
    ...
    public fun fetch(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback,
    ): Unit = webkit_website_data_manager_fetch(webkitWebsiteDataManagerPointer.reinterpret(), types.mask, cancellable?.gioCancellablePointer?.reinterpret(), AsyncReadyCallbackFunc.reinterpret(), StableRef.create(callback).asCPointer())
     ...
     */
    @WebKitVersion2_30
    public fun getItpSummary(cancellable: Cancellable? = null, callback: AsyncReadyCallback): Unit = webkit_website_data_manager_get_itp_summary(webkitWebsiteDataManagerPointer.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), AsyncReadyCallbackFunc.reinterpret(), StableRef.create(callback).asCPointer())
    ...
    public fun remove(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback,
    ): Unit = webkit_website_data_manager_remove(webkitWebsiteDataManagerPointer.reinterpret(), types.mask, websiteData.glibListPointer.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), AsyncReadyCallbackFunc.reinterpret(), StableRef.create(callback).asCPointer())
