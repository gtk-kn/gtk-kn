...
public class NetworkProxySettings(
    public val webkitNetworkProxySettingsPointer: CPointer<WebKitNetworkProxySettings>,
     ...
     * @since 2.16
     */
    public constructor(defaultProxyUri: String? = null, ignoreHosts: List<String>? = null) : this(memScoped {
        webkit_network_proxy_settings_new(defaultProxyUri, ignoreHosts?.toCStringList(this))!!
    }
    ) {
     ...
     */
    @WebKitVersion2_16
    public fun addProxyForScheme(scheme: String, proxyUri: String): Unit = webkit_network_proxy_settings_add_proxy_for_scheme(webkitNetworkProxySettingsPointer, scheme, proxyUri)
     ...
     */
    @WebKitVersion2_16
    public fun copy(): NetworkProxySettings = webkit_network_proxy_settings_copy(webkitNetworkProxySettingsPointer)!!.run {
