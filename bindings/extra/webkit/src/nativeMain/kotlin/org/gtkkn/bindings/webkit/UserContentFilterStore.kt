...
public class UserContentFilterStore(
     ...
     * @since 2.24
     */
    public constructor(storagePath: String) : this(webkit_user_content_filter_store_new(storagePath)!!.reinterpret())
    ...
    ): Unit = webkit_user_content_filter_store_load(webkitUserContentFilterStorePointer.reinterpret(), identifier, cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public fun remove(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = webkit_user_content_filter_store_remove(webkitUserContentFilterStorePointer.reinterpret(), identifier, cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public fun save(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = webkit_user_content_filter_store_save(webkitUserContentFilterStorePointer.reinterpret(), identifier, source.glibBytesPointer.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public fun saveFromFile(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = webkit_user_content_filter_store_save_from_file(webkitUserContentFilterStorePointer.reinterpret(), identifier, `file`.gioFilePointer, cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
