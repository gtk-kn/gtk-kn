...
public open class GutterLines(
     ...
     */
    public open fun addClass(line: UInt, name: String): Unit = gtk_source_gutter_lines_add_class(gtksourceGutterLinesPointer.reinterpret(), line, name)
     ...
     */
    public open fun addQclass(line: UInt, qname: Quark): Unit = gtk_source_gutter_lines_add_qclass(gtksourceGutterLinesPointer.reinterpret(), line, qname)
     ...
     */
    public open fun getIterAtLine(iter: TextIter, line: UInt): Unit = gtk_source_gutter_lines_get_iter_at_line(gtksourceGutterLinesPointer.reinterpret(), iter.gtkTextIterPointer.reinterpret(), line)
     ...
     */
    @GtkSourceVersion5_6
    public open fun hasAnyClass(line: UInt): Boolean = gtk_source_gutter_lines_has_any_class(gtksourceGutterLinesPointer.reinterpret(), line).asBoolean()
     ...
     */
    public open fun hasClass(line: UInt, name: String): Boolean = gtk_source_gutter_lines_has_class(gtksourceGutterLinesPointer.reinterpret(), line, name).asBoolean()
     ...
     */
    public open fun hasQclass(line: UInt, qname: Quark): Boolean = gtk_source_gutter_lines_has_qclass(gtksourceGutterLinesPointer.reinterpret(), line, qname).asBoolean()
     ...
     */
    public open fun isCursor(line: UInt): Boolean = gtk_source_gutter_lines_is_cursor(gtksourceGutterLinesPointer.reinterpret(), line).asBoolean()
     ...
     */
    public open fun isPrelit(line: UInt): Boolean = gtk_source_gutter_lines_is_prelit(gtksourceGutterLinesPointer.reinterpret(), line).asBoolean()
     ...
     */
    public open fun isSelected(line: UInt): Boolean = gtk_source_gutter_lines_is_selected(gtksourceGutterLinesPointer.reinterpret(), line).asBoolean()
     ...
     * @param name a class name
     */
    public open fun removeClass(line: UInt, name: String): Unit = gtk_source_gutter_lines_remove_class(gtksourceGutterLinesPointer.reinterpret(), line, name)
     ...
     */
    public open fun removeQclass(line: UInt, qname: Quark): Unit = gtk_source_gutter_lines_remove_qclass(gtksourceGutterLinesPointer.reinterpret(), line, qname)
