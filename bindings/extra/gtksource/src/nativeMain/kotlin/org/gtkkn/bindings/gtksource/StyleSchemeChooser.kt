...
public interface StyleSchemeChooser : Interface, KGTyped {
    ...
    public var styleScheme: StyleScheme
         ...
         */
        get() = gtk_source_style_scheme_chooser_get_style_scheme(gtksourceStyleSchemeChooserPointer.reinterpret())!!.run {
         ...
         */
        set(scheme) = gtk_source_style_scheme_chooser_set_style_scheme(gtksourceStyleSchemeChooserPointer.reinterpret(), scheme.gtksourceStyleSchemePointer.reinterpret())
     ...
     * @return the currently-selected scheme.
     */
    public fun getStyleScheme(): StyleScheme = gtk_source_style_scheme_chooser_get_style_scheme(gtksourceStyleSchemeChooserPointer.reinterpret())!!.run {
        StyleScheme(reinterpret())}
     ...
     * @param scheme a #GtkSourceStyleScheme
     */
    public fun setStyleScheme(scheme: StyleScheme): Unit = gtk_source_style_scheme_chooser_set_style_scheme(gtksourceStyleSchemeChooserPointer.reinterpret(), scheme.gtksourceStyleSchemePointer.reinterpret())
