...
public open class GutterRendererText(
    ...
    public open fun setMarkup(markup: String, length: gint): Unit = gtk_source_gutter_renderer_text_set_markup(gtksourceGutterRendererTextPointer, markup, length)

    public open fun setText(text: String, length: gint): Unit = gtk_source_gutter_renderer_text_set_text(gtksourceGutterRendererTextPointer, text, length)
    ...
    public companion object : TypeCompanion<GutterRendererText> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_source_gutter_renderer_text_get_type")
    }
}
