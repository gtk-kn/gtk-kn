...
public open class Completion(
     ...
     */
    public open fun addProvider(provider: CompletionProvider): Unit = gtk_source_completion_add_provider(gtksourceCompletionPointer.reinterpret(), provider.gtksourceCompletionProviderPointer)

    public open fun blockInteractive(): Unit = gtk_source_completion_block_interactive(gtksourceCompletionPointer.reinterpret())
     ...
     * @param provider a #GtkSourceCompletionProvider
     */
    public open fun removeProvider(provider: CompletionProvider): Unit = gtk_source_completion_remove_provider(gtksourceCompletionPointer.reinterpret(), provider.gtksourceCompletionProviderPointer)
    ...
    public open fun unblockInteractive(): Unit = gtk_source_completion_unblock_interactive(gtksourceCompletionPointer.reinterpret())
     ...
     */
    public fun connectProviderAdded(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (provider: CompletionProvider) -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "provider-added", connectProviderAddedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect. Params: `provider` a #GtkSourceCompletionProvider
     */
    public fun connectProviderRemoved(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (provider: CompletionProvider) -> Unit): ULong = g_signal_connect_data(gPointer.reinterpret(), "provider-removed", connectProviderRemovedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
