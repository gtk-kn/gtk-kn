...
public open class SearchSettings(
    ...
    public open var atWordBoundaries: Boolean
         ...
         */
        get() = gtk_source_search_settings_get_at_word_boundaries(gtksourceSearchSettingsPointer.reinterpret()).asBoolean()
        /**
         ...
         */
        set(atWordBoundaries) = gtk_source_search_settings_set_at_word_boundaries(gtksourceSearchSettingsPointer.reinterpret(), atWordBoundaries.asGBoolean())
    ...
    public open var caseSensitive: Boolean
         ...
         */
        set(caseSensitive) = gtk_source_search_settings_set_case_sensitive(gtksourceSearchSettingsPointer.reinterpret(), caseSensitive.asGBoolean())
    ...
    public open var regexEnabled: Boolean
         ...
         */
        set(regexEnabled) = gtk_source_search_settings_set_regex_enabled(gtksourceSearchSettingsPointer.reinterpret(), regexEnabled.asGBoolean())
    ...
    public open var searchText: String?
         ...
         */
        set(searchText) = gtk_source_search_settings_set_search_text(gtksourceSearchSettingsPointer.reinterpret(), searchText)
    ...
    public open var visibleOnly: Boolean
         ...
         */
        @GtkSourceVersion5_12
        set(visibleOnly) = gtk_source_search_settings_set_visible_only(gtksourceSearchSettingsPointer.reinterpret(), visibleOnly.asGBoolean())
    ...
    public open var wrapAround: Boolean
         ...
         */
        set(wrapAround) = gtk_source_search_settings_set_wrap_around(gtksourceSearchSettingsPointer.reinterpret(), wrapAround.asGBoolean())
