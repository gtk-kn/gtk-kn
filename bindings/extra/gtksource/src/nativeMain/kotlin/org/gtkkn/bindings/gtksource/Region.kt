 ...
 * ```
 */
public open class Region(pointer: CPointer<GtkSourceRegion>) :
     ...
     */
    public open fun getStartRegionIter(iter: RegionIter): Unit = gtk_source_region_get_start_region_iter(
        gtksourceRegionPointer.reinterpret(),
