...
public open class Region(
     ...
     */
    public constructor(buffer: TextBuffer) : this(gtk_source_region_new(buffer.gtkTextBufferPointer.reinterpret())!!.reinterpret())
     ...
     */
    public open fun addRegion(regionToAdd: Region? = null): Unit = gtk_source_region_add_region(gtksourceRegionPointer.reinterpret(), regionToAdd?.gtksourceRegionPointer?.reinterpret())
     ...
     */
    public open fun addSubregion(start: TextIter, end: TextIter): Unit = gtk_source_region_add_subregion(gtksourceRegionPointer.reinterpret(), start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret())
     ...
     */
    public open fun getBounds(start: TextIter?, end: TextIter?): Boolean = gtk_source_region_get_bounds(gtksourceRegionPointer.reinterpret(), start?.gtkTextIterPointer?.reinterpret(), end?.gtkTextIterPointer?.reinterpret()).asBoolean()
     ...
     */
    public open fun getStartRegionIter(iter: RegionIter): Unit = gtk_source_region_get_start_region_iter(gtksourceRegionPointer.reinterpret(), iter.gtksourceRegionIterPointer.reinterpret())
     ...
     *   object.
     */
    public open fun intersectRegion(region2: Region? = null): Region? = gtk_source_region_intersect_region(gtksourceRegionPointer.reinterpret(), region2?.gtksourceRegionPointer?.reinterpret())?.run {
        Region(reinterpret())}
     ...
     *   #GtkSourceRegion.
     */
    public open fun intersectSubregion(start: TextIter, end: TextIter): Region? = gtk_source_region_intersect_subregion(gtksourceRegionPointer.reinterpret(), start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret())?.run {
        Region(reinterpret())}
     ...
     *   @region, or null.
     */
    public open fun subtractRegion(regionToSubtract: Region? = null): Unit = gtk_source_region_subtract_region(gtksourceRegionPointer.reinterpret(), regionToSubtract?.gtksourceRegionPointer?.reinterpret())
     ...
     * @param end the end of the subregion.
     */
    public open fun subtractSubregion(start: TextIter, end: TextIter): Unit = gtk_source_region_subtract_subregion(gtksourceRegionPointer.reinterpret(), start.gtkTextIterPointer.reinterpret(), end.gtkTextIterPointer.reinterpret())
     ...
     */
    public open fun toStringRegion(): String? = gtk_source_region_to_string(gtksourceRegionPointer.reinterpret())?.toKString()
