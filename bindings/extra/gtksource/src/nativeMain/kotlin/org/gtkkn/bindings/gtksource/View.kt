...
public open class View(pointer: CPointer<GtkSourceView>) :
     ...
     */
    public open fun getGutterView(windowType: UInt): Gutter =
     ...
     */
    public open fun setMarkAttributes(category: String, attributes: MarkAttributes, priority: Int): Unit =
     ...
     */
    public fun connectJoinLines(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong =
     ...
     */
    public fun connectMoveWords(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (count: Int) -> Unit): ULong =
        g_signal_connect_data(
            gPointer.reinterpret(),
            "move-words",
     ...
     * @param handler the Callback to connect
     */
    public fun connectShowCompletion(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong =
        g_signal_connect_data(
            gPointer.reinterpret(),
            "show-completion",
