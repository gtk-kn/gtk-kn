...
public open class LanguageManager(
    ...
    public companion object : TypeCompanion<LanguageManager> {
        ...
        public fun getDefault(): LanguageManager = gtk_source_language_manager_get_default()!!.run {
            InstanceCache.get(this, true) { LanguageManager(reinterpret()) }!!.apply { ref() }
        }
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("gtk_source_language_manager_get_type")
    }
}
