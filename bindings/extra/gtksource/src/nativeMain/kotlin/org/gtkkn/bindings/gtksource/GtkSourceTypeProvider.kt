...
public object GtkSourceTypeProvider : TypeProvider {
    override val typeMap: kotlin.collections.Map<KClass<*>, KGType<*>> = buildMap {
        ...
        if (StyleSchemeChooserButton.getTypeOrNull() != null) put(StyleSchemeChooserButton::class, StyleSchemeChooserButton.type)
        if (StyleSchemeChooserWidget.getTypeOrNull() != null) put(StyleSchemeChooserWidget::class, StyleSchemeChooserWidget.type)
