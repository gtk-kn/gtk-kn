...
public object GtkSourceTypeProvider : TypeProvider {
    override val typeMap: kotlin.collections.Map<KClass<*>, KGType<*>> = buildMap {
        ...
        if (getTypeOrNull("gtk_source_completion_cell_get_type") != null) put(CompletionCell::class, CompletionCell.type)
        if (getTypeOrNull("gtk_source_completion_context_get_type") != null) put(CompletionContext::class, CompletionContext.type)
        if (getTypeOrNull("gtk_source_completion_snippets_get_type") != null) put(CompletionSnippets::class, CompletionSnippets.type)
        if (getTypeOrNull("gtk_source_completion_words_get_type") != null) put(CompletionWords::class, CompletionWords.type)
        ...
        if (getTypeOrNull("gtk_source_gutter_renderer_get_type") != null) put(GutterRenderer::class, GutterRenderer.type)
        if (getTypeOrNull("gtk_source_gutter_renderer_pixbuf_get_type") != null) put(GutterRendererPixbuf::class, GutterRendererPixbuf.type)
        if (getTypeOrNull("gtk_source_gutter_renderer_text_get_type") != null) put(GutterRendererText::class, GutterRendererText.type)
        ...
        if (getTypeOrNull("gtk_source_language_manager_get_type") != null) put(LanguageManager::class, LanguageManager.type)
        ...
        if (getTypeOrNull("gtk_source_mark_attributes_get_type") != null) put(MarkAttributes::class, MarkAttributes.type)
        if (getTypeOrNull("gtk_source_print_compositor_get_type") != null) put(PrintCompositor::class, PrintCompositor.type)
        ...
        if (getTypeOrNull("gtk_source_search_settings_get_type") != null) put(SearchSettings::class, SearchSettings.type)
        ...
        if (getTypeOrNull("gtk_source_snippet_context_get_type") != null) put(SnippetContext::class, SnippetContext.type)
        if (getTypeOrNull("gtk_source_snippet_manager_get_type") != null) put(SnippetManager::class, SnippetManager.type)
        ...
        if (getTypeOrNull("gtk_source_style_scheme_chooser_button_get_type") != null) put(StyleSchemeChooserButton::class, StyleSchemeChooserButton.type)
        if (getTypeOrNull("gtk_source_style_scheme_chooser_widget_get_type") != null) put(StyleSchemeChooserWidget::class, StyleSchemeChooserWidget.type)
        if (getTypeOrNull("gtk_source_style_scheme_manager_get_type") != null) put(StyleSchemeManager::class, StyleSchemeManager.type)
        if (getTypeOrNull("gtk_source_style_scheme_preview_get_type") != null) put(StyleSchemePreview::class, StyleSchemePreview.type)
        ...
        if (getTypeOrNull("gtk_source_completion_proposal_get_type") != null) put(CompletionProposal::class, CompletionProposal.type)
        if (getTypeOrNull("gtk_source_completion_provider_get_type") != null) put(CompletionProvider::class, CompletionProvider.type)
        ...
        if (getTypeOrNull("gtk_source_style_scheme_chooser_get_type") != null) put(StyleSchemeChooser::class, StyleSchemeChooser.type)
    }
}
