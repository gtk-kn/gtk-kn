...
public class Context(
    ...
    public val virtualMachine: VirtualMachine
         ...
         */
        get() =
            jsc_context_get_virtual_machine(javascriptcoreContextPointer.reinterpret())!!.run {
    ...
    public fun getException(): Exception? =
        jsc_context_get_exception(javascriptcoreContextPointer.reinterpret())?.run {
     ...
     * @return the #JSCVirtualMachine where the #JSCContext was created.
     */
    public fun getVirtualMachine(): VirtualMachine =
        jsc_context_get_virtual_machine(javascriptcoreContextPointer.reinterpret())!!.run {
            VirtualMachine(reinterpret())
        }
     ...
     */
    public fun pushExceptionHandler(handler: ExceptionHandler): Unit =
        jsc_context_push_exception_handler(
            javascriptcoreContextPointer.reinterpret(),
     ...
     * @param errorMessage an error message
     */
    public fun throwWithName(
        errorName: String,
        errorMessage: String,
    ): Unit = jsc_context_throw_with_name(javascriptcoreContextPointer.reinterpret(), errorName, errorMessage)
    ...
    public companion object : TypeCompanion<Context> {
         ...
         */
        public fun getCurrent(): Context? =
            jsc_context_get_current()?.run {
                Context(reinterpret())
            }
    }
}
