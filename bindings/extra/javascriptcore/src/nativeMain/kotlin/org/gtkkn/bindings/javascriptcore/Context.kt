...
public class Context(pointer: CPointer<JSCContext>) :
    ...
    public constructor(
        vm: VirtualMachine,
    ) : this(jsc_context_new_with_virtual_machine(vm.javascriptcoreVirtualMachinePointer.reinterpret())!!.reinterpret())
    ...
    public fun evaluate(code: String, length: Long): Value =
        jsc_context_evaluate(javascriptcoreContextPointer.reinterpret(), code, length)!!.run {
            Value(reinterpret())
        }
     ...
     * @return a #JSCValue representing the last value generated by the script.
     */
    public fun evaluateWithSourceUri(code: String, length: Long, uri: String, lineNumber: UInt): Value =
        jsc_context_evaluate_with_source_uri(
            javascriptcoreContextPointer.reinterpret(),
            code,
            length,
            uri,
            lineNumber
     ...
     * @return a #JSCValue
     */
    public fun getGlobalObject(): Value =
        jsc_context_get_global_object(javascriptcoreContextPointer.reinterpret())!!.run {
            Value(reinterpret())
        }
     ...
     * @return a #JSCValue
     */
    public fun getValue(name: String): Value =
        jsc_context_get_value(javascriptcoreContextPointer.reinterpret(), name)!!.run {
            Value(reinterpret())
        }
     ...
     */
    public fun popExceptionHandler(): Unit =
        jsc_context_pop_exception_handler(javascriptcoreContextPointer.reinterpret())
     ...
     */
    public fun setValue(name: String, `value`: Value): Unit = jsc_context_set_value(
        javascriptcoreContextPointer.reinterpret(),
        name,
        `value`.javascriptcoreValuePointer.reinterpret()
    )
     ...
     */
    public fun `throw`(errorMessage: String): Unit =
        jsc_context_throw(javascriptcoreContextPointer.reinterpret(), errorMessage)
     ...
     */
    public fun throwException(exception: Exception): Unit = jsc_context_throw_exception(
        javascriptcoreContextPointer.reinterpret(),
        exception.javascriptcoreExceptionPointer.reinterpret()
    )
    ...
    public fun throwWithName(errorName: String, errorMessage: String): Unit =
        jsc_context_throw_with_name(javascriptcoreContextPointer.reinterpret(), errorName, errorMessage)
