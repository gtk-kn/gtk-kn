...
import org.gtkkn.native.javascriptcore.jsc_context_evaluate_with_source_uri
import org.gtkkn.native.javascriptcore.jsc_context_get_current
import org.gtkkn.native.javascriptcore.jsc_context_get_exception
import org.gtkkn.native.javascriptcore.jsc_context_get_global_object
import org.gtkkn.native.javascriptcore.jsc_context_get_type
import org.gtkkn.native.javascriptcore.jsc_context_get_value
import org.gtkkn.native.javascriptcore.jsc_context_get_virtual_machine
import org.gtkkn.native.javascriptcore.jsc_context_new
import org.gtkkn.native.javascriptcore.jsc_context_new_with_virtual_machine
import org.gtkkn.native.javascriptcore.jsc_context_pop_exception_handler
import org.gtkkn.native.javascriptcore.jsc_context_push_exception_handler
import org.gtkkn.native.javascriptcore.jsc_context_set_value
import org.gtkkn.native.javascriptcore.jsc_context_throw
import org.gtkkn.native.javascriptcore.jsc_context_throw_exception
import org.gtkkn.native.javascriptcore.jsc_context_throw_with_name
...
public class Context(
    ...
    KGTyped {
    public val javascriptcoreContextPointer: CPointer<JSCContext>
    ...
    public val virtualMachine: VirtualMachine
         ...
         */
        get() = jsc_context_get_virtual_machine(javascriptcoreContextPointer.reinterpret())!!.run {
            VirtualMachine(reinterpret())}
     ...
     * @return the newly created #JSCContext.
     */
    public constructor(vm: VirtualMachine) : this(jsc_context_new_with_virtual_machine(vm.javascriptcoreVirtualMachinePointer.reinterpret())!!.reinterpret())

    /**
     * Clear the uncaught exception in @context if any.
     */
    public fun clearException(): Unit = jsc_context_clear_exception(javascriptcoreContextPointer.reinterpret())
     ...
     */
    public fun evaluate(code: String, length: Long): Value = jsc_context_evaluate(javascriptcoreContextPointer.reinterpret(), code, length)!!.run {
        Value(reinterpret())}
     ...
     * @return a #JSCValue representing the last value generated by the script.
     */
    public fun evaluateWithSourceUri(
        code: String,
        length: Long,
        uri: String,
        lineNumber: guint,
     ...
     */
    public fun getException(): Exception? = jsc_context_get_exception(javascriptcoreContextPointer.reinterpret())?.run {
     ...
     * @return a #JSCValue
     */
    public fun getGlobalObject(): Value = jsc_context_get_global_object(javascriptcoreContextPointer.reinterpret())!!.run {
        Value(reinterpret())}
     ...
     * @return a #JSCValue
     */
    public fun getValue(name: String): Value = jsc_context_get_value(javascriptcoreContextPointer.reinterpret(), name)!!.run {
        Value(reinterpret())}
     ...
     */
    public fun popExceptionHandler(): Unit = jsc_context_pop_exception_handler(javascriptcoreContextPointer.reinterpret())
     ...
     */
    public fun pushExceptionHandler(handler: ExceptionHandler): Unit = jsc_context_push_exception_handler(javascriptcoreContextPointer.reinterpret(), ExceptionHandlerFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret())
     ...
     */
    public fun setValue(name: String, `value`: Value): Unit = jsc_context_set_value(javascriptcoreContextPointer.reinterpret(), name, `value`.javascriptcoreValuePointer.reinterpret())
     ...
     */
    public fun `throw`(errorMessage: String): Unit = jsc_context_throw(javascriptcoreContextPointer.reinterpret(), errorMessage)
     ...
     */
    public fun throwException(exception: Exception): Unit = jsc_context_throw_exception(javascriptcoreContextPointer.reinterpret(), exception.javascriptcoreExceptionPointer.reinterpret())
     ...
     * @param errorMessage an error message
     */
    public fun throwWithName(errorName: String, errorMessage: String): Unit = jsc_context_throw_with_name(javascriptcoreContextPointer.reinterpret(), errorName, errorMessage)
