...
public open class WebsocketExtension(
    ...
    public open fun configure(connectionType: WebsocketConnectionType, params: HashTable? = null): Result<Boolean> = memScoped {
        ...
        val gResult = soup_websocket_extension_configure(soupWebsocketExtensionPointer.reinterpret(), connectionType.nativeValue, params?.glibHashTablePointer?.reinterpret(), gError.ptr).asBoolean()
     ...
     */
    public open fun getRequestParams(): String? = soup_websocket_extension_get_request_params(soupWebsocketExtensionPointer.reinterpret())?.toKString()
     ...
     * @return a new allocated string with the parameters
     */
    public open fun getResponseParams(): String? = soup_websocket_extension_get_response_params(soupWebsocketExtensionPointer.reinterpret())?.toKString()
