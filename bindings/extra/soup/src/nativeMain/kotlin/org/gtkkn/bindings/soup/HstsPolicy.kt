...
public class HstsPolicy(
    public val soupHstsPolicyPointer: CPointer<SoupHSTSPolicy>,
     ...
     */
    public constructor(msg: Message) : this(soup_hsts_policy_new_from_response(msg.soupMessagePointer)!!.reinterpret()) {
        MemoryCleaner.setBoxedType(this, getType(), owned = true)
    }
     ...
     * @return a new #SoupHSTSPolicy.
     */
    public constructor(domain: String, includeSubdomains: Boolean) : this(soup_hsts_policy_new_session_policy(domain, includeSubdomains.asGBoolean())!!) {
        MemoryCleaner.setBoxedType(this, getType(), owned = true)
    }
     ...
     */
    public fun equal(policy2: HstsPolicy): Boolean = soup_hsts_policy_equal(soupHstsPolicyPointer, policy2.soupHstsPolicyPointer).asBoolean()
     ...
     */
    public fun getDomain(): String = soup_hsts_policy_get_domain(soupHstsPolicyPointer)?.toKString() ?: error("Expected not null string")
