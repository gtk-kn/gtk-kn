...
public class MessageHeaders(
    public val soupMessageHeadersPointer: CPointer<SoupMessageHeaders>,
     ...
     */
    public fun append(name: String, `value`: String): Unit = soup_message_headers_append(soupMessageHeadersPointer, name, `value`)
     ...
     */
    public fun foreach(func: MessageHeadersForeachFunc): Unit = soup_message_headers_foreach(soupMessageHeadersPointer, MessageHeadersForeachFuncFunc.reinterpret(), StableRef.create(func).asCPointer())
     ...
     */
    public fun freeRanges(ranges: Range): Unit = soup_message_headers_free_ranges(soupMessageHeadersPointer, ranges.soupRangePointer)
     ...
     */
    public fun getHeadersType(): MessageHeadersType = soup_message_headers_get_headers_type(soupMessageHeadersPointer).run {
     ...
     */
    public fun getList(name: String): String? = soup_message_headers_get_list(soupMessageHeadersPointer, name)?.toKString()
     ...
     * @return the header's value or null if not found.
     */
    public fun getOne(name: String): String? = soup_message_headers_get_one(soupMessageHeadersPointer, name)?.toKString()
     ...
     *   false otherwise.
     */
    public fun headerContains(name: String, token: String): Boolean = soup_message_headers_header_contains(soupMessageHeadersPointer, name, token).asBoolean()
     ...
     */
    public fun headerEquals(name: String, `value`: String): Boolean = soup_message_headers_header_equals(soupMessageHeadersPointer, name, `value`).asBoolean()
     ...
     * @param value the new value of @name
     */
    public fun replace(name: String, `value`: String): Unit = soup_message_headers_replace(soupMessageHeadersPointer, name, `value`)
     ...
     */
    public fun setContentDisposition(disposition: String, params: HashTable? = null): Unit = soup_message_headers_set_content_disposition(soupMessageHeadersPointer, disposition, params?.glibHashTablePointer)
     ...
     */
    public fun setContentLength(contentLength: gint64): Unit = soup_message_headers_set_content_length(soupMessageHeadersPointer, contentLength)
    ...
    public fun setContentRange(
        ...
        totalLength: gint64,
    ): Unit = soup_message_headers_set_content_range(soupMessageHeadersPointer, start, end, totalLength)
     ...
     * @param params additional parameters
     */
    public fun setContentType(contentType: String, params: HashTable? = null): Unit = soup_message_headers_set_content_type(soupMessageHeadersPointer, contentType, params?.glibHashTablePointer)
     ...
     */
    public fun setEncoding(encoding: Encoding): Unit = soup_message_headers_set_encoding(soupMessageHeadersPointer, encoding.nativeValue)
     ...
     */
    public fun setExpectations(expectations: Expectation): Unit = soup_message_headers_set_expectations(soupMessageHeadersPointer, expectations.mask)
     ...
     */
    public fun setRange(start: gint64, end: gint64): Unit = soup_message_headers_set_range(soupMessageHeadersPointer, start, end)
     ...
     */
    public fun setRanges(ranges: Range, length: gint): Unit = soup_message_headers_set_ranges(soupMessageHeadersPointer, ranges.soupRangePointer, length)
