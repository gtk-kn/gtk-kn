...
public object Soup {
     ...
     */
    public fun cookiesToCookieHeader(cookies: SList): KotlinString = soup_cookies_to_cookie_header(cookies.glibSListPointer)?.toKString() ?: error("Expected not null string")
     ...
     */
    public fun cookiesToRequest(cookies: SList, msg: Message): Unit = soup_cookies_to_request(cookies.glibSListPointer, msg.soupMessagePointer)
     ...
     * @param msg a #SoupMessage
     */
    public fun cookiesToResponse(cookies: SList, msg: Message): Unit = soup_cookies_to_response(cookies.glibSListPointer, msg.soupMessagePointer)
     ...
     */
    public fun dateTimeToString(date: DateTime, format: DateFormat): KotlinString = soup_date_time_to_string(date.glibDateTimePointer, format.nativeValue)?.toKString() ?: error("Expected not null string")
     ...
     */
    public fun formEncodeHash(formDataSet: HashTable): KotlinString = soup_form_encode_hash(formDataSet.glibHashTablePointer)?.toKString() ?: error("Expected not null string")
     ...
     */
    public fun headerFreeParamList(paramList: HashTable): Unit = soup_header_free_param_list(paramList.glibHashTablePointer)
     ...
     */
    public fun uriEqual(uri1: Uri, uri2: Uri): Boolean = soup_uri_equal(uri1.glibUriPointer, uri2.glibUriPointer).asBoolean()
