...
public object SoupTypeProvider : TypeProvider {
    override val typeMap: Map<KClass<*>, KGType<*>> = buildMap {
        ...
        if (WebsocketExtensionDeflate.getTypeOrNull() != null) put(WebsocketExtensionDeflate::class, WebsocketExtensionDeflate.type)
        if (WebsocketExtensionManager.getTypeOrNull() != null) put(WebsocketExtensionManager::class, WebsocketExtensionManager.type)
