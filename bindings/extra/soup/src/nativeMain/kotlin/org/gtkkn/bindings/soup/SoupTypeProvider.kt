...
public object SoupTypeProvider : TypeProvider {
    override val typeMap: Map<KClass<*>, KGType<*>> = buildMap {
        ...
        if (getTypeOrNull("soup_auth_domain_digest_get_type") != null) put(AuthDomainDigest::class, AuthDomainDigest.type)
        ...
        if (getTypeOrNull("soup_multipart_input_stream_get_type") != null) put(MultipartInputStream::class, MultipartInputStream.type)
        ...
        if (getTypeOrNull("soup_websocket_connection_get_type") != null) put(WebsocketConnection::class, WebsocketConnection.type)
        if (getTypeOrNull("soup_websocket_extension_get_type") != null) put(WebsocketExtension::class, WebsocketExtension.type)
        if (getTypeOrNull("soup_websocket_extension_deflate_get_type") != null) put(WebsocketExtensionDeflate::class, WebsocketExtensionDeflate.type)
        if (getTypeOrNull("soup_websocket_extension_manager_get_type") != null) put(WebsocketExtensionManager::class, WebsocketExtensionManager.type)
