...
public class MessageHeadersIter(
    ...
    public companion object {
         ...
         */
        public fun `init`(iter: MessageHeadersIter, hdrs: MessageHeaders): Unit = soup_message_headers_iter_init(iter.soupMessageHeadersIterPointer, hdrs.soupMessageHeadersPointer)
    }
}
