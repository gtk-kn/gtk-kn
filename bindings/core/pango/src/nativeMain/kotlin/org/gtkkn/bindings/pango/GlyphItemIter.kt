...
public class GlyphItemIter(
     ...
     */
    public constructor() : this(nativeHeap.alloc<PangoGlyphItemIter>().run {
     ...
     */
    private constructor(pair: Pair<CPointer<PangoGlyphItemIter>, Cleaner>) : this(pointer = pair.first, cleaner = pair.second)
