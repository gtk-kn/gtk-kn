...
public class TabArray(
    public val pangoTabArrayPointer: CPointer<PangoTabArray>,
) : ProxyInstance(pangoTabArrayPointer) {
    /**
     ...
     */
    public constructor(initialSize: gint, positionsInPixels: Boolean) : this(pango_tab_array_new(initialSize, positionsInPixels.asGBoolean())!!) {
     ...
     */
    @PangoVersion1_50
    public fun getDecimalPoint(tabIndex: gint): gunichar = pango_tab_array_get_decimal_point(pangoTabArrayPointer, tabIndex)
     ...
     */
    public fun getPositionsInPixels(): Boolean = pango_tab_array_get_positions_in_pixels(pangoTabArrayPointer).asBoolean()
     ...
     */
    @PangoVersion1_50
    public fun setDecimalPoint(tabIndex: gint, decimalPoint: gunichar): Unit = pango_tab_array_set_decimal_point(pangoTabArrayPointer, tabIndex, decimalPoint)
     ...
     */
    @PangoVersion1_50
    public fun setPositionsInPixels(positionsInPixels: Boolean): Unit = pango_tab_array_set_positions_in_pixels(pangoTabArrayPointer, positionsInPixels.asGBoolean())
    ...
    public fun setTab(
        ...
        alignment: TabAlign,
        location: gint,
    ): Unit = pango_tab_array_set_tab(pangoTabArrayPointer, tabIndex, alignment.nativeValue, location)
    ...
    @PangoVersion1_50
    override fun toString(): String = pango_tab_array_to_string(pangoTabArrayPointer)?.toKString() ?: error("Expected not null string")
