...
public open class FontsetSimple(
     ...
     */
    public constructor(language: Language) : this(pango_fontset_simple_new(language.pangoLanguagePointer.reinterpret())!!.reinterpret())
     ...
     */
    public open fun append(font: Font): Unit = pango_fontset_simple_append(pangoFontsetSimplePointer.reinterpret(), font.pangoFontPointer.reinterpret())
