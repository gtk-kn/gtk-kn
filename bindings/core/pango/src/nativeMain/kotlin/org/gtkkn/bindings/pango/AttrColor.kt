...
public class AttrColor(
     ...
     */
    public constructor() : this(nativeHeap.alloc<PangoAttrColor>().run {
     ...
     */
    private constructor(pair: Pair<CPointer<PangoAttrColor>, Cleaner>) : this(pointer = pair.first, cleaner = pair.second)
