...
public class AttrShape(
    public val pangoAttrShapePointer: CPointer<PangoAttrShape>,
     ...
     */
    public constructor() : this(nativeHeap.alloc<PangoAttrShape>().ptr) {
    ...
    public companion object {
         ...
         */
        public fun new(inkRect: Rectangle, logicalRect: Rectangle): Attribute = pango_attr_shape_new(inkRect.pangoRectanglePointer, logicalRect.pangoRectanglePointer)!!.run {
            Attribute(this)}
    }
}
