...
public open class SvgSurface(
     ...
     */
    @CairoVersion1_16
    public open fun setDocumentUnit(unit: guint): Unit = cairo_svg_surface_set_document_unit(cairoSvgSurfacePointer, unit)

    public open fun restrictToVersion(version: SvgVersion): Unit = cairo_svg_surface_restrict_to_version(cairoSvgSurfacePointer, version.nativeValue)
