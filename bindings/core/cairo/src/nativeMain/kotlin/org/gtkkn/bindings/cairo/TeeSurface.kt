...
public open class TeeSurface(
    ...
    public open fun add(target: Surface): Unit = cairo_tee_surface_add(cairoTeeSurfacePointer, target.cairoSurfacePointer)

    public open fun remove(target: Surface): Unit = cairo_tee_surface_remove(cairoTeeSurfacePointer, target.cairoSurfacePointer)
