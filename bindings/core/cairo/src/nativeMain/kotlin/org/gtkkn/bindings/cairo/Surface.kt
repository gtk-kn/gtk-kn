...
public open class Surface(
    ...
    public open fun markDirtyRectangle(
        x: gint,
        y: gint,
        width: gint,
        height: gint,
    ): Unit = cairo_surface_mark_dirty_rectangle(cairoSurfacePointer, x, y, width, height)

    public open fun setDeviceOffset(xOffset: gdouble, yOffset: gdouble): Unit = cairo_surface_set_device_offset(cairoSurfacePointer, xOffset, yOffset)
     ...
     */
    @CairoVersion1_14
    public open fun setDeviceScale(xScale: gdouble, yScale: gdouble): Unit = cairo_surface_set_device_scale(cairoSurfacePointer, xScale, yScale)
     ...
     */
    @CairoVersion1_2
    public open fun setFallbackResolution(xPpi: gdouble, yPpi: gdouble): Unit = cairo_surface_set_fallback_resolution(cairoSurfacePointer, xPpi, yPpi)
     ...
     */
    @CairoVersion1_12
    public open fun supportsMimeType(mimeType: String): Boolean = cairo_surface_supports_mime_type(cairoSurfacePointer, mimeType).asBoolean()
     ...
     */
    @CairoVersion1_12
    public open fun unmapImage(imageSurface: Surface): Unit = cairo_surface_unmap_image(cairoSurfacePointer, imageSurface.cairoSurfacePointer)
     ...
     */
    @CairoVersion1_4
    public open fun getUserData(key: UserDataKey): gpointer = cairo_surface_get_user_data(cairoSurfacePointer, key.cairoUserDataKeyPointer)!!
