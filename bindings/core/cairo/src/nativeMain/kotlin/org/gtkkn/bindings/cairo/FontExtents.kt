...
public class FontExtents(
     ...
     */
    public constructor() : this(nativeHeap.alloc<cairo_font_extents_t>().ptr) {
    ...
    override fun toString(): String = "FontExtents(ascent=$ascent, descent=$descent, height=$height, maxXAdvance=$maxXAdvance, maxYAdvance=$maxYAdvance)"
}
