...
public class FontOptions(
    public val cairoFontOptionsPointer: CPointer<cairo_font_options_t>,
    ...
    public fun merge(other: FontOptions): Unit = cairo_font_options_merge(cairoFontOptionsPointer, other.cairoFontOptionsPointer)

    public fun hash(): gulong = cairo_font_options_hash(cairoFontOptionsPointer)

    public fun equal(other: FontOptions): Boolean = cairo_font_options_equal(cairoFontOptionsPointer, other.cairoFontOptionsPointer).asBoolean()

    public fun setAntialias(antialias: Antialias): Unit = cairo_font_options_set_antialias(cairoFontOptionsPointer, antialias.nativeValue)
    ...
    public fun setSubpixelOrder(subpixelOrder: SubpixelOrder): Unit = cairo_font_options_set_subpixel_order(cairoFontOptionsPointer, subpixelOrder.nativeValue)
    ...
    public fun setHintStyle(hintStyle: HintStyle): Unit = cairo_font_options_set_hint_style(cairoFontOptionsPointer, hintStyle.nativeValue)
    ...
    public fun setHintMetrics(hintMetrics: HintMetrics): Unit = cairo_font_options_set_hint_metrics(cairoFontOptionsPointer, hintMetrics.nativeValue)
     ...
     */
    @CairoVersion1_16
    public fun setVariations(variations: String): Unit = cairo_font_options_set_variations(cairoFontOptionsPointer, variations)
     ...
     */
    @CairoVersion1_16
    public fun getVariations(): String = cairo_font_options_get_variations(cairoFontOptionsPointer)?.toKString() ?: error("Expected not null string")
     ...
     */
    @CairoVersion1_18
    public fun setColorMode(colorMode: ColorMode): Unit = cairo_font_options_set_color_mode(cairoFontOptionsPointer, colorMode.nativeValue)
     ...
     */
    @CairoVersion1_18
    public fun setColorPalette(paletteIndex: guint): Unit = cairo_font_options_set_color_palette(cairoFontOptionsPointer, paletteIndex)
     ...
     */
    @CairoVersion1_18
    public fun setCustomPaletteColor(
        index: guint,
        red: gdouble,
        green: gdouble,
        blue: gdouble,
        alpha: gdouble,
    ): Unit = cairo_font_options_set_custom_palette_color(cairoFontOptionsPointer, index, red, green, blue, alpha)
