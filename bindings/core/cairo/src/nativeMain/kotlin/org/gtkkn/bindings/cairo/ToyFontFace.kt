...
public open class ToyFontFace(
    ...
    public open fun getFamily(): String = cairo_toy_font_face_get_family(cairoToyFontFacePointer)?.toKString() ?: error("Expected not null string")
    ...
    public companion object : TypeCompanion<ToyFontFace> {
        override val type: GeneratedClassKGType<ToyFontFace> =
                GeneratedClassKGType(getTypeOrNull("cairo_gobject_font_face_get_type")!!) { ToyFontFace(it.reinterpret()) }
