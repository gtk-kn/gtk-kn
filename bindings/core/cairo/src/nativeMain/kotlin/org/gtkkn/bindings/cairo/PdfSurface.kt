...
public open class PdfSurface(
     ...
     */
    @CairoVersion1_10
    public open fun restrictToVersion(version: PdfVersion): Unit = cairo_pdf_surface_restrict_to_version(cairoPdfSurfacePointer, version.nativeValue)

    public open fun setSize(widthInPoints: gdouble, heightInPoints: gdouble): Unit = cairo_pdf_surface_set_size(cairoPdfSurfacePointer, widthInPoints, heightInPoints)
     ...
     */
    @CairoVersion1_16
    public open fun addOutline(
        parentId: gint,
        utf8Name: String,
        linkAttribs: String,
        flags: guint,
    ): gint = cairo_pdf_surface_add_outline(cairoPdfSurfacePointer, parentId, utf8Name, linkAttribs, flags)
     ...
     */
    @CairoVersion1_16
    public open fun setMetadata(metadata: PdfMetadata, utf8Value: String): Unit = cairo_pdf_surface_set_metadata(cairoPdfSurfacePointer, metadata.nativeValue, utf8Value)
     ...
     */
    @CairoVersion1_18
    public open fun setCustomMetadata(name: String, `value`: String): Unit = cairo_pdf_surface_set_custom_metadata(cairoPdfSurfacePointer, name, `value`)
