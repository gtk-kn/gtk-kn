...
public open class Script(
    ...
    public open fun fromRecordingSurface(recordingSurface: RecordingSurface): Status = cairo_script_from_recording_surface(cairoScriptPointer, recordingSurface.cairoRecordingSurfacePointer.reinterpret()).run {
    ...
    public open fun createScriptSurface(
        content: Content,
        width: gdouble,
        height: gdouble,
