...
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_composite_color
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_composite_color_simple
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_copy
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_copy_area
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_copy_options
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_fill
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_flip
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_get_bits_per_sample
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_get_byte_length
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_get_colorspace
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_get_file_info_async
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_get_formats
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_get_has_alpha
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_get_height
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_get_n_channels
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_get_option
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_get_options
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_get_rowstride
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_get_type
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_get_width
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_init_modules
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_new
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_new_from_bytes
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_new_from_file
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_new_from_file_at_scale
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_new_from_file_at_size
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_new_from_resource
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_new_from_resource_at_scale
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_new_from_stream
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_new_from_stream_async
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_new_from_stream_at_scale
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_new_from_stream_at_scale_async
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_new_from_stream_finish
...
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_save_to_callbackv
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_save_to_stream_finish
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_save_to_streamv
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_save_to_streamv_async
import org.gtkkn.native.gdkpixbuf.gdk_pixbuf_savev
...
public open class Pixbuf(
    ...
    public open val bitsPerSample: gint
         ...
         */
        get() = gdk_pixbuf_get_bits_per_sample(gdkpixbufPixbufPointer.reinterpret())
    ...
    public open val colorspace: Colorspace
         ...
         * @return Color space.
         */
        get() = gdk_pixbuf_get_colorspace(gdkpixbufPixbufPointer.reinterpret()).run {
    ...
    public open val hasAlpha: Boolean
         ...
         */
        get() = gdk_pixbuf_get_has_alpha(gdkpixbufPixbufPointer.reinterpret()).asBoolean()
    ...
    public open val height: gint
         ...
         */
        get() = gdk_pixbuf_get_height(gdkpixbufPixbufPointer.reinterpret())
    ...
    public open val nChannels: gint
         ...
         */
        get() = gdk_pixbuf_get_n_channels(gdkpixbufPixbufPointer.reinterpret())
    ...
    public open val rowstride: gint
         ...
         */
        get() = gdk_pixbuf_get_rowstride(gdkpixbufPixbufPointer.reinterpret())
    ...
    public open val width: gint
         ...
         */
        get() = gdk_pixbuf_get_width(gdkpixbufPixbufPointer.reinterpret())
    ...
    public constructor(
        ...
        height: gint,
        rowstride: gint,
    ) : this(gdk_pixbuf_new_from_bytes(`data`.glibBytesPointer.reinterpret(), colorspace.nativeValue, hasAlpha.asGBoolean(), bitsPerSample, width, height, rowstride)!!.reinterpret())
    ...
    public constructor(stream: InputStream, cancellable: Cancellable? = null) : this(memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = gdk_pixbuf_new_from_stream(stream.gioInputStreamPointer.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), gError.ptr)
        if (gError.pointed != null) {
            throw resolveException(Error(gError.pointed!!.ptr))
        }
        gResult!!.reinterpret()
    ...
    public constructor(
        ...
        val gError = allocPointerTo<GError>()
        val gResult = gdk_pixbuf_new_from_stream_at_scale(stream.gioInputStreamPointer.reinterpret(), width, height, preserveAspectRatio.asGBoolean(), cancellable?.gioCancellablePointer?.reinterpret(), gError.ptr)
        if (gError.pointed != null) {
            throw resolveException(Error(gError.pointed!!.ptr))
        }
        gResult!!.reinterpret()
    ...
    public open fun addAlpha(
        ...
        g: guint8,
        b: guint8,
    ): Pixbuf = gdk_pixbuf_add_alpha(gdkpixbufPixbufPointer.reinterpret(), substituteColor.asGBoolean(), r, g, b)!!.run {
        Pixbuf(reinterpret())}
    ...
    public open fun applyEmbeddedOrientation(): Pixbuf? = gdk_pixbuf_apply_embedded_orientation(gdkpixbufPixbufPointer.reinterpret())?.run {
        Pixbuf(reinterpret())}
    ...
    public open fun composite(
        ...
        overallAlpha: gint,
    ): Unit = gdk_pixbuf_composite(gdkpixbufPixbufPointer.reinterpret(), dest.gdkpixbufPixbufPointer.reinterpret(), destX, destY, destWidth, destHeight, offsetX, offsetY, scaleX, scaleY, interpType.nativeValue, overallAlpha)
    ...
    public open fun compositeColor(
        ...
        color1: guint,
        color2: guint,
    ): Unit = gdk_pixbuf_composite_color(gdkpixbufPixbufPointer.reinterpret(), dest.gdkpixbufPixbufPointer.reinterpret(), destX, destY, destWidth, destHeight, offsetX, offsetY, scaleX, scaleY, interpType.nativeValue, overallAlpha, checkX, checkY, checkSize, color1, color2)
    ...
    public open fun compositeColorSimple(
        ...
        color1: guint,
        color2: guint,
    ): Pixbuf? = gdk_pixbuf_composite_color_simple(gdkpixbufPixbufPointer.reinterpret(), destWidth, destHeight, interpType.nativeValue, overallAlpha, checkSize, color1, color2)?.run {
        Pixbuf(reinterpret())}
     ...
     * @return A newly-created pixbuf
     */
    public open fun copy(): Pixbuf? = gdk_pixbuf_copy(gdkpixbufPixbufPointer.reinterpret())?.run {
        Pixbuf(reinterpret())}
    ...
    public open fun copyArea(
        ...
        destX: gint,
        destY: gint,
    ): Unit = gdk_pixbuf_copy_area(gdkpixbufPixbufPointer.reinterpret(), srcX, srcY, width, height, destPixbuf.gdkpixbufPixbufPointer.reinterpret(), destX, destY)
    ...
    public open fun copyOptions(destPixbuf: Pixbuf): Boolean = gdk_pixbuf_copy_options(gdkpixbufPixbufPointer.reinterpret(), destPixbuf.gdkpixbufPixbufPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun fill(pixel: guint): Unit = gdk_pixbuf_fill(gdkpixbufPixbufPointer.reinterpret(), pixel)
     ...
     */
    @GdkPixbufVersion2_6
    public open fun flip(horizontal: Boolean): Pixbuf? = gdk_pixbuf_flip(gdkpixbufPixbufPointer.reinterpret(), horizontal.asGBoolean())?.run {
        Pixbuf(reinterpret())}
    ...
    public open fun getByteLength(): gsize = gdk_pixbuf_get_byte_length(gdkpixbufPixbufPointer.reinterpret())
     ...
     */
    public open fun getOption(key: String): String? = gdk_pixbuf_get_option(gdkpixbufPixbufPointer.reinterpret(), key)?.toKString()
    ...
    public open fun getOptions(): HashTable = gdk_pixbuf_get_options(gdkpixbufPixbufPointer.reinterpret())!!.run {
    ...
    public open fun newSubpixbuf(
        ...
        width: gint,
        height: gint,
    ): Pixbuf = gdk_pixbuf_new_subpixbuf(gdkpixbufPixbufPointer.reinterpret(), srcX, srcY, width, height)!!.run {
        Pixbuf(reinterpret())}
     ...
     */
    @GdkPixbufVersion2_32
    public open fun readPixelBytes(): Bytes = gdk_pixbuf_read_pixel_bytes(gdkpixbufPixbufPointer.reinterpret())!!.run {
        Bytes(reinterpret())}
     ...
     */
    @GdkPixbufVersion2_36
    public open fun removeOption(key: String): Boolean = gdk_pixbuf_remove_option(gdkpixbufPixbufPointer.reinterpret(), key).asBoolean()
     ...
     */
    @GdkPixbufVersion2_6
    public open fun rotateSimple(angle: PixbufRotation): Pixbuf? = gdk_pixbuf_rotate_simple(gdkpixbufPixbufPointer.reinterpret(), angle.nativeValue)?.run {
        Pixbuf(reinterpret())}
    ...
    public open fun saturateAndPixelate(
        ...
        saturation: gfloat,
        pixelate: Boolean,
    ): Unit = gdk_pixbuf_saturate_and_pixelate(gdkpixbufPixbufPointer.reinterpret(), dest.gdkpixbufPixbufPointer.reinterpret(), saturation, pixelate.asGBoolean())
    ...
    public open fun saveToCallbackv(
        ...
        val gError = allocPointerTo<GError>()
        val gResult = gdk_pixbuf_save_to_callbackv(gdkpixbufPixbufPointer.reinterpret(), PixbufSaveFuncFunc.reinterpret(), StableRef.create(saveFunc).asCPointer(), type, optionKeys?.toCStringList(this), optionValues?.toCStringList(this), gError.ptr).asBoolean()
    ...
    public open fun saveToStreamv(
        ...
        val gError = allocPointerTo<GError>()
        val gResult = gdk_pixbuf_save_to_streamv(gdkpixbufPixbufPointer.reinterpret(), stream.gioOutputStreamPointer.reinterpret(), type, optionKeys?.toCStringList(this), optionValues?.toCStringList(this), cancellable?.gioCancellablePointer?.reinterpret(), gError.ptr).asBoolean()
        return if (gError.pointed != null) {
            Result.failure(resolveException(Error(gError.pointed!!.ptr)))
        }
        else {
    ...
    public open fun saveToStreamvAsync(
        ...
        return gdk_pixbuf_save_to_streamv_async(gdkpixbufPixbufPointer.reinterpret(), stream.gioOutputStreamPointer.reinterpret(), type, optionKeys?.toCStringList(this), optionValues?.toCStringList(this), cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })}
    ...
    public open fun savev(
        ...
        val gError = allocPointerTo<GError>()
        val gResult = gdk_pixbuf_savev(gdkpixbufPixbufPointer.reinterpret(), filename, type, optionKeys?.toCStringList(this), optionValues?.toCStringList(this), gError.ptr).asBoolean()
        return if (gError.pointed != null) {
            Result.failure(resolveException(Error(gError.pointed!!.ptr)))
        }
        else {
    ...
    public open fun scale(
        ...
        scaleY: gdouble,
        interpType: InterpType,
    ): Unit = gdk_pixbuf_scale(gdkpixbufPixbufPointer.reinterpret(), dest.gdkpixbufPixbufPointer.reinterpret(), destX, destY, destWidth, destHeight, offsetX, offsetY, scaleX, scaleY, interpType.nativeValue)
    ...
    public open fun scaleSimple(
        ...
        destHeight: gint,
        interpType: InterpType,
    ): Pixbuf? = gdk_pixbuf_scale_simple(gdkpixbufPixbufPointer.reinterpret(), destWidth, destHeight, interpType.nativeValue)?.run {
        Pixbuf(reinterpret())}
    ...
    public companion object : TypeCompanion<Pixbuf> {
        ...
        public fun getFileInfoAsync(
            ...
            cancellable: Cancellable? = null,
            callback: AsyncReadyCallback?,
        ): Unit = gdk_pixbuf_get_file_info_async(filename, cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
        ...
        public fun newFromStreamAsync(
            ...
            cancellable: Cancellable? = null,
            callback: AsyncReadyCallback?,
        ): Unit = gdk_pixbuf_new_from_stream_async(stream.gioInputStreamPointer.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
        ...
        public fun newFromStreamAtScaleAsync(
            ...
            cancellable: Cancellable? = null,
            callback: AsyncReadyCallback?,
        ): Unit = gdk_pixbuf_new_from_stream_at_scale_async(stream.gioInputStreamPointer.reinterpret(), width, height, preserveAspectRatio.asGBoolean(), cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
