...
public class Closure(
    public val gobjectClosurePointer: CPointer<GClosure>,
     ...
     */
    public constructor(sizeofClosure: guint, `object`: Object) : this(g_closure_new_object(sizeofClosure, `object`.gobjectObjectPointer)!!) {
     ...
     */
    public constructor(sizeofClosure: guint, `data`: gpointer? = null) : this(g_closure_new_simple(sizeofClosure, `data`)!!) {
        MemoryCleaner.setBoxedType(this, getType(), owned = true)
    }
