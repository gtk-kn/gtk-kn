...
public class TypeValueTable(
     ...
     */
    public constructor() : this(nativeHeap.alloc<GTypeValueTable>().run {
     ...
     */
    private constructor(pair: Pair<CPointer<GTypeValueTable>, Cleaner>) : this(pointer = pair.first, cleaner = pair.second)
