 ...
 * - field `read_cond`: Record field read_cond is private
 * - field `write_cond`: Record field write_cond is private
 * - field `read_counter`: Record field read_counter is private
 * - field `have_writer`: Record field have_writer is private
 * - field `want_to_read`: Record field want_to_read is private
 * - field `want_to_write`: Record field want_to_write is private
 */
