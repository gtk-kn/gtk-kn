...
public class OptionEntry(
     ...
     */
    public constructor() : this(nativeHeap.alloc<GOptionEntry>().run {
    ...
    override fun toString(): String = "OptionEntry(longName=$longName, shortName=$shortName, flags=$flags, arg=$arg, description=$description, argDescription=$argDescription)"
}
