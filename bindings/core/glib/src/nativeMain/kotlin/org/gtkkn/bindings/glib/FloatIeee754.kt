...
public class FloatIeee754(
    pointer: CPointer<GFloatIEEE754>,
     ...
     */
    public constructor() : this(nativeHeap.alloc<GFloatIEEE754>().run {
     ...
     */
    private constructor(pair: Pair<CPointer<GFloatIEEE754>, Cleaner>) : this(pointer = pair.first, cleaner = pair.second)
