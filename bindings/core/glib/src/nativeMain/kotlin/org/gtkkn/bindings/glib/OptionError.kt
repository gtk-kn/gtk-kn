...
import org.gtkkn.native.glib.GOptionError.G_OPTION_ERROR_BAD_VALUE
import org.gtkkn.native.glib.GOptionError.G_OPTION_ERROR_FAILED
import org.gtkkn.native.glib.GOptionError.G_OPTION_ERROR_UNKNOWN_OPTION
...
public enum class OptionError(
    ...
    public companion object {
        public fun fromNativeValue(nativeValue: GOptionError): OptionError =
            when (nativeValue) {
                G_OPTION_ERROR_UNKNOWN_OPTION -> UNKNOWN_OPTION
                G_OPTION_ERROR_BAD_VALUE -> BAD_VALUE
                G_OPTION_ERROR_FAILED -> FAILED
