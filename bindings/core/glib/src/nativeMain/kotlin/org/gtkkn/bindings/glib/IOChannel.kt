 ...
 */
public class IOChannel(pointer: CPointer<GIOChannel>) : Record {
     ...
     */
    public fun seek(offset: Long, type: SeekType): IOError =
     ...
     */
    public fun setLineTerm(lineTerm: String? = null, length: Int): Unit =
