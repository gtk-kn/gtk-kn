...
public class ScannerConfig(
     ...
     */
    public constructor() : this(nativeHeap.alloc<GScannerConfig>().run {
     ...
     */
    private constructor(pair: Pair<CPointer<GScannerConfig>, Cleaner>) : this(pointer = pair.first, cleaner = pair.second)
