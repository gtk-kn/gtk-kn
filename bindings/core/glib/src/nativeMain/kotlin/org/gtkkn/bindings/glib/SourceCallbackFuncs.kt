...
public class SourceCallbackFuncs(
     ...
     */
    public constructor() : this(nativeHeap.alloc<GSourceCallbackFuncs>().run {
     ...
     */
    private constructor(pair: Pair<CPointer<GSourceCallbackFuncs>, Cleaner>) : this(pointer = pair.first, cleaner = pair.second)
