...
public class UriParamsIter(
     ...
     */
    public constructor() : this(nativeHeap.alloc<GUriParamsIter>().run {
     ...
     */
    private constructor(pair: Pair<CPointer<GUriParamsIter>, Cleaner>) : this(pointer = pair.first, cleaner = pair.second)
