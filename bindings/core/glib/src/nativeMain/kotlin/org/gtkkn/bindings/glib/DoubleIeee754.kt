...
public class DoubleIeee754(
    pointer: CPointer<GDoubleIEEE754>,
     ...
     */
    public constructor() : this(nativeHeap.alloc<GDoubleIEEE754>().run {
     ...
     */
    private constructor(pair: Pair<CPointer<GDoubleIEEE754>, Cleaner>) : this(pointer = pair.first, cleaner = pair.second)
    ...
    override fun toString(): String = "DoubleIeee754(vDouble=$vDouble, mantissaLow=$mantissaLow, mantissaHigh=$mantissaHigh, biasedExponent=$biasedExponent, sign=$sign)"
}
