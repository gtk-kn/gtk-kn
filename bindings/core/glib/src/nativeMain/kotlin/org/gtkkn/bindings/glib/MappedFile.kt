...
public class MappedFile(
    public val glibMappedFilePointer: CPointer<GMappedFile>,
    ...
    public constructor(filename: String, writable: Boolean) : this(memScoped {
     ...
     */
    @Throws(GLibException::class)
    public constructor(fd: gint, writable: Boolean) : this(memScoped {
        val gError = allocPointerTo<GError>()
        gError.`value` = null
     ...
     */
    @GLibVersion2_8
    public fun getContents(): String = g_mapped_file_get_contents(glibMappedFilePointer)?.toKString() ?: error("Expected not null string")
