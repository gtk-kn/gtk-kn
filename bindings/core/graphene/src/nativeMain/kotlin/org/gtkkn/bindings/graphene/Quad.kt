...
@GrapheneVersion1_0
public class Quad(
    public val grapheneQuadPointer: CPointer<graphene_quad_t>,
    ...
    public fun `init`(
        ...
        p3: Point,
        p4: Point,
    ): Quad = graphene_quad_init(grapheneQuadPointer, p1.graphenePointPointer, p2.graphenePointPointer, p3.graphenePointPointer, p4.graphenePointPointer)!!.run {
        Quad(this)}
     ...
     */
    @GrapheneVersion1_0
    public fun initFromRect(r: Rect): Quad = graphene_quad_init_from_rect(grapheneQuadPointer, r.grapheneRectPointer)!!.run {
        Quad(this)}
