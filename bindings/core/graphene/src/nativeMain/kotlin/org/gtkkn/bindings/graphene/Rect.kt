...
@GrapheneVersion1_0
public class Rect(
    public val grapheneRectPointer: CPointer<graphene_rect_t>,
     ...
     */
    @GrapheneVersion1_0
    public fun containsPoint(p: Point): Boolean = graphene_rect_contains_point(grapheneRectPointer, p.graphenePointPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun containsRect(b: Rect): Boolean = graphene_rect_contains_rect(grapheneRectPointer, b.grapheneRectPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun equal(b: Rect): Boolean = graphene_rect_equal(grapheneRectPointer, b.grapheneRectPointer)
     ...
     */
    @GrapheneVersion1_4
    public fun expand(p: Point, res: Rect): Unit = graphene_rect_expand(grapheneRectPointer, p.graphenePointPointer, res.grapheneRectPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun free(): Unit = graphene_rect_free(grapheneRectPointer)
     ...
     */
    @GrapheneVersion1_10
    public fun getArea(): gfloat = graphene_rect_get_area(grapheneRectPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun getBottomLeft(p: Point): Unit = graphene_rect_get_bottom_left(grapheneRectPointer, p.graphenePointPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun getBottomRight(p: Point): Unit = graphene_rect_get_bottom_right(grapheneRectPointer, p.graphenePointPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun getCenter(p: Point): Unit = graphene_rect_get_center(grapheneRectPointer, p.graphenePointPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun getHeight(): gfloat = graphene_rect_get_height(grapheneRectPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun getTopLeft(p: Point): Unit = graphene_rect_get_top_left(grapheneRectPointer, p.graphenePointPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun getTopRight(p: Point): Unit = graphene_rect_get_top_right(grapheneRectPointer, p.graphenePointPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun getWidth(): gfloat = graphene_rect_get_width(grapheneRectPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun getX(): gfloat = graphene_rect_get_x(grapheneRectPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun getY(): gfloat = graphene_rect_get_y(grapheneRectPointer)
    ...
    public fun `init`(
        ...
        width: gfloat,
        height: gfloat,
    ): Rect = graphene_rect_init(grapheneRectPointer, x, y, width, height)!!.run {
        Rect(this)}
     ...
     */
    @GrapheneVersion1_0
    public fun initFromRect(src: Rect): Rect = graphene_rect_init_from_rect(grapheneRectPointer, src.grapheneRectPointer)!!.run {
        Rect(this)}
     ...
     */
    @GrapheneVersion1_0
    public fun inset(dX: gfloat, dY: gfloat): Rect = graphene_rect_inset(grapheneRectPointer, dX, dY)!!.run {
        Rect(this)}
    ...
    public fun insetR(
        ...
        dY: gfloat,
        res: Rect,
    ): Unit = graphene_rect_inset_r(grapheneRectPointer, dX, dY, res.grapheneRectPointer)
    ...
    public fun interpolate(
        ...
        factor: gdouble,
        res: Rect,
    ): Unit = graphene_rect_interpolate(grapheneRectPointer, b.grapheneRectPointer, factor, res.grapheneRectPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun intersection(b: Rect, res: Rect?): Boolean = graphene_rect_intersection(grapheneRectPointer, b.grapheneRectPointer, res?.grapheneRectPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun normalize(): Rect = graphene_rect_normalize(grapheneRectPointer)!!.run {
        Rect(this)}
     ...
     */
    @GrapheneVersion1_4
    public fun normalizeR(res: Rect): Unit = graphene_rect_normalize_r(grapheneRectPointer, res.grapheneRectPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun offset(dX: gfloat, dY: gfloat): Rect = graphene_rect_offset(grapheneRectPointer, dX, dY)!!.run {
        Rect(this)}
     ...
     */
    @GrapheneVersion1_4
    public fun round(res: Rect): Unit = graphene_rect_round(grapheneRectPointer, res.grapheneRectPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun roundToPixel(): Rect = graphene_rect_round_to_pixel(grapheneRectPointer)!!.run {
        Rect(this)}
    ...
    public fun scale(
        ...
        sV: gfloat,
        res: Rect,
    ): Unit = graphene_rect_scale(grapheneRectPointer, sH, sV, res.grapheneRectPointer)
     ...
     */
    @GrapheneVersion1_0
    public fun union(b: Rect, res: Rect): Unit = graphene_rect_union(grapheneRectPointer, b.grapheneRectPointer, res.grapheneRectPointer)
