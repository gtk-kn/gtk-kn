...
@GrapheneVersion1_0
public class Size(
    public val grapheneSizePointer: CPointer<graphene_size_t>,
     ...
     */
    @GrapheneVersion1_0
    public fun `init`(width: gfloat, height: gfloat): Size = graphene_size_init(grapheneSizePointer, width, height)!!.run {
        Size(this)}
     ...
     */
    @GrapheneVersion1_0
    public fun initFromSize(src: Size): Size = graphene_size_init_from_size(grapheneSizePointer, src.grapheneSizePointer)!!.run {
        Size(this)}
    ...
    public fun interpolate(
        ...
        factor: gdouble,
        res: Size,
    ): Unit = graphene_size_interpolate(grapheneSizePointer, b.grapheneSizePointer, factor, res.grapheneSizePointer)
     ...
     */
    @GrapheneVersion1_0
    public fun scale(factor: gfloat, res: Size): Unit = graphene_size_scale(grapheneSizePointer, factor, res.grapheneSizePointer)
