 ...
 */
public class Matrix(pointer: CPointer<graphene_matrix_t>) : Record {
     ...
     */
    @GrapheneVersion1_0
    public fun getRow(index: UInt, res: Vec4): Unit =
     ...
     */
    @GrapheneVersion1_0
    public fun getValue(row: UInt, col: UInt): Float =
     ...
     */
    @GrapheneVersion1_0
    public fun initFrom2d(xx: Double, yx: Double, xy: Double, yy: Double, x0: Double, y0: Double): Matrix =
     ...
     */
    @GrapheneVersion1_2
    public fun initFrustum(left: Float, right: Float, bottom: Float, top: Float, zNear: Float, zFar: Float): Matrix =
     ...
     */
    @GrapheneVersion1_0
    public fun initOrtho(left: Float, right: Float, top: Float, bottom: Float, zNear: Float, zFar: Float): Matrix =
     ...
     */
    @GrapheneVersion1_0
    public fun initPerspective(fovy: Float, aspect: Float, zNear: Float, zFar: Float): Matrix =
     ...
     */
    @GrapheneVersion1_0
    public fun initRotate(angle: Float, axis: Vec3): Matrix = graphene_matrix_init_rotate(
        grapheneMatrixPointer.reinterpret(),
        angle,
     ...
     */
    @GrapheneVersion1_0
    public fun initScale(x: Float, y: Float, z: Float): Matrix =
     ...
     */
    @GrapheneVersion1_0
    public fun initSkew(xSkew: Float, ySkew: Float): Matrix =
     ...
     */
    @GrapheneVersion1_0
    public fun interpolate(b: Matrix, factor: Double, res: Matrix): Unit = graphene_matrix_interpolate(
        grapheneMatrixPointer.reinterpret(),
     ...
     */
    @GrapheneVersion1_10
    public fun near(b: Matrix, epsilon: Float): Boolean =
     ...
     */
    @GrapheneVersion1_0
    public fun perspective(depth: Float, res: Matrix): Unit =
     ...
     */
    @GrapheneVersion1_0
    public fun rotate(angle: Float, axis: Vec3): Unit =
     ...
     */
    @GrapheneVersion1_0
    public fun scale(factorX: Float, factorY: Float, factorZ: Float): Unit =
