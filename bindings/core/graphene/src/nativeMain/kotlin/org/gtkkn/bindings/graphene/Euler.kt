...
@GrapheneVersion1_2
public class Euler(
    public val grapheneEulerPointer: CPointer<graphene_euler_t>,
) : ProxyInstance(grapheneEulerPointer) {
    /**
    ...
    public fun `init`(
        ...
        y: gfloat,
        z: gfloat,
    ): Euler = graphene_euler_init(grapheneEulerPointer, x, y, z)!!.run {
        Euler(this)}
     ...
     */
    @GrapheneVersion1_2
    public fun initFromEuler(src: Euler? = null): Euler = graphene_euler_init_from_euler(grapheneEulerPointer, src?.grapheneEulerPointer)!!.run {
        Euler(this)}
     ...
     */
    @GrapheneVersion1_2
    public fun initFromMatrix(m: Matrix? = null, order: EulerOrder): Euler = graphene_euler_init_from_matrix(grapheneEulerPointer, m?.grapheneMatrixPointer, order.nativeValue)!!.run {
        Euler(this)}
     ...
     */
    @GrapheneVersion1_2
    public fun initFromQuaternion(q: Quaternion? = null, order: EulerOrder): Euler = graphene_euler_init_from_quaternion(grapheneEulerPointer, q?.grapheneQuaternionPointer, order.nativeValue)!!.run {
        Euler(this)}
    ...
    public fun initFromRadians(
        ...
        z: gfloat,
        order: EulerOrder,
    ): Euler = graphene_euler_init_from_radians(grapheneEulerPointer, x, y, z, order.nativeValue)!!.run {
        Euler(this)}
     ...
     */
    @GrapheneVersion1_2
    public fun initFromVec3(v: Vec3? = null, order: EulerOrder): Euler = graphene_euler_init_from_vec3(grapheneEulerPointer, v?.grapheneVec3Pointer, order.nativeValue)!!.run {
        Euler(this)}
    ...
    public fun initWithOrder(
        ...
        z: gfloat,
        order: EulerOrder,
    ): Euler = graphene_euler_init_with_order(grapheneEulerPointer, x, y, z, order.nativeValue)!!.run {
        Euler(this)}
     ...
     */
    @GrapheneVersion1_2
    public fun reorder(order: EulerOrder, res: Euler): Unit = graphene_euler_reorder(grapheneEulerPointer, order.nativeValue, res.grapheneEulerPointer)
     ...
     */
    @GrapheneVersion1_10
    public fun toQuaternion(res: Quaternion): Unit = graphene_euler_to_quaternion(grapheneEulerPointer, res.grapheneQuaternionPointer)
