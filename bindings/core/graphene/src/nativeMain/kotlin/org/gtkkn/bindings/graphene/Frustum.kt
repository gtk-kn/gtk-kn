...
public class Frustum(
    public val grapheneFrustumPointer: CPointer<graphene_frustum_t>,
     ...
     */
    @GrapheneVersion1_2
    public fun containsPoint(point: Point3d): Boolean = graphene_frustum_contains_point(grapheneFrustumPointer, point.graphenePoint3dPointer)
    ...
    public fun `init`(
        ...
        p4: Plane,
        p5: Plane,
    ): Frustum = graphene_frustum_init(grapheneFrustumPointer, p0.graphenePlanePointer, p1.graphenePlanePointer, p2.graphenePlanePointer, p3.graphenePlanePointer, p4.graphenePlanePointer, p5.graphenePlanePointer)!!.run {
        Frustum(this)}
     ...
     */
    @GrapheneVersion1_2
    public fun initFromFrustum(src: Frustum): Frustum = graphene_frustum_init_from_frustum(grapheneFrustumPointer, src.grapheneFrustumPointer)!!.run {
        Frustum(this)}
     ...
     */
    @GrapheneVersion1_2
    public fun initFromMatrix(matrix: Matrix): Frustum = graphene_frustum_init_from_matrix(grapheneFrustumPointer, matrix.grapheneMatrixPointer)!!.run {
        Frustum(this)}
     ...
     */
    @GrapheneVersion1_2
    public fun intersectsBox(box: Box): Boolean = graphene_frustum_intersects_box(grapheneFrustumPointer, box.grapheneBoxPointer)
     ...
     */
    @GrapheneVersion1_2
    public fun intersectsSphere(sphere: Sphere): Boolean = graphene_frustum_intersects_sphere(grapheneFrustumPointer, sphere.grapheneSpherePointer)
