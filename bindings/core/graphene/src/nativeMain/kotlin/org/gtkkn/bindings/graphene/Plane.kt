 ...
 */
@GrapheneVersion1_2
public class Plane(public val graphenePlanePointer: CPointer<graphene_plane_t>, cleaner: Cleaner? = null) :
    ...
    ) : this(graphenePlanePointer = pair.first, cleaner = pair.second)
