...
public open class TlsPassword(
     ...
     */
    public constructor(flags: TlsPasswordFlags, description: String) : this(g_tls_password_new(flags.mask, description)!!) {
        InstanceCache.put(this)
    }

    public companion object : TypeCompanion<TlsPassword> {
        override val type: GeneratedClassKGType<TlsPassword> =
                GeneratedClassKGType(getTypeOrNull()!!) { TlsPassword(it.reinterpret()) }
        ...
        /**
         * Gets the GType of from the symbol `g_tls_password_get_type` if it exists.
         *
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("g_tls_password_get_type")
    }
}
