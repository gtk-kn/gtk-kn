...
public class DBusMethodInfo(
     ...
     */
    public constructor() : this(nativeHeap.alloc<GDBusMethodInfo>().run {
     ...
     */
    private constructor(pair: Pair<CPointer<GDBusMethodInfo>, Cleaner>) : this(pointer = pair.first, cleaner = pair.second)
