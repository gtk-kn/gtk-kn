...
public open class DBusConnection(
     ...
     */
    @GioVersion2_26
    public open fun addFilter(filterFunction: DBusMessageFilterFunction): guint = g_dbus_connection_add_filter(gioDBusConnectionPointer.reinterpret(), DBusMessageFilterFunctionFunc.reinterpret(), StableRef.create(filterFunction).asCPointer(), staticStableRefDestroy.reinterpret())
    ...
    ): Unit = g_dbus_connection_call(gioDBusConnectionPointer.reinterpret(), busName, objectPath, interfaceName, methodName, parameters?.glibVariantPointer?.reinterpret(), replyType?.glibVariantTypePointer?.reinterpret(), flags.mask, timeoutMsec, cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public open fun callWithUnixFdList(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = g_dbus_connection_call_with_unix_fd_list(gioDBusConnectionPointer.reinterpret(), busName, objectPath, interfaceName, methodName, parameters?.glibVariantPointer?.reinterpret(), replyType?.glibVariantTypePointer?.reinterpret(), flags.mask, timeoutMsec, fdList?.gioUnixFDListPointer?.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
     ...
     */
    @GioVersion2_26
    public open fun close(cancellable: Cancellable? = null, callback: AsyncReadyCallback?): Unit = g_dbus_connection_close(gioDBusConnectionPointer.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
     ...
     */
    @GioVersion2_26
    public open fun flush(cancellable: Cancellable? = null, callback: AsyncReadyCallback?): Unit = g_dbus_connection_flush(gioDBusConnectionPointer.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
     ...
     */
    @GioVersion2_34
    public open fun getLastSerial(): guint = g_dbus_connection_get_last_serial(gioDBusConnectionPointer.reinterpret())
     ...
     */
    @GioVersion2_26
    public open fun removeFilter(filterId: guint): Unit = g_dbus_connection_remove_filter(gioDBusConnectionPointer.reinterpret(), filterId)
    ...
    ): guint = g_dbus_connection_signal_subscribe(gioDBusConnectionPointer.reinterpret(), sender, interfaceName, member, objectPath, arg0, flags.mask, DBusSignalCallbackFunc.reinterpret(), StableRef.create(callback).asCPointer(), staticStableRefDestroy.reinterpret())
     ...
     */
    @GioVersion2_26
    public open fun signalUnsubscribe(subscriptionId: guint): Unit = g_dbus_connection_signal_unsubscribe(gioDBusConnectionPointer.reinterpret(), subscriptionId)
     ...
     */
    @GioVersion2_32
    public open fun unexportActionGroup(exportId: guint): Unit = g_dbus_connection_unexport_action_group(gioDBusConnectionPointer.reinterpret(), exportId)
     ...
     */
    @GioVersion2_32
    public open fun unexportMenuModel(exportId: guint): Unit = g_dbus_connection_unexport_menu_model(gioDBusConnectionPointer.reinterpret(), exportId)
     ...
     */
    @GioVersion2_26
    public open fun unregisterObject(registrationId: guint): Boolean = g_dbus_connection_unregister_object(gioDBusConnectionPointer.reinterpret(), registrationId).asBoolean()
     ...
     */
    @GioVersion2_26
    public open fun unregisterSubtree(registrationId: guint): Boolean = g_dbus_connection_unregister_subtree(gioDBusConnectionPointer.reinterpret(), registrationId).asBoolean()
    ...
    public companion object : TypeCompanion<DBusConnection> {
        ...
        public fun new(
            ...
            cancellable: Cancellable? = null,
            callback: AsyncReadyCallback?,
        ): Unit = g_dbus_connection_new(stream.gioIOStreamPointer.reinterpret(), guid, flags.mask, observer?.gioDBusAuthObserverPointer?.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
        ...
        public fun newForAddress(
            ...
            cancellable: Cancellable? = null,
            callback: AsyncReadyCallback?,
        ): Unit = g_dbus_connection_new_for_address(address, flags.mask, observer?.gioDBusAuthObserverPointer?.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
