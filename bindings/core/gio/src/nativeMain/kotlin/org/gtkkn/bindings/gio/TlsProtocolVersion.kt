...
import org.gtkkn.native.gio.GTlsProtocolVersion.G_TLS_PROTOCOL_VERSION_SSL_3_0
import org.gtkkn.native.gio.GTlsProtocolVersion.G_TLS_PROTOCOL_VERSION_TLS_1_0
import org.gtkkn.native.gio.GTlsProtocolVersion.G_TLS_PROTOCOL_VERSION_TLS_1_1
import org.gtkkn.native.gio.GTlsProtocolVersion.G_TLS_PROTOCOL_VERSION_TLS_1_2
import org.gtkkn.native.gio.GTlsProtocolVersion.G_TLS_PROTOCOL_VERSION_TLS_1_3
import org.gtkkn.native.gio.GTlsProtocolVersion.G_TLS_PROTOCOL_VERSION_UNKNOWN
...
public enum class TlsProtocolVersion(
    ...
    public companion object {
        public fun fromNativeValue(nativeValue: GTlsProtocolVersion): TlsProtocolVersion =
            when (nativeValue) {
                G_TLS_PROTOCOL_VERSION_UNKNOWN -> UNKNOWN
                G_TLS_PROTOCOL_VERSION_SSL_3_0 -> SSL_3_0
                G_TLS_PROTOCOL_VERSION_TLS_1_0 -> TLS_1_0
                G_TLS_PROTOCOL_VERSION_TLS_1_1 -> TLS_1_1
                G_TLS_PROTOCOL_VERSION_TLS_1_2 -> TLS_1_2
                G_TLS_PROTOCOL_VERSION_TLS_1_3 -> TLS_1_3
                G_TLS_PROTOCOL_VERSION_DTLS_1_0 -> DTLS_1_0
                G_TLS_PROTOCOL_VERSION_DTLS_1_2 -> DTLS_1_2
