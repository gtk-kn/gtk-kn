...
public open class SocketClient(
    ...
    public open var enableProxy: Boolean
         ...
         * @since 2.26
         */
        get() = g_socket_client_get_enable_proxy(gioSocketClientPointer).asBoolean()
        /**
         ...
         */
        @GioVersion2_26
        set(enable) = g_socket_client_set_enable_proxy(gioSocketClientPointer, enable.asGBoolean())
    ...
    public open var family: SocketFamily
         ...
         * @since 2.22
         */
        get() = g_socket_client_get_family(gioSocketClientPointer).run {
         ...
         */
        @GioVersion2_22
        set(family) = g_socket_client_set_family(gioSocketClientPointer, family.nativeValue)
    ...
    public open var localAddress: SocketAddress?
         ...
         */
        @GioVersion2_22
        set(address) = g_socket_client_set_local_address(gioSocketClientPointer, address?.gioSocketAddressPointer)
    ...
    public open var protocol: SocketProtocol
         ...
         * @since 2.22
         */
        get() = g_socket_client_get_protocol(gioSocketClientPointer).run {
         ...
         */
        @GioVersion2_22
        set(protocol) = g_socket_client_set_protocol(gioSocketClientPointer, protocol.nativeValue)
    ...
    public open var timeout: guint
         ...
         * @since 2.26
         */
        get() = g_socket_client_get_timeout(gioSocketClientPointer)
        /**
         ...
         */
        @GioVersion2_26
        set(timeout) = g_socket_client_set_timeout(gioSocketClientPointer, timeout)
    ...
    public open var tls: Boolean
         ...
         * @since 2.28
         */
        get() = g_socket_client_get_tls(gioSocketClientPointer).asBoolean()
        /**
    ...
    public open var tlsValidationFlags: TlsCertificateFlags
         ...
         * @since 2.28
         */
        get() = g_socket_client_get_tls_validation_flags(gioSocketClientPointer).run {
         ...
         */
        @GioVersion2_28
        set(flags) = g_socket_client_set_tls_validation_flags(gioSocketClientPointer, flags.mask)
     ...
     */
    public open fun addApplicationProxy(protocol: String): Unit = g_socket_client_add_application_proxy(gioSocketClientPointer, protocol)
    ...
    public open fun connect(connectable: SocketConnectable, cancellable: Cancellable? = null): Result<SocketConnection> = memScoped {
        ...
        val gResult = g_socket_client_connect(gioSocketClientPointer, connectable.gioSocketConnectablePointer, cancellable?.gioCancellablePointer, gError.ptr)?.run {
            InstanceCache.get(this, true) { SocketConnection(reinterpret()) }!!.also { ref() }
        }
    ...
    ): Unit = g_socket_client_connect_async(gioSocketClientPointer, connectable.gioSocketConnectablePointer, cancellable?.gioCancellablePointer, callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public open fun connectToHostAsync(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = g_socket_client_connect_to_host_async(gioSocketClientPointer, hostAndPort, defaultPort, cancellable?.gioCancellablePointer, callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public open fun connectToServiceAsync(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = g_socket_client_connect_to_service_async(gioSocketClientPointer, domain, service, cancellable?.gioCancellablePointer, callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public open fun connectToUriAsync(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = g_socket_client_connect_to_uri_async(gioSocketClientPointer, uri, defaultPort, cancellable?.gioCancellablePointer, callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
     ...
     */
    @GioVersion2_36
    public open fun getProxyResolver(): ProxyResolver = g_socket_client_get_proxy_resolver(gioSocketClientPointer)!!.run {
     ...
     */
    @GioVersion2_22
    public open fun getSocketType(): SocketType = g_socket_client_get_socket_type(gioSocketClientPointer).run {
     ...
     */
    @GioVersion2_36
    public open fun setProxyResolver(proxyResolver: ProxyResolver? = null): Unit = g_socket_client_set_proxy_resolver(gioSocketClientPointer, proxyResolver?.gioProxyResolverPointer)
     ...
     */
    @GioVersion2_22
    public open fun setSocketType(type: SocketType): Unit = g_socket_client_set_socket_type(gioSocketClientPointer, type.nativeValue)
     ...
     */
    @GioVersion2_32
    public fun onEvent(connectFlags: ConnectFlags = ConnectFlags(0u), handler: (
        event: SocketClientEvent,
        connectable: SocketConnectable,
        connection: IoStream?,
    ) -> Unit): ULong = g_signal_connect_data(gioSocketClientPointer, "event", onEventFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
    ...
    public fun emitEvent(
        ...
        g_signal_emit_by_name(gioSocketClientPointer.reinterpret(), "event", event.nativeValue, connectable.gioSocketConnectablePointer, connection?.gioIoStreamPointer)
    }
...
private val onEventFunc: CPointer<CFunction<(
    GSocketClientEvent,
