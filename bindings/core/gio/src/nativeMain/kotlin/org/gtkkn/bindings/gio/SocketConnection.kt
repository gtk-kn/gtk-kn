...
public open class SocketConnection(pointer: CPointer<GSocketConnection>) :
    ...
    public companion object : TypeCompanion<SocketConnection> {
         ...
         */
        @GioVersion2_22
        public fun factoryLookupType(family: SocketFamily, type: SocketType, protocolId: Int): ULong =
         ...
         */
        @GioVersion2_22
        public fun factoryRegisterType(gType: ULong, family: SocketFamily, type: SocketType, protocol: Int): Unit =
