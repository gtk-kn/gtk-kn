 ...
 */
public interface Mount : Proxy, KGTyped {
     ...
     */
    public fun canEject(): Boolean = g_mount_can_eject(gioMountPointer).asBoolean()
    ...
    public fun ejectFinish(result: AsyncResult): Result<Boolean> = memScoped {
        ...
        val gResult = g_mount_eject_finish(gioMountPointer, result.gioAsyncResultPointer, gError.ptr).asBoolean()
    ...
    public fun ejectWithOperation(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = g_mount_eject_with_operation(gioMountPointer, flags.mask, mountOperation?.gioMountOperationPointer, cancellable?.gioCancellablePointer, callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public fun ejectWithOperationFinish(result: AsyncResult): Result<Boolean> = memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = g_mount_eject_with_operation_finish(gioMountPointer, result.gioAsyncResultPointer, gError.ptr).asBoolean()
        return if (gError.pointed != null) {
            Result.failure(resolveException(Error(gError.pointed!!.ptr)))
        } else {
            Result.success(gResult)
     ...
     */
    public fun getName(): String = g_mount_get_name(gioMountPointer)?.toKString() ?: error("Expected not null string")
     ...
     */
    @GioVersion2_32
    public fun getSortKey(): String? = g_mount_get_sort_key(gioMountPointer)?.toKString()
     ...
     *     when no longer needed.
     */
    public fun getUuid(): String? = g_mount_get_uuid(gioMountPointer)?.toKString()
    ...
    public fun guessContentType(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = g_mount_guess_content_type(gioMountPointer, forceRescan.asGBoolean(), cancellable?.gioCancellablePointer, callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public fun guessContentTypeFinish(result: AsyncResult): Result<List<String>> = memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = g_mount_guess_content_type_finish(gioMountPointer, result.gioAsyncResultPointer, gError.ptr)?.toKStringList()
        return if (gError.pointed != null) {
            Result.failure(resolveException(Error(gError.pointed!!.ptr)))
        } else {
    ...
    public fun guessContentTypeSync(forceRescan: Boolean, cancellable: Cancellable? = null): Result<List<String>> = memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = g_mount_guess_content_type_sync(gioMountPointer, forceRescan.asGBoolean(), cancellable?.gioCancellablePointer, gError.ptr)?.toKStringList()
        return if (gError.pointed != null) {
            Result.failure(resolveException(Error(gError.pointed!!.ptr)))
        } else {
            Result.success(checkNotNull(gResult))
     ...
     */
    @GioVersion2_20
    public fun isShadowed(): Boolean = g_mount_is_shadowed(gioMountPointer).asBoolean()
    ...
    public fun remount(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = g_mount_remount(gioMountPointer, flags.mask, mountOperation?.gioMountOperationPointer, cancellable?.gioCancellablePointer, callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public fun remountFinish(result: AsyncResult): Result<Boolean> = memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = g_mount_remount_finish(gioMountPointer, result.gioAsyncResultPointer, gError.ptr).asBoolean()
        return if (gError.pointed != null) {
            Result.failure(resolveException(Error(gError.pointed!!.ptr)))
        } else {
            Result.success(gResult)
    ...
    public fun unmountFinish(result: AsyncResult): Result<Boolean> = memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = g_mount_unmount_finish(gioMountPointer, result.gioAsyncResultPointer, gError.ptr).asBoolean()
        return if (gError.pointed != null) {
            Result.failure(resolveException(Error(gError.pointed!!.ptr)))
        } else {
            Result.success(gResult)
    ...
    public fun unmountWithOperation(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = g_mount_unmount_with_operation(gioMountPointer, flags.mask, mountOperation?.gioMountOperationPointer, cancellable?.gioCancellablePointer, callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public fun unmountWithOperationFinish(result: AsyncResult): Result<Boolean> = memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = g_mount_unmount_with_operation_finish(gioMountPointer, result.gioAsyncResultPointer, gError.ptr).asBoolean()
        return if (gError.pointed != null) {
            Result.failure(resolveException(Error(gError.pointed!!.ptr)))
        } else {
            Result.success(gResult)
     ...
     */
    @GioVersion2_20
    public fun unshadow(): Unit = g_mount_unshadow(gioMountPointer)
     ...
     */
    public fun onChanged(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong = g_signal_connect_data(gioMountPointer, "changed", onChangedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     */
    @GioVersion2_22
    public fun onPreUnmount(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong = g_signal_connect_data(gioMountPointer, "pre-unmount", onPreUnmountFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
     ...
     * @param handler the Callback to connect
     */
    public fun onUnmounted(connectFlags: ConnectFlags = ConnectFlags(0u), handler: () -> Unit): ULong = g_signal_connect_data(gioMountPointer, "unmounted", onUnmountedFunc.reinterpret(), StableRef.create(handler).asCPointer(), staticStableRefDestroy.reinterpret(), connectFlags.mask)
...
private val onPreUnmountFunc: CPointer<CFunction<() -> Unit>> = staticCFunction {
    _: COpaquePointer,
    userData: COpaquePointer
    ->
    userData.asStableRef<() -> Unit>().get().invoke()}
...
private val onUnmountedFunc: CPointer<CFunction<() -> Unit>> = staticCFunction {
    _: COpaquePointer,
    userData: COpaquePointer
    ->
    userData.asStableRef<() -> Unit>().get().invoke()}
