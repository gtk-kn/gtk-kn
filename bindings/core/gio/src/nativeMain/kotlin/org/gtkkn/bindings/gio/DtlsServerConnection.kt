...
public interface DtlsServerConnection : Proxy, DatagramBased, DtlsConnection, KGTyped {
     ...
     */
    public class DtlsServerConnectionImpl(
        gioDtlsServerConnectionPointer: CPointer<GDtlsServerConnection>,
    ...
    public companion object : TypeCompanion<DtlsServerConnection> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("g_dtls_server_connection_get_type")
    }
}
