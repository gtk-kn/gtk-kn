...
public open class Menu(pointer: CPointer<GMenu>) :
     ...
     */
    @GioVersion2_32
    public open fun insert(position: Int, label: String? = null, detailedAction: String? = null): Unit =
     ...
     */
    @GioVersion2_32
    public open fun insertItem(position: Int, item: MenuItem): Unit =
     ...
     */
    @GioVersion2_32
    public open fun insertSection(position: Int, label: String? = null, section: MenuModel): Unit =
     ...
     */
    @GioVersion2_32
    public open fun insertSubmenu(position: Int, label: String? = null, submenu: MenuModel): Unit =
