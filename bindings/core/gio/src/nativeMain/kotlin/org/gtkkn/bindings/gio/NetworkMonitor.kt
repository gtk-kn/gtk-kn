...
public interface NetworkMonitor :
     ...
     */
    public class NetworkMonitorImpl(gioNetworkMonitorPointer: CPointer<GNetworkMonitor>) :
    ...
    public companion object : TypeCompanion<NetworkMonitor> {
        ...
        internal fun getTypeOrNull(): GType? =
            org.gtkkn.extensions.glib.cinterop.getTypeOrNull("g_network_monitor_get_type")
    }
}
