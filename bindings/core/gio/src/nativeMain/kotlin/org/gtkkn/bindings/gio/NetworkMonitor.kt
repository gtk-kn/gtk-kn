...
public interface NetworkMonitor : Interface, Initable, KGTyped {
    ...
    ): Unit = g_network_monitor_can_reach_async(gioNetworkMonitorPointer.reinterpret(), connectable.gioSocketConnectablePointer, cancellable?.gioCancellablePointer?.reinterpret(), AsyncReadyCallbackFunc.reinterpret(), StableRef.create(callback).asCPointer())
