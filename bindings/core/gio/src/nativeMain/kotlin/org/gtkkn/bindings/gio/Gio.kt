...
public object Gio {
    ...
    public fun dbusGvariantToGvalue(`value`: Variant, outGvalue: Value): Unit =
        g_dbus_gvariant_to_gvalue(`value`.glibVariantPointer, outGvalue.gobjectValuePointer)
    ...
    public fun ioModulesLoadAllInDirectoryWithScope(dirname: String, scope: IoModuleScope): GlibList =
        g_io_modules_load_all_in_directory_with_scope(dirname, scope.gioIoModuleScopePointer)!!.run {
            GlibList(this)
        }
    ...
    public fun ioModulesScanAllInDirectoryWithScope(dirname: String, scope: IoModuleScope): Unit =
        g_io_modules_scan_all_in_directory_with_scope(dirname, scope.gioIoModuleScopePointer)
    ...
    public fun pollableSourceNew(pollableStream: Object): Source =
        g_pollable_source_new(pollableStream.gobjectObjectPointer)!!.run {
            Source(this)
        }
    ...
    public fun pollableSourceNewFull(
        ...
        pollableStream.gobjectObjectPointer.reinterpret(),
    ...
    public fun unixMountCompare(mount1: UnixMountEntry, mount2: UnixMountEntry): gint =
        g_unix_mount_compare(mount1.gioUnixMountEntryPointer, mount2.gioUnixMountEntryPointer)
    ...
    private fun registerTypes() {
        AppInfoMonitor.getTypeOrNull()?.let { gtype ->
            TypeCache.register(AppInfoMonitor::class, gtype) { AppInfoMonitor(it.reinterpret()) }
        }
        ...
        ApplicationCommandLine.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ApplicationCommandLine::class, gtype) { ApplicationCommandLine(it.reinterpret()) }
        }
        BufferedInputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(BufferedInputStream::class, gtype) { BufferedInputStream(it.reinterpret()) }
        }
        BufferedOutputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(BufferedOutputStream::class, gtype) { BufferedOutputStream(it.reinterpret()) }
        }
        BytesIcon.getTypeOrNull()?.let { gtype ->
            TypeCache.register(BytesIcon::class, gtype) { BytesIcon(it.reinterpret()) }
        }
        Cancellable.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Cancellable::class, gtype) { Cancellable(it.reinterpret()) }
        }
        CharsetConverter.getTypeOrNull()?.let { gtype ->
            TypeCache.register(CharsetConverter::class, gtype) { CharsetConverter(it.reinterpret()) }
        }
        ConverterInputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ConverterInputStream::class, gtype) { ConverterInputStream(it.reinterpret()) }
        }
        ConverterOutputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ConverterOutputStream::class, gtype) { ConverterOutputStream(it.reinterpret()) }
        }
        Credentials.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Credentials::class, gtype) { Credentials(it.reinterpret()) }
        }
        DBusActionGroup.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusActionGroup::class, gtype) { DBusActionGroup(it.reinterpret()) }
        }
        DBusAuthObserver.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusAuthObserver::class, gtype) { DBusAuthObserver(it.reinterpret()) }
        }
        DBusConnection.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusConnection::class, gtype) { DBusConnection(it.reinterpret()) }
        }
        DBusInterfaceSkeleton.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusInterfaceSkeleton::class, gtype) {
                DBusInterfaceSkeleton.DBusInterfaceSkeletonImpl(it.reinterpret())
            }
        }
        DBusMenuModel.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusMenuModel::class, gtype) { DBusMenuModel(it.reinterpret()) }
        }
        DBusMessage.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusMessage::class, gtype) { DBusMessage(it.reinterpret()) }
        }
        DBusMethodInvocation.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusMethodInvocation::class, gtype) { DBusMethodInvocation(it.reinterpret()) }
        }
        DBusObjectManagerClient.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusObjectManagerClient::class, gtype) { DBusObjectManagerClient(it.reinterpret()) }
        }
        DBusObjectManagerServer.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusObjectManagerServer::class, gtype) { DBusObjectManagerServer(it.reinterpret()) }
        }
        DBusObjectProxy.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusObjectProxy::class, gtype) { DBusObjectProxy(it.reinterpret()) }
        }
        DBusObjectSkeleton.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusObjectSkeleton::class, gtype) { DBusObjectSkeleton(it.reinterpret()) }
        }
        DBusProxy.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusProxy::class, gtype) { DBusProxy(it.reinterpret()) }
        }
        DBusServer.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusServer::class, gtype) { DBusServer(it.reinterpret()) }
        }
        DataInputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DataInputStream::class, gtype) { DataInputStream(it.reinterpret()) }
        }
        DataOutputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DataOutputStream::class, gtype) { DataOutputStream(it.reinterpret()) }
        }
        ...
        FileEnumerator.getTypeOrNull()?.let { gtype ->
            TypeCache.register(FileEnumerator::class, gtype) { FileEnumerator(it.reinterpret()) }
        }
        FileIoStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(FileIoStream::class, gtype) { FileIoStream(it.reinterpret()) }
        }
        FileIcon.getTypeOrNull()?.let { gtype ->
            TypeCache.register(FileIcon::class, gtype) { FileIcon(it.reinterpret()) }
        }
        FileInfo.getTypeOrNull()?.let { gtype ->
            TypeCache.register(FileInfo::class, gtype) { FileInfo(it.reinterpret()) }
        }
        FileInputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(FileInputStream::class, gtype) { FileInputStream(it.reinterpret()) }
        }
        FileMonitor.getTypeOrNull()?.let { gtype ->
            TypeCache.register(FileMonitor::class, gtype) { FileMonitor.FileMonitorImpl(it.reinterpret()) }
        }
        FileOutputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(FileOutputStream::class, gtype) { FileOutputStream(it.reinterpret()) }
        }
        FilenameCompleter.getTypeOrNull()?.let { gtype ->
            TypeCache.register(FilenameCompleter::class, gtype) { FilenameCompleter(it.reinterpret()) }
        }
        FilterInputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(FilterInputStream::class, gtype) {
                FilterInputStream.FilterInputStreamImpl(it.reinterpret())
            }
        }
        FilterOutputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(FilterOutputStream::class, gtype) {
                FilterOutputStream.FilterOutputStreamImpl(it.reinterpret())
            }
        }
        IoModule.getTypeOrNull()?.let { gtype ->
            TypeCache.register(IoModule::class, gtype) { IoModule(it.reinterpret()) }
        }
        IoStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(IoStream::class, gtype) { IoStream.IoStreamImpl(it.reinterpret()) }
        }
        InetAddress.getTypeOrNull()?.let { gtype ->
            TypeCache.register(InetAddress::class, gtype) { InetAddress(it.reinterpret()) }
        }
        InetAddressMask.getTypeOrNull()?.let { gtype ->
            TypeCache.register(InetAddressMask::class, gtype) { InetAddressMask(it.reinterpret()) }
        }
        InetSocketAddress.getTypeOrNull()?.let { gtype ->
            TypeCache.register(InetSocketAddress::class, gtype) { InetSocketAddress(it.reinterpret()) }
        }
        InputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(InputStream::class, gtype) { InputStream.InputStreamImpl(it.reinterpret()) }
        }
        ListStore.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ListStore::class, gtype) { ListStore(it.reinterpret()) }
        }
        MemoryInputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(MemoryInputStream::class, gtype) { MemoryInputStream(it.reinterpret()) }
        }
        MemoryOutputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(MemoryOutputStream::class, gtype) { MemoryOutputStream(it.reinterpret()) }
        }
        Menu.getTypeOrNull()?.let { gtype -> TypeCache.register(Menu::class, gtype) { Menu(it.reinterpret()) } }
        MenuAttributeIter.getTypeOrNull()?.let { gtype ->
            TypeCache.register(MenuAttributeIter::class, gtype) {
                MenuAttributeIter.MenuAttributeIterImpl(it.reinterpret())
            }
        }
        MenuItem.getTypeOrNull()?.let { gtype ->
            TypeCache.register(MenuItem::class, gtype) { MenuItem(it.reinterpret()) }
        }
        MenuLinkIter.getTypeOrNull()?.let { gtype ->
            TypeCache.register(MenuLinkIter::class, gtype) { MenuLinkIter.MenuLinkIterImpl(it.reinterpret()) }
        }
        MenuModel.getTypeOrNull()?.let { gtype ->
            TypeCache.register(MenuModel::class, gtype) { MenuModel.MenuModelImpl(it.reinterpret()) }
        }
        MountOperation.getTypeOrNull()?.let { gtype ->
            TypeCache.register(MountOperation::class, gtype) { MountOperation(it.reinterpret()) }
        }
        NativeSocketAddress.getTypeOrNull()?.let { gtype ->
            TypeCache.register(NativeSocketAddress::class, gtype) { NativeSocketAddress(it.reinterpret()) }
        }
        NativeVolumeMonitor.getTypeOrNull()?.let { gtype ->
            TypeCache.register(NativeVolumeMonitor::class, gtype) {
                NativeVolumeMonitor.NativeVolumeMonitorImpl(it.reinterpret())
            }
        }
        NetworkAddress.getTypeOrNull()?.let { gtype ->
            TypeCache.register(NetworkAddress::class, gtype) { NetworkAddress(it.reinterpret()) }
        }
        NetworkService.getTypeOrNull()?.let { gtype ->
            TypeCache.register(NetworkService::class, gtype) { NetworkService(it.reinterpret()) }
        }
        ...
        Permission.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Permission::class, gtype) { Permission.PermissionImpl(it.reinterpret()) }
        }
        PropertyAction.getTypeOrNull()?.let { gtype ->
            TypeCache.register(PropertyAction::class, gtype) { PropertyAction(it.reinterpret()) }
        }
        ProxyAddress.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ProxyAddress::class, gtype) { ProxyAddress(it.reinterpret()) }
        }
        ProxyAddressEnumerator.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ProxyAddressEnumerator::class, gtype) { ProxyAddressEnumerator(it.reinterpret()) }
        }
        Resolver.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Resolver::class, gtype) { Resolver.ResolverImpl(it.reinterpret()) }
        }
        Settings.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Settings::class, gtype) { Settings(it.reinterpret()) }
        }
        SettingsBackend.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SettingsBackend::class, gtype) { SettingsBackend.SettingsBackendImpl(it.reinterpret()) }
        }
        SimpleAction.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SimpleAction::class, gtype) { SimpleAction(it.reinterpret()) }
        }
        SimpleActionGroup.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SimpleActionGroup::class, gtype) { SimpleActionGroup(it.reinterpret()) }
        }
        SimpleAsyncResult.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SimpleAsyncResult::class, gtype) { SimpleAsyncResult(it.reinterpret()) }
        }
        SimpleIoStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SimpleIoStream::class, gtype) { SimpleIoStream(it.reinterpret()) }
        }
        SimplePermission.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SimplePermission::class, gtype) { SimplePermission(it.reinterpret()) }
        }
        SimpleProxyResolver.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SimpleProxyResolver::class, gtype) { SimpleProxyResolver(it.reinterpret()) }
        }
        Socket.getTypeOrNull()?.let { gtype -> TypeCache.register(Socket::class, gtype) { Socket(it.reinterpret()) } }
        SocketAddress.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SocketAddress::class, gtype) { SocketAddress.SocketAddressImpl(it.reinterpret()) }
        }
        SocketAddressEnumerator.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SocketAddressEnumerator::class, gtype) {
                SocketAddressEnumerator.SocketAddressEnumeratorImpl(it.reinterpret())
            }
        }
        SocketClient.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SocketClient::class, gtype) { SocketClient(it.reinterpret()) }
        }
        SocketConnection.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SocketConnection::class, gtype) { SocketConnection(it.reinterpret()) }
        }
        SocketControlMessage.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SocketControlMessage::class, gtype) {
                SocketControlMessage.SocketControlMessageImpl(it.reinterpret())
            }
        }
        SocketListener.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SocketListener::class, gtype) { SocketListener(it.reinterpret()) }
        }
        SocketService.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SocketService::class, gtype) { SocketService(it.reinterpret()) }
        }
        Subprocess.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Subprocess::class, gtype) { Subprocess(it.reinterpret()) }
        }
        SubprocessLauncher.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SubprocessLauncher::class, gtype) { SubprocessLauncher(it.reinterpret()) }
        }
        Task.getTypeOrNull()?.let { gtype -> TypeCache.register(Task::class, gtype) { Task(it.reinterpret()) } }
        TcpConnection.getTypeOrNull()?.let { gtype ->
            TypeCache.register(TcpConnection::class, gtype) { TcpConnection(it.reinterpret()) }
        }
        TcpWrapperConnection.getTypeOrNull()?.let { gtype ->
            TypeCache.register(TcpWrapperConnection::class, gtype) { TcpWrapperConnection(it.reinterpret()) }
        }
        TestDBus.getTypeOrNull()?.let { gtype ->
            TypeCache.register(TestDBus::class, gtype) { TestDBus(it.reinterpret()) }
        }
        ThemedIcon.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ThemedIcon::class, gtype) { ThemedIcon(it.reinterpret()) }
        }
        ThreadedSocketService.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ThreadedSocketService::class, gtype) { ThreadedSocketService(it.reinterpret()) }
        }
        TlsCertificate.getTypeOrNull()?.let { gtype ->
            TypeCache.register(TlsCertificate::class, gtype) { TlsCertificate.TlsCertificateImpl(it.reinterpret()) }
        }
        TlsConnection.getTypeOrNull()?.let { gtype ->
            TypeCache.register(TlsConnection::class, gtype) { TlsConnection.TlsConnectionImpl(it.reinterpret()) }
        }
        TlsDatabase.getTypeOrNull()?.let { gtype ->
            TypeCache.register(TlsDatabase::class, gtype) { TlsDatabase.TlsDatabaseImpl(it.reinterpret()) }
        }
        TlsInteraction.getTypeOrNull()?.let { gtype ->
            TypeCache.register(TlsInteraction::class, gtype) { TlsInteraction(it.reinterpret()) }
        }
        TlsPassword.getTypeOrNull()?.let { gtype ->
            TypeCache.register(TlsPassword::class, gtype) { TlsPassword(it.reinterpret()) }
        }
        UnixConnection.getTypeOrNull()?.let { gtype ->
            TypeCache.register(UnixConnection::class, gtype) { UnixConnection(it.reinterpret()) }
        }
        UnixCredentialsMessage.getTypeOrNull()?.let { gtype ->
            TypeCache.register(UnixCredentialsMessage::class, gtype) { UnixCredentialsMessage(it.reinterpret()) }
        }
        UnixFdList.getTypeOrNull()?.let { gtype ->
            TypeCache.register(UnixFdList::class, gtype) { UnixFdList(it.reinterpret()) }
        }
        UnixFdMessage.getTypeOrNull()?.let { gtype ->
            TypeCache.register(UnixFdMessage::class, gtype) { UnixFdMessage(it.reinterpret()) }
        }
        UnixInputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(UnixInputStream::class, gtype) { UnixInputStream(it.reinterpret()) }
        }
        UnixMountMonitor.getTypeOrNull()?.let { gtype ->
            TypeCache.register(UnixMountMonitor::class, gtype) { UnixMountMonitor(it.reinterpret()) }
        }
        UnixOutputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(UnixOutputStream::class, gtype) { UnixOutputStream(it.reinterpret()) }
        }
        UnixSocketAddress.getTypeOrNull()?.let { gtype ->
            TypeCache.register(UnixSocketAddress::class, gtype) { UnixSocketAddress(it.reinterpret()) }
        }
        Vfs.getTypeOrNull()?.let { gtype -> TypeCache.register(Vfs::class, gtype) { Vfs(it.reinterpret()) } }
        VolumeMonitor.getTypeOrNull()?.let { gtype ->
            TypeCache.register(VolumeMonitor::class, gtype) { VolumeMonitor(it.reinterpret()) }
        }
        ZlibCompressor.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ZlibCompressor::class, gtype) { ZlibCompressor(it.reinterpret()) }
        }
        ZlibDecompressor.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ZlibDecompressor::class, gtype) { ZlibDecompressor(it.reinterpret()) }
        }
        Action.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Action::class, gtype) { Action.ActionImpl(it.reinterpret()) }
        }
        ActionGroup.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ActionGroup::class, gtype) { ActionGroup.ActionGroupImpl(it.reinterpret()) }
        }
        ActionMap.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ActionMap::class, gtype) { ActionMap.ActionMapImpl(it.reinterpret()) }
        }
        AppInfo.getTypeOrNull()?.let { gtype ->
            TypeCache.register(AppInfo::class, gtype) { AppInfo.AppInfoImpl(it.reinterpret()) }
        }
        AsyncInitable.getTypeOrNull()?.let { gtype ->
            TypeCache.register(AsyncInitable::class, gtype) { AsyncInitable.AsyncInitableImpl(it.reinterpret()) }
        }
        AsyncResult.getTypeOrNull()?.let { gtype ->
            TypeCache.register(AsyncResult::class, gtype) { AsyncResult.AsyncResultImpl(it.reinterpret()) }
        }
        Converter.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Converter::class, gtype) { Converter.ConverterImpl(it.reinterpret()) }
        }
        DBusInterface.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusInterface::class, gtype) { DBusInterface.DBusInterfaceImpl(it.reinterpret()) }
        }
        DBusObject.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusObject::class, gtype) { DBusObject.DBusObjectImpl(it.reinterpret()) }
        }
        DBusObjectManager.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DBusObjectManager::class, gtype) {
                DBusObjectManager.DBusObjectManagerImpl(it.reinterpret())
            }
        }
        DatagramBased.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DatagramBased::class, gtype) { DatagramBased.DatagramBasedImpl(it.reinterpret()) }
        }
        ...
        DtlsClientConnection.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DtlsClientConnection::class, gtype) {
                DtlsClientConnection.DtlsClientConnectionImpl(it.reinterpret())
            }
        }
        DtlsConnection.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DtlsConnection::class, gtype) { DtlsConnection.DtlsConnectionImpl(it.reinterpret()) }
        }
        DtlsServerConnection.getTypeOrNull()?.let { gtype ->
            TypeCache.register(DtlsServerConnection::class, gtype) {
                DtlsServerConnection.DtlsServerConnectionImpl(it.reinterpret())
            }
        }
        File.getTypeOrNull()?.let { gtype ->
            TypeCache.register(File::class, gtype) { File.FileImpl(it.reinterpret()) }
        }
        FileDescriptorBased.getTypeOrNull()?.let { gtype ->
            TypeCache.register(FileDescriptorBased::class, gtype) {
                FileDescriptorBased.FileDescriptorBasedImpl(it.reinterpret())
            }
        }
        Icon.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Icon::class, gtype) { Icon.IconImpl(it.reinterpret()) }
        }
        Initable.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Initable::class, gtype) { Initable.InitableImpl(it.reinterpret()) }
        }
        ListModel.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ListModel::class, gtype) { ListModel.ListModelImpl(it.reinterpret()) }
        }
        LoadableIcon.getTypeOrNull()?.let { gtype ->
            TypeCache.register(LoadableIcon::class, gtype) { LoadableIcon.LoadableIconImpl(it.reinterpret()) }
        }
        MemoryMonitor.getTypeOrNull()?.let { gtype ->
            TypeCache.register(MemoryMonitor::class, gtype) { MemoryMonitor.MemoryMonitorImpl(it.reinterpret()) }
        }
        Mount.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Mount::class, gtype) { Mount.MountImpl(it.reinterpret()) }
        }
        NetworkMonitor.getTypeOrNull()?.let { gtype ->
            TypeCache.register(NetworkMonitor::class, gtype) { NetworkMonitor.NetworkMonitorImpl(it.reinterpret()) }
        }
        PollableInputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(PollableInputStream::class, gtype) {
                PollableInputStream.PollableInputStreamImpl(it.reinterpret())
            }
        }
        PollableOutputStream.getTypeOrNull()?.let { gtype ->
            TypeCache.register(PollableOutputStream::class, gtype) {
                PollableOutputStream.PollableOutputStreamImpl(it.reinterpret())
            }
        }
        PowerProfileMonitor.getTypeOrNull()?.let { gtype ->
            TypeCache.register(PowerProfileMonitor::class, gtype) {
                PowerProfileMonitor.PowerProfileMonitorImpl(it.reinterpret())
            }
        }
        Proxy.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Proxy::class, gtype) { Proxy.ProxyImpl(it.reinterpret()) }
        }
        ProxyResolver.getTypeOrNull()?.let { gtype ->
            TypeCache.register(ProxyResolver::class, gtype) { ProxyResolver.ProxyResolverImpl(it.reinterpret()) }
        }
        RemoteActionGroup.getTypeOrNull()?.let { gtype ->
            TypeCache.register(RemoteActionGroup::class, gtype) {
                RemoteActionGroup.RemoteActionGroupImpl(it.reinterpret())
            }
        }
        Seekable.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Seekable::class, gtype) { Seekable.SeekableImpl(it.reinterpret()) }
        }
        SocketConnectable.getTypeOrNull()?.let { gtype ->
            TypeCache.register(SocketConnectable::class, gtype) {
                SocketConnectable.SocketConnectableImpl(it.reinterpret())
            }
        }
        TlsBackend.getTypeOrNull()?.let { gtype ->
            TypeCache.register(TlsBackend::class, gtype) { TlsBackend.TlsBackendImpl(it.reinterpret()) }
        }
        TlsClientConnection.getTypeOrNull()?.let { gtype ->
            TypeCache.register(TlsClientConnection::class, gtype) {
                TlsClientConnection.TlsClientConnectionImpl(it.reinterpret())
            }
        }
        TlsFileDatabase.getTypeOrNull()?.let { gtype ->
            TypeCache.register(TlsFileDatabase::class, gtype) { TlsFileDatabase.TlsFileDatabaseImpl(it.reinterpret()) }
        }
        TlsServerConnection.getTypeOrNull()?.let { gtype ->
            TypeCache.register(TlsServerConnection::class, gtype) {
                TlsServerConnection.TlsServerConnectionImpl(it.reinterpret())
            }
        }
        Volume.getTypeOrNull()?.let { gtype ->
            TypeCache.register(Volume::class, gtype) { Volume.VolumeImpl(it.reinterpret()) }
        }
    }
}
...
public val DatagramBasedSourceFuncFunc: CPointer<
    ...
    userData.asStableRef<
        ...
        >().get().invoke(
        datagramBased!!.run {
            DatagramBased.DatagramBasedImpl(reinterpret())
        },
        condition.run {
            IoCondition(this)
        },
