...
public open class DBusObjectSkeleton(
    ...
    public constructor(objectPath: String) :
        this(g_dbus_object_skeleton_new(objectPath)!!.reinterpret())
     ...
     * @param handler the Callback to connect. Params: `interface` The #GDBusInterfaceSkeleton that
     * @invocation is for.; `invocation` A #GDBusMethodInvocation.. Returns true if the call is
    ...
    public companion object : TypeCompanion<DBusObjectSkeleton> {
        override val type: GeneratedClassKGType<DBusObjectSkeleton> =
            GeneratedClassKGType(g_dbus_object_skeleton_get_type()) {
...
private val connectAuthorizeMethodFunc: CPointer<
    CFunction<
        (
