...
public open class FilterOutputStream(
     ...
     */
    public open fun setCloseBaseStream(closeBase: Boolean): Unit = g_filter_output_stream_set_close_base_stream(gioFilterOutputStreamPointer.reinterpret(), closeBase.asGBoolean())
