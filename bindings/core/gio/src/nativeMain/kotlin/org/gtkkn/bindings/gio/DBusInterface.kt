...
public interface DBusInterface : Proxy, KGTyped {
     ...
     */
    public class DBusInterfaceImpl(
        gioDBusInterfacePointer: CPointer<GDBusInterface>,
    ...
    public companion object : TypeCompanion<DBusInterface> {
         ...
         */
        internal fun getTypeOrNull(): GType? = org.gtkkn.extensions.glib.cinterop.getTypeOrNull("g_dbus_interface_get_type")
    }
}
