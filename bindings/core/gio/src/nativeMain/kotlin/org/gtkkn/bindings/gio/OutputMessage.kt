...
public class OutputMessage(
     ...
     */
    public constructor() : this(nativeHeap.alloc<GOutputMessage>().run {
     ...
     */
    private constructor(pair: Pair<CPointer<GOutputMessage>, Cleaner>) : this(pointer = pair.first, cleaner = pair.second)
