...
public class SettingsSchemaSource(
    public val gioSettingsSchemaSourcePointer: CPointer<GSettingsSchemaSource>,
    ...
    public constructor(
        ...
        gError.`value` = null
        val gResult = g_settings_schema_source_new_from_directory(directory, parent?.gioSettingsSchemaSourcePointer, trusted.asGBoolean(), gError.ptr)
     ...
     */
    @GioVersion2_32
    public fun lookup(schemaId: String, recursive: Boolean): SettingsSchema? = g_settings_schema_source_lookup(gioSettingsSchemaSourcePointer, schemaId, recursive.asGBoolean())?.run {
        SettingsSchema(this)}
