...
public class FileAttributeMatcher(
    public val gioFileAttributeMatcherPointer: CPointer<GFileAttributeMatcher>,
     ...
     */
    public fun enumerateNamespace(ns: String): Boolean = g_file_attribute_matcher_enumerate_namespace(gioFileAttributeMatcherPointer, ns).asBoolean()
     ...
     */
    public fun enumerateNext(): String? = g_file_attribute_matcher_enumerate_next(gioFileAttributeMatcherPointer)?.toKString()
     ...
     */
    public fun matches(attribute: String): Boolean = g_file_attribute_matcher_matches(gioFileAttributeMatcherPointer, attribute).asBoolean()
     ...
     */
    public fun matchesOnly(attribute: String): Boolean = g_file_attribute_matcher_matches_only(gioFileAttributeMatcherPointer, attribute).asBoolean()
     ...
     */
    public fun subtract(subtract: FileAttributeMatcher? = null): FileAttributeMatcher? = g_file_attribute_matcher_subtract(gioFileAttributeMatcherPointer, subtract?.gioFileAttributeMatcherPointer)?.run {
        FileAttributeMatcher(this)}
    ...
    @GioVersion2_32
    override fun toString(): String = g_file_attribute_matcher_to_string(gioFileAttributeMatcherPointer)?.toKString() ?: error("Expected not null string")
