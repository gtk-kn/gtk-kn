...
public abstract class FilterInputStream(
    ...
    public open var closeBaseStream: Boolean
         ...
         */
        set(closeBase) = g_filter_input_stream_set_close_base_stream(gioFilterInputStreamPointer, closeBase.asGBoolean())
     ...
     */
    public class FilterInputStreamImpl(
        pointer: CPointer<GFilterInputStream>,
    ) : FilterInputStream(pointer)
