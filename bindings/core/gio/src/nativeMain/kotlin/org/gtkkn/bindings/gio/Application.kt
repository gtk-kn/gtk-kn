...
public open class Application(
     ...
     */
    public open fun hold(): Unit = g_application_hold(gioApplicationPointer.reinterpret())
     ...
     */
    public open fun release(): Unit = g_application_release(gioApplicationPointer.reinterpret())
