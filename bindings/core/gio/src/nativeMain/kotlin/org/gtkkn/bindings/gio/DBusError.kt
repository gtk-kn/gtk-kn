...
public enum class DBusError(
    ...
    public companion object {
         ...
         */
        @GioVersion2_26
        public fun encodeGerror(error: Error): String = g_dbus_error_encode_gerror(error.glibErrorPointer.reinterpret())?.toKString() ?: error("Expected not null string")
         ...
         */
        @GioVersion2_26
        public fun getRemoteError(error: Error): String? = g_dbus_error_get_remote_error(error.glibErrorPointer.reinterpret())?.toKString()
         ...
         */
        @GioVersion2_26
        public fun isRemoteError(error: Error): Boolean = g_dbus_error_is_remote_error(error.glibErrorPointer.reinterpret()).asBoolean()
         ...
         */
        @GioVersion2_26
        public fun newForDbusError(dbusErrorName: String, dbusErrorMessage: String): Error = g_dbus_error_new_for_dbus_error(dbusErrorName, dbusErrorMessage)!!.run {
            Error(reinterpret())}
         ...
         */
        @GioVersion2_26
        public fun stripRemoteError(error: Error): Boolean = g_dbus_error_strip_remote_error(error.glibErrorPointer.reinterpret()).asBoolean()
