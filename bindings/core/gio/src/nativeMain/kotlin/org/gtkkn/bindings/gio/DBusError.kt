...
public enum class DBusError(
    ...
    public companion object {
         ...
         */
        @GioVersion2_26
        public fun encodeGerror(error: Error): String = g_dbus_error_encode_gerror(error.glibErrorPointer)?.toKString() ?: error("Expected not null string")
         ...
         */
        @GioVersion2_26
        public fun getRemoteError(error: Error): String? = g_dbus_error_get_remote_error(error.glibErrorPointer)?.toKString()
         ...
         */
        @GioVersion2_26
        public fun isRemoteError(error: Error): Boolean = g_dbus_error_is_remote_error(error.glibErrorPointer).asBoolean()
         ...
         */
        @GioVersion2_26
        public fun stripRemoteError(error: Error): Boolean = g_dbus_error_strip_remote_error(error.glibErrorPointer).asBoolean()
