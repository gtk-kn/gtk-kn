...
public enum class DBusError(public val nativeValue: GDBusError) {
    ...
    public companion object {
         ...
         */
        @GioVersion2_26
        public fun registerError(errorDomain: Quark, errorCode: Int, dbusErrorName: String): Boolean =
         ...
         */
        @GioVersion2_26
        public fun unregisterError(errorDomain: Quark, errorCode: Int, dbusErrorName: String): Boolean =
