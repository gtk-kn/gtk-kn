...
public open class SimpleAsyncResult(
    ...
    ) : this(g_simple_async_result_new(sourceObject?.gPointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() }, sourceTag)!!.reinterpret())
    ...
    public constructor(
        ...
        callback: AsyncReadyCallback?,
        error: Error,
    ) : this(g_simple_async_result_new_from_error(sourceObject?.gPointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() }, error.glibErrorPointer.reinterpret())!!.reinterpret())
     ...
     * is needed to complete the call.
     */
    public open fun completeInIdle(): Unit = g_simple_async_result_complete_in_idle(gioSimpleAsyncResultPointer.reinterpret())
     ...
     */
    public open fun getOpResGboolean(): Boolean = g_simple_async_result_get_op_res_gboolean(gioSimpleAsyncResultPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun getOpResGpointer(): gpointer? = g_simple_async_result_get_op_res_gpointer(gioSimpleAsyncResultPointer.reinterpret())
     ...
     */
    public open fun getOpResGssize(): Long = g_simple_async_result_get_op_res_gssize(gioSimpleAsyncResultPointer.reinterpret())
     ...
     */
    public open fun getSourceTag(): gpointer? = g_simple_async_result_get_source_tag(gioSimpleAsyncResultPointer.reinterpret())
    ...
    public open fun propagateError(): Result<Boolean> = memScoped {
        ...
        val gResult = g_simple_async_result_propagate_error(gioSimpleAsyncResultPointer.reinterpret(), gError.ptr).asBoolean()
     ...
     */
    @GioVersion2_32
    public open fun setCheckCancellable(checkCancellable: Cancellable? = null): Unit = g_simple_async_result_set_check_cancellable(gioSimpleAsyncResultPointer.reinterpret(), checkCancellable?.gioCancellablePointer?.reinterpret())
     ...
     * @param error #GError.
     */
    public open fun setFromError(error: Error): Unit = g_simple_async_result_set_from_error(gioSimpleAsyncResultPointer.reinterpret(), error.glibErrorPointer.reinterpret())
     ...
     */
    public open fun setHandleCancellation(handleCancellation: Boolean): Unit = g_simple_async_result_set_handle_cancellation(gioSimpleAsyncResultPointer.reinterpret(), handleCancellation.asGBoolean())
     ...
     */
    public open fun setOpResGboolean(opRes: Boolean): Unit = g_simple_async_result_set_op_res_gboolean(gioSimpleAsyncResultPointer.reinterpret(), opRes.asGBoolean())
    ...
    public companion object : TypeCompanion<SimpleAsyncResult> {
        ...
        public fun newFromError(
            ...
            callback: AsyncReadyCallback?,
            error: Error,
        ): SimpleAsyncResult = SimpleAsyncResult(g_simple_async_result_new_from_error(sourceObject?.gPointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() }, error.glibErrorPointer.reinterpret())!!.reinterpret())
        ...
        public fun newTakeError(
            ...
            callback: AsyncReadyCallback?,
            error: Error,
        ): SimpleAsyncResult = SimpleAsyncResult(g_simple_async_result_new_take_error(sourceObject?.gPointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() }, error.glibErrorPointer.reinterpret())!!.reinterpret())
        ...
        public fun isValid(
            ...
            source: Object? = null,
            sourceTag: gpointer? = null,
        ): Boolean = g_simple_async_result_is_valid(result.gioAsyncResultPointer, source?.gPointer?.reinterpret(), sourceTag).asBoolean()
