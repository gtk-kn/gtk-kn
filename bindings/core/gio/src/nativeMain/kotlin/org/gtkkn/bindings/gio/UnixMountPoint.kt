...
public class UnixMountPoint(public val gioUnixMountPointPointer: CPointer<GUnixMountPoint>) :
     ...
     */
    public fun free(): Unit = g_unix_mount_point_free(gioUnixMountPointPointer)
     ...
     */
    @GioVersion2_32
    public fun getOptions(): String? = g_unix_mount_point_get_options(gioUnixMountPointPointer)?.toKString()
     ...
     */
    public fun guessCanEject(): Boolean = g_unix_mount_point_guess_can_eject(gioUnixMountPointPointer).asBoolean()
     ...
     */
    public fun isLoopback(): Boolean = g_unix_mount_point_is_loopback(gioUnixMountPointPointer).asBoolean()
     ...
     */
    public fun isReadonly(): Boolean = g_unix_mount_point_is_readonly(gioUnixMountPointPointer).asBoolean()
     ...
     */
    public fun isUserMountable(): Boolean = g_unix_mount_point_is_user_mountable(gioUnixMountPointPointer).asBoolean()
