...
public class UnixMountPoint(
     ...
     */
    public fun getDevicePath(): String = g_unix_mount_point_get_device_path(gioUnixMountPointPointer.reinterpret())?.toKString() ?: error("Expected not null string")
     ...
     */
    public fun getFsType(): String = g_unix_mount_point_get_fs_type(gioUnixMountPointPointer.reinterpret())?.toKString() ?: error("Expected not null string")
     ...
     */
    public fun getMountPath(): String = g_unix_mount_point_get_mount_path(gioUnixMountPointPointer.reinterpret())?.toKString() ?: error("Expected not null string")
     ...
     */
    @GioVersion2_32
    public fun getOptions(): String? = g_unix_mount_point_get_options(gioUnixMountPointPointer.reinterpret())?.toKString()
     ...
     */
    public fun guessCanEject(): Boolean = g_unix_mount_point_guess_can_eject(gioUnixMountPointPointer.reinterpret()).asBoolean()
     ...
     */
    public fun guessName(): String = g_unix_mount_point_guess_name(gioUnixMountPointPointer.reinterpret())?.toKString() ?: error("Expected not null string")
     ...
     */
    @GioVersion2_34
    public fun guessSymbolicIcon(): Icon = g_unix_mount_point_guess_symbolic_icon(gioUnixMountPointPointer.reinterpret())!!.run {
        Icon.wrap(reinterpret())}
     ...
     */
    public fun isLoopback(): Boolean = g_unix_mount_point_is_loopback(gioUnixMountPointPointer.reinterpret()).asBoolean()
     ...
     */
    public fun isReadonly(): Boolean = g_unix_mount_point_is_readonly(gioUnixMountPointPointer.reinterpret()).asBoolean()
