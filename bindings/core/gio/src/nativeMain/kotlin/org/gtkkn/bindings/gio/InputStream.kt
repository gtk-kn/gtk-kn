...
public open class InputStream(
     ...
     */
    public open fun clearPending(): Unit = g_input_stream_clear_pending(gioInputStreamPointer.reinterpret())
    ...
    public open fun close(cancellable: Cancellable? = null): Result<Boolean> = memScoped {
        ...
        val gResult = g_input_stream_close(gioInputStreamPointer.reinterpret(), cancellable?.gioCancellablePointer?.reinterpret(), gError.ptr).asBoolean()
    ...
    ): Unit = g_input_stream_close_async(gioInputStreamPointer.reinterpret(), ioPriority, cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public open fun closeFinish(result: AsyncResult): Result<Boolean> = memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = g_input_stream_close_finish(gioInputStreamPointer.reinterpret(), result.gioAsyncResultPointer, gError.ptr).asBoolean()
        return if (gError.pointed != null) {
            Result.failure(resolveException(Error(gError.pointed!!.ptr)))
        }
        else {
     ...
     */
    public open fun hasPending(): Boolean = g_input_stream_has_pending(gioInputStreamPointer.reinterpret()).asBoolean()
     ...
     */
    public open fun isClosed(): Boolean = g_input_stream_is_closed(gioInputStreamPointer.reinterpret()).asBoolean()
    ...
    public open fun readBytesAsync(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = g_input_stream_read_bytes_async(gioInputStreamPointer.reinterpret(), count, ioPriority, cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public open fun readBytesFinish(result: AsyncResult): Result<Bytes> = memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = g_input_stream_read_bytes_finish(gioInputStreamPointer.reinterpret(), result.gioAsyncResultPointer, gError.ptr)?.run {
            Bytes(reinterpret())}
    ...
    public open fun readFinish(result: AsyncResult): Result<Long> = memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = g_input_stream_read_finish(gioInputStreamPointer.reinterpret(), result.gioAsyncResultPointer, gError.ptr)
        return if (gError.pointed != null) {
            Result.failure(resolveException(Error(gError.pointed!!.ptr)))
        }
        else {
    ...
    public open fun skipAsync(
        ...
        cancellable: Cancellable? = null,
        callback: AsyncReadyCallback?,
    ): Unit = g_input_stream_skip_async(gioInputStreamPointer.reinterpret(), count, ioPriority, cancellable?.gioCancellablePointer?.reinterpret(), callback?.let { AsyncReadyCallbackFunc.reinterpret() }, callback?.let { StableRef.create(callback).asCPointer() })
    ...
    public open fun skipFinish(result: AsyncResult): Result<Long> = memScoped {
        val gError = allocPointerTo<GError>()
        val gResult = g_input_stream_skip_finish(gioInputStreamPointer.reinterpret(), result.gioAsyncResultPointer, gError.ptr)
        return if (gError.pointed != null) {
            Result.failure(resolveException(Error(gError.pointed!!.ptr)))
        }
        else {
