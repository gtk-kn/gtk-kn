...
public open class DataInputStream(public val gioDataInputStreamPointer: CPointer<GDataInputStream>) :
    ...
    public open var byteOrder: DataStreamByteOrder
         ...
         */
        set(order) = g_data_input_stream_set_byte_order(gioDataInputStreamPointer, order.nativeValue)
    ...
    public open var newlineType: DataStreamNewlineType
         ...
         */
        set(type) = g_data_input_stream_set_newline_type(gioDataInputStreamPointer, type.nativeValue)
    ...
    public companion object : TypeCompanion<DataInputStream> {
        ...
        internal fun getTypeOrNull(): GType? =
            org.gtkkn.extensions.glib.cinterop.getTypeOrNull("g_data_input_stream_get_type")
    }
}
