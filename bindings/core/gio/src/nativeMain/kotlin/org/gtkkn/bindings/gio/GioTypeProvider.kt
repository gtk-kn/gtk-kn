...
public object GioTypeProvider : TypeProvider {
    override val typeMap: Map<KClass<*>, KGType<*>> = buildMap {
        ...
        if (DesktopAppInfo.getTypeOrNull() != null) put(DesktopAppInfo::class, DesktopAppInfo.type)
        ...
        if (DesktopAppInfoLookup.getTypeOrNull() != null) put(DesktopAppInfoLookup::class, DesktopAppInfoLookup.type)
