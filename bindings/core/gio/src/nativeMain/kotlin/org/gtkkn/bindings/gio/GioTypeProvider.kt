...
public object GioTypeProvider : TypeProvider {
    override val typeMap: Map<KClass<*>, KGType<*>> = buildMap {
        ...
        if (ApplicationCommandLine.getTypeOrNull() != null) put(ApplicationCommandLine::class, ApplicationCommandLine.type)
        ...
        if (DBusObjectManagerClient.getTypeOrNull() != null) put(DBusObjectManagerClient::class, DBusObjectManagerClient.type)
        if (DBusObjectManagerServer.getTypeOrNull() != null) put(DBusObjectManagerServer::class, DBusObjectManagerServer.type)
        ...
        if (ProxyAddressEnumerator.getTypeOrNull() != null) put(ProxyAddressEnumerator::class, ProxyAddressEnumerator.type)
        ...
        if (SocketAddressEnumerator.getTypeOrNull() != null) put(SocketAddressEnumerator::class, SocketAddressEnumerator.type)
        ...
        if (UnixCredentialsMessage.getTypeOrNull() != null) put(UnixCredentialsMessage::class, UnixCredentialsMessage.type)
