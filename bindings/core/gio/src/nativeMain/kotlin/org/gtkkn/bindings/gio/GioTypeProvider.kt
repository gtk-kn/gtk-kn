...
public object GioTypeProvider : TypeProvider {
    override val typeMap: Map<KClass<*>, KGType<*>> = buildMap {
        ...
        if (getTypeOrNull("g_application_command_line_get_type") != null) put(ApplicationCommandLine::class, ApplicationCommandLine.type)
        if (getTypeOrNull("g_buffered_input_stream_get_type") != null) put(BufferedInputStream::class, BufferedInputStream.type)
        if (getTypeOrNull("g_buffered_output_stream_get_type") != null) put(BufferedOutputStream::class, BufferedOutputStream.type)
        ...
        if (getTypeOrNull("g_converter_input_stream_get_type") != null) put(ConverterInputStream::class, ConverterInputStream.type)
        if (getTypeOrNull("g_converter_output_stream_get_type") != null) put(ConverterOutputStream::class, ConverterOutputStream.type)
        ...
        if (getTypeOrNull("g_dbus_interface_skeleton_get_type") != null) put(DBusInterfaceSkeleton::class, DBusInterfaceSkeleton.type)
        ...
        if (getTypeOrNull("g_dbus_method_invocation_get_type") != null) put(DBusMethodInvocation::class, DBusMethodInvocation.type)
        if (getTypeOrNull("g_dbus_object_manager_client_get_type") != null) put(DBusObjectManagerClient::class, DBusObjectManagerClient.type)
        if (getTypeOrNull("g_dbus_object_manager_server_get_type") != null) put(DBusObjectManagerServer::class, DBusObjectManagerServer.type)
        if (getTypeOrNull("g_dbus_object_proxy_get_type") != null) put(DBusObjectProxy::class, DBusObjectProxy.type)
        if (getTypeOrNull("g_dbus_object_skeleton_get_type") != null) put(DBusObjectSkeleton::class, DBusObjectSkeleton.type)
        ...
        if (getTypeOrNull("g_debug_controller_dbus_get_type") != null) put(DebugControllerDBus::class, DebugControllerDBus.type)
        ...
        if (getTypeOrNull("g_filename_completer_get_type") != null) put(FilenameCompleter::class, FilenameCompleter.type)
        if (getTypeOrNull("g_filter_input_stream_get_type") != null) put(FilterInputStream::class, FilterInputStream.type)
        if (getTypeOrNull("g_filter_output_stream_get_type") != null) put(FilterOutputStream::class, FilterOutputStream.type)
        ...
        if (getTypeOrNull("g_inet_socket_address_get_type") != null) put(InetSocketAddress::class, InetSocketAddress.type)
        ...
        if (getTypeOrNull("g_memory_input_stream_get_type") != null) put(MemoryInputStream::class, MemoryInputStream.type)
        if (getTypeOrNull("g_memory_output_stream_get_type") != null) put(MemoryOutputStream::class, MemoryOutputStream.type)
        if (getTypeOrNull("g_menu_get_type") != null) put(Menu::class, Menu.type)
        if (getTypeOrNull("g_menu_attribute_iter_get_type") != null) put(MenuAttributeIter::class, MenuAttributeIter.type)
        ...
        if (getTypeOrNull("g_native_socket_address_get_type") != null) put(NativeSocketAddress::class, NativeSocketAddress.type)
        if (getTypeOrNull("g_native_volume_monitor_get_type") != null) put(NativeVolumeMonitor::class, NativeVolumeMonitor.type)
        ...
        if (getTypeOrNull("g_proxy_address_enumerator_get_type") != null) put(ProxyAddressEnumerator::class, ProxyAddressEnumerator.type)
        ...
        if (getTypeOrNull("g_simple_action_group_get_type") != null) put(SimpleActionGroup::class, SimpleActionGroup.type)
        if (getTypeOrNull("g_simple_async_result_get_type") != null) put(SimpleAsyncResult::class, SimpleAsyncResult.type)
        ...
        if (getTypeOrNull("g_simple_proxy_resolver_get_type") != null) put(SimpleProxyResolver::class, SimpleProxyResolver.type)
        ...
        if (getTypeOrNull("g_socket_address_enumerator_get_type") != null) put(SocketAddressEnumerator::class, SocketAddressEnumerator.type)
        ...
        if (getTypeOrNull("g_socket_control_message_get_type") != null) put(SocketControlMessage::class, SocketControlMessage.type)
        ...
        if (getTypeOrNull("g_subprocess_launcher_get_type") != null) put(SubprocessLauncher::class, SubprocessLauncher.type)
        ...
        if (getTypeOrNull("g_tcp_wrapper_connection_get_type") != null) put(TcpWrapperConnection::class, TcpWrapperConnection.type)
        ...
        if (getTypeOrNull("g_threaded_socket_service_get_type") != null) put(ThreadedSocketService::class, ThreadedSocketService.type)
        ...
        if (getTypeOrNull("g_unix_credentials_message_get_type") != null) put(UnixCredentialsMessage::class, UnixCredentialsMessage.type)
        ...
        if (getTypeOrNull("g_unix_socket_address_get_type") != null) put(UnixSocketAddress::class, UnixSocketAddress.type)
        ...
        if (getTypeOrNull("g_dbus_object_manager_get_type") != null) put(DBusObjectManager::class, DBusObjectManager.type)
        ...
        if (getTypeOrNull("g_desktop_app_info_lookup_get_type") != null) put(DesktopAppInfoLookup::class, DesktopAppInfoLookup.type)
        if (getTypeOrNull("g_drive_get_type") != null) put(Drive::class, Drive.type)
        if (getTypeOrNull("g_dtls_client_connection_get_type") != null) put(DtlsClientConnection::class, DtlsClientConnection.type)
        if (getTypeOrNull("g_dtls_connection_get_type") != null) put(DtlsConnection::class, DtlsConnection.type)
        if (getTypeOrNull("g_dtls_server_connection_get_type") != null) put(DtlsServerConnection::class, DtlsServerConnection.type)
        if (getTypeOrNull("g_file_get_type") != null) put(File::class, File.type)
        if (getTypeOrNull("g_file_descriptor_based_get_type") != null) put(FileDescriptorBased::class, FileDescriptorBased.type)
        ...
        if (getTypeOrNull("g_pollable_input_stream_get_type") != null) put(PollableInputStream::class, PollableInputStream.type)
        if (getTypeOrNull("g_pollable_output_stream_get_type") != null) put(PollableOutputStream::class, PollableOutputStream.type)
        if (getTypeOrNull("g_power_profile_monitor_get_type") != null) put(PowerProfileMonitor::class, PowerProfileMonitor.type)
        ...
        if (getTypeOrNull("g_remote_action_group_get_type") != null) put(RemoteActionGroup::class, RemoteActionGroup.type)
        if (getTypeOrNull("g_seekable_get_type") != null) put(Seekable::class, Seekable.type)
        if (getTypeOrNull("g_socket_connectable_get_type") != null) put(SocketConnectable::class, SocketConnectable.type)
        if (getTypeOrNull("g_tls_backend_get_type") != null) put(TlsBackend::class, TlsBackend.type)
        if (getTypeOrNull("g_tls_client_connection_get_type") != null) put(TlsClientConnection::class, TlsClientConnection.type)
        if (getTypeOrNull("g_tls_file_database_get_type") != null) put(TlsFileDatabase::class, TlsFileDatabase.type)
        if (getTypeOrNull("g_tls_server_connection_get_type") != null) put(TlsServerConnection::class, TlsServerConnection.type)
